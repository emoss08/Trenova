...
func (glau *GeneralLedgerAccountUpdate) SetCashFlowType(gft generalledgeraccount.CashFlowType) *GeneralLedgerAccountUpdate {
	glau.mutation.SetCashFlowType(gft)
	return glau
}

// SetNillableCashFlowType sets the "cash_flow_type" field if the given value is not nil.
func (glau *GeneralLedgerAccountUpdate) SetNillableCashFlowType(gft *generalledgeraccount.CashFlowType) *GeneralLedgerAccountUpdate {
	if gft != nil {
		glau.SetCashFlowType(*gft)
	}
	return glau
}
...
func (glau *GeneralLedgerAccountUpdate) SetAccountSubType(gst generalledgeraccount.AccountSubType) *GeneralLedgerAccountUpdate {
	glau.mutation.SetAccountSubType(gst)
	return glau
}

// SetNillableAccountSubType sets the "account_sub_type" field if the given value is not nil.
func (glau *GeneralLedgerAccountUpdate) SetNillableAccountSubType(gst *generalledgeraccount.AccountSubType) *GeneralLedgerAccountUpdate {
	if gst != nil {
		glau.SetAccountSubType(*gst)
	}
	return glau
}
...
func (glau *GeneralLedgerAccountUpdate) SetAccountClass(gc generalledgeraccount.AccountClass) *GeneralLedgerAccountUpdate {
	glau.mutation.SetAccountClass(gc)
	return glau
}

// SetNillableAccountClass sets the "account_class" field if the given value is not nil.
func (glau *GeneralLedgerAccountUpdate) SetNillableAccountClass(gc *generalledgeraccount.AccountClass) *GeneralLedgerAccountUpdate {
	if gc != nil {
		glau.SetAccountClass(*gc)
	}
	return glau
}
...
func (glau *GeneralLedgerAccountUpdate) check() error {
	...
	if v, ok := glau.mutation.CashFlowType(); ok {
		if err := generalledgeraccount.CashFlowTypeValidator(v); err != nil {
			return &ValidationError{Name: "cash_flow_type", err: fmt.Errorf(`ent: validator failed for field "GeneralLedgerAccount.cash_flow_type": %w`, err)}
		}
	}
	if v, ok := glau.mutation.AccountSubType(); ok {
		if err := generalledgeraccount.AccountSubTypeValidator(v); err != nil {
			return &ValidationError{Name: "account_sub_type", err: fmt.Errorf(`ent: validator failed for field "GeneralLedgerAccount.account_sub_type": %w`, err)}
		}
	}
	if v, ok := glau.mutation.AccountClass(); ok {
		if err := generalledgeraccount.AccountClassValidator(v); err != nil {
			return &ValidationError{Name: "account_class", err: fmt.Errorf(`ent: validator failed for field "GeneralLedgerAccount.account_class": %w`, err)}
		}
	}
...
func (glau *GeneralLedgerAccountUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if glau.mutation.CashFlowTypeCleared() {
		_spec.ClearField(generalledgeraccount.FieldCashFlowType, field.TypeEnum)
	}
	...
	if glau.mutation.AccountSubTypeCleared() {
		_spec.ClearField(generalledgeraccount.FieldAccountSubType, field.TypeEnum)
	}
	...
	if glau.mutation.AccountClassCleared() {
		_spec.ClearField(generalledgeraccount.FieldAccountClass, field.TypeEnum)
	}
...
// SetCashFlowType sets the "cash_flow_type" field.
func (glauo *GeneralLedgerAccountUpdateOne) SetCashFlowType(gft generalledgeraccount.CashFlowType) *GeneralLedgerAccountUpdateOne {
	glauo.mutation.SetCashFlowType(gft)
	return glauo
}

// SetNillableCashFlowType sets the "cash_flow_type" field if the given value is not nil.
func (glauo *GeneralLedgerAccountUpdateOne) SetNillableCashFlowType(gft *generalledgeraccount.CashFlowType) *GeneralLedgerAccountUpdateOne {
	if gft != nil {
		glauo.SetCashFlowType(*gft)
	}
	return glauo
}
...
// SetAccountSubType sets the "account_sub_type" field.
func (glauo *GeneralLedgerAccountUpdateOne) SetAccountSubType(gst generalledgeraccount.AccountSubType) *GeneralLedgerAccountUpdateOne {
	glauo.mutation.SetAccountSubType(gst)
	return glauo
}

// SetNillableAccountSubType sets the "account_sub_type" field if the given value is not nil.
func (glauo *GeneralLedgerAccountUpdateOne) SetNillableAccountSubType(gst *generalledgeraccount.AccountSubType) *GeneralLedgerAccountUpdateOne {
	if gst != nil {
		glauo.SetAccountSubType(*gst)
	}
	return glauo
}
...
// SetAccountClass sets the "account_class" field.
func (glauo *GeneralLedgerAccountUpdateOne) SetAccountClass(gc generalledgeraccount.AccountClass) *GeneralLedgerAccountUpdateOne {
	glauo.mutation.SetAccountClass(gc)
	return glauo
}

// SetNillableAccountClass sets the "account_class" field if the given value is not nil.
func (glauo *GeneralLedgerAccountUpdateOne) SetNillableAccountClass(gc *generalledgeraccount.AccountClass) *GeneralLedgerAccountUpdateOne {
	if gc != nil {
		glauo.SetAccountClass(*gc)
	}
	return glauo
}
...
func (glauo *GeneralLedgerAccountUpdateOne) check() error {
	...
	if v, ok := glauo.mutation.CashFlowType(); ok {
		if err := generalledgeraccount.CashFlowTypeValidator(v); err != nil {
			return &ValidationError{Name: "cash_flow_type", err: fmt.Errorf(`ent: validator failed for field "GeneralLedgerAccount.cash_flow_type": %w`, err)}
		}
	}
	if v, ok := glauo.mutation.AccountSubType(); ok {
		if err := generalledgeraccount.AccountSubTypeValidator(v); err != nil {
			return &ValidationError{Name: "account_sub_type", err: fmt.Errorf(`ent: validator failed for field "GeneralLedgerAccount.account_sub_type": %w`, err)}
		}
	}
	if v, ok := glauo.mutation.AccountClass(); ok {
		if err := generalledgeraccount.AccountClassValidator(v); err != nil {
			return &ValidationError{Name: "account_class", err: fmt.Errorf(`ent: validator failed for field "GeneralLedgerAccount.account_class": %w`, err)}
		}
	}
