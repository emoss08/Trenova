...
func PackingGroupEQ(v PackingGroup) predicate.HazardousMaterial {
...
func PackingGroupNEQ(v PackingGroup) predicate.HazardousMaterial {
...
func PackingGroupIn(vs ...PackingGroup) predicate.HazardousMaterial {
...
func PackingGroupNotIn(vs ...PackingGroup) predicate.HazardousMaterial {
...
// HasCommodities applies the HasEdge predicate on the "commodities" edge.
func HasCommodities() predicate.HazardousMaterial {
	return predicate.HazardousMaterial(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasCommoditiesWith applies the HasEdge predicate on the "commodities" edge with a given conditions (other predicates).
func HasCommoditiesWith(preds ...predicate.Commodity) predicate.HazardousMaterial {
	return predicate.HazardousMaterial(func(s *sql.Selector) {
		step := newCommoditiesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
