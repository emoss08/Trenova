...
const (
	...
	// EmailControlTable is the table that holds the email_control relation/edge.
	EmailControlTable = "email_controls"
	// EmailControlInverseTable is the table name for the EmailControl entity.
	// It exists in this package in order to avoid circular dependency with the "emailcontrol" package.
...
// ByEmailControlField orders the results by email_control field.
func ByEmailControlField(field string, opts ...sql.OrderTermOption) OrderOption {
	return func(s *sql.Selector) {
...
func newEmailControlStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		sqlgraph.From(Table, FieldID),
