...
const (
	// Label holds the string label denoting the chargetype type in the database.
	Label = "charge_type"
	...
	// Table holds the table name of the chargetype in the database.
	Table = "charge_types"
	// BusinessUnitTable is the table that holds the business_unit relation/edge.
	BusinessUnitTable = "charge_types"
	...
	OrganizationTable = "charge_types"
...
// Columns holds all SQL columns for chargetype fields.
var Columns = []string{
	FieldID,
	FieldBusinessUnitID,
	FieldOrganizationID,
...
func StatusValidator(s Status) error {
	...
	case StatusA, StatusI:
		return nil
	default:
		return fmt.Errorf("chargetype: invalid enum value for status field: %q", s)
	}
}

// OrderOption defines the ordering options for the ChargeType queries.
