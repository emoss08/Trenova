...
func (glac *GeneralLedgerAccountCreate) SetCashFlowType(gft generalledgeraccount.CashFlowType) *GeneralLedgerAccountCreate {
	glac.mutation.SetCashFlowType(gft)
	return glac
}

// SetNillableCashFlowType sets the "cash_flow_type" field if the given value is not nil.
func (glac *GeneralLedgerAccountCreate) SetNillableCashFlowType(gft *generalledgeraccount.CashFlowType) *GeneralLedgerAccountCreate {
	if gft != nil {
		glac.SetCashFlowType(*gft)
	}
	return glac
}

// SetAccountSubType sets the "account_sub_type" field.
func (glac *GeneralLedgerAccountCreate) SetAccountSubType(gst generalledgeraccount.AccountSubType) *GeneralLedgerAccountCreate {
	glac.mutation.SetAccountSubType(gst)
	return glac
}

// SetNillableAccountSubType sets the "account_sub_type" field if the given value is not nil.
func (glac *GeneralLedgerAccountCreate) SetNillableAccountSubType(gst *generalledgeraccount.AccountSubType) *GeneralLedgerAccountCreate {
	if gst != nil {
		glac.SetAccountSubType(*gst)
	}
	return glac
}

// SetAccountClass sets the "account_class" field.
func (glac *GeneralLedgerAccountCreate) SetAccountClass(gc generalledgeraccount.AccountClass) *GeneralLedgerAccountCreate {
	glac.mutation.SetAccountClass(gc)
	return glac
}

// SetNillableAccountClass sets the "account_class" field if the given value is not nil.
func (glac *GeneralLedgerAccountCreate) SetNillableAccountClass(gc *generalledgeraccount.AccountClass) *GeneralLedgerAccountCreate {
	if gc != nil {
		glac.SetAccountClass(*gc)
	}
	return glac
}
...
func (glac *GeneralLedgerAccountCreate) check() error {
	...
	if v, ok := glac.mutation.CashFlowType(); ok {
	...
	if v, ok := glac.mutation.AccountSubType(); ok {
	...
	if v, ok := glac.mutation.AccountClass(); ok {
