...
func MinTemp(v float64) predicate.Commodity {
...
func MaxTemp(v float64) predicate.Commodity {
	return predicate.Commodity(sql.FieldEQ(FieldMaxTemp, v))
}

// SetPointTemp applies equality check predicate on the "set_point_temp" field. It's identical to SetPointTempEQ.
func SetPointTemp(v float64) predicate.Commodity {
	return predicate.Commodity(sql.FieldEQ(FieldSetPointTemp, v))
}
...
func UnitOfMeasureEQ(v UnitOfMeasure) predicate.Commodity {
...
func UnitOfMeasureNEQ(v UnitOfMeasure) predicate.Commodity {
...
func UnitOfMeasureIn(vs ...UnitOfMeasure) predicate.Commodity {
...
func UnitOfMeasureNotIn(vs ...UnitOfMeasure) predicate.Commodity {
...
// SetPointTempEQ applies the EQ predicate on the "set_point_temp" field.
func SetPointTempEQ(v float64) predicate.Commodity {
	return predicate.Commodity(sql.FieldEQ(FieldSetPointTemp, v))
}

// SetPointTempNEQ applies the NEQ predicate on the "set_point_temp" field.
func SetPointTempNEQ(v float64) predicate.Commodity {
	return predicate.Commodity(sql.FieldNEQ(FieldSetPointTemp, v))
}

// SetPointTempIn applies the In predicate on the "set_point_temp" field.
func SetPointTempIn(vs ...float64) predicate.Commodity {
	return predicate.Commodity(sql.FieldIn(FieldSetPointTemp, vs...))
}

// SetPointTempNotIn applies the NotIn predicate on the "set_point_temp" field.
func SetPointTempNotIn(vs ...float64) predicate.Commodity {
	return predicate.Commodity(sql.FieldNotIn(FieldSetPointTemp, vs...))
}

// SetPointTempGT applies the GT predicate on the "set_point_temp" field.
func SetPointTempGT(v float64) predicate.Commodity {
	return predicate.Commodity(sql.FieldGT(FieldSetPointTemp, v))
}

// SetPointTempGTE applies the GTE predicate on the "set_point_temp" field.
func SetPointTempGTE(v float64) predicate.Commodity {
	return predicate.Commodity(sql.FieldGTE(FieldSetPointTemp, v))
}

// SetPointTempLT applies the LT predicate on the "set_point_temp" field.
func SetPointTempLT(v float64) predicate.Commodity {
	return predicate.Commodity(sql.FieldLT(FieldSetPointTemp, v))
}

// SetPointTempLTE applies the LTE predicate on the "set_point_temp" field.
func SetPointTempLTE(v float64) predicate.Commodity {
	return predicate.Commodity(sql.FieldLTE(FieldSetPointTemp, v))
}

// SetPointTempIsNil applies the IsNil predicate on the "set_point_temp" field.
func SetPointTempIsNil() predicate.Commodity {
	return predicate.Commodity(sql.FieldIsNull(FieldSetPointTemp))
}

// SetPointTempNotNil applies the NotNil predicate on the "set_point_temp" field.
func SetPointTempNotNil() predicate.Commodity {
	return predicate.Commodity(sql.FieldNotNull(FieldSetPointTemp))
}
