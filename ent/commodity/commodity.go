...
const (
	...
	// FieldSetPointTemp holds the string denoting the set_point_temp field in the database.
	FieldSetPointTemp = "set_point_temp"
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "commodities"
...
// UnitOfMeasure defines the type for the "unit_of_measure" enum field.
type UnitOfMeasure string

// UnitOfMeasure values.
const (
	UnitOfMeasureP UnitOfMeasure = "P"
	UnitOfMeasureT UnitOfMeasure = "T"
	UnitOfMeasureD UnitOfMeasure = "D"
	UnitOfMeasureC UnitOfMeasure = "C"
	UnitOfMeasureA UnitOfMeasure = "A"
	UnitOfMeasureB UnitOfMeasure = "B"
	UnitOfMeasureO UnitOfMeasure = "O"
	UnitOfMeasureL UnitOfMeasure = "L"
	UnitOfMeasureI UnitOfMeasure = "I"
	UnitOfMeasureS UnitOfMeasure = "S"
)
...
// UnitOfMeasureValidator is a validator for the "unit_of_measure" field enum values. It is called by the builders before save.
func UnitOfMeasureValidator(uom UnitOfMeasure) error {
	switch uom {
	case UnitOfMeasureP, UnitOfMeasureT, UnitOfMeasureD, UnitOfMeasureC, UnitOfMeasureA, UnitOfMeasureB, UnitOfMeasureO, UnitOfMeasureL, UnitOfMeasureI, UnitOfMeasureS:
		return nil
	default:
		return fmt.Errorf("commodity: invalid enum value for unit_of_measure field: %q", uom)
	}
}
...
// BySetPointTemp orders the results by the set_point_temp field.
func BySetPointTemp(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSetPointTemp, opts...).ToFunc()
}
