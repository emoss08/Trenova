...
func (ic *InvoiceControl) String() string {
	...
	builder.WriteString(", ")
	if v := ic.InvoiceTerms; v != nil {
		builder.WriteString("invoice_terms=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
	if v := ic.InvoiceFooter; v != nil {
		builder.WriteString("invoice_footer=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
	if v := ic.InvoiceLogoURL; v != nil {
