...
func (cc *CommodityCreate) SetUnitOfMeasure(com commodity.UnitOfMeasure) *CommodityCreate {
	cc.mutation.SetUnitOfMeasure(com)
	return cc
}

// SetNillableUnitOfMeasure sets the "unit_of_measure" field if the given value is not nil.
func (cc *CommodityCreate) SetNillableUnitOfMeasure(com *commodity.UnitOfMeasure) *CommodityCreate {
	if com != nil {
		cc.SetUnitOfMeasure(*com)
	}
	return cc
}

// SetMinTemp sets the "min_temp" field.
func (cc *CommodityCreate) SetMinTemp(f float64) *CommodityCreate {
	cc.mutation.SetMinTemp(f)
	return cc
}

// SetNillableMinTemp sets the "min_temp" field if the given value is not nil.
func (cc *CommodityCreate) SetNillableMinTemp(f *float64) *CommodityCreate {
	if f != nil {
		cc.SetMinTemp(*f)
	}
	return cc
...
func (cc *CommodityCreate) SetMaxTemp(f float64) *CommodityCreate {
	cc.mutation.SetMaxTemp(f)
	return cc
}

// SetNillableMaxTemp sets the "max_temp" field if the given value is not nil.
func (cc *CommodityCreate) SetNillableMaxTemp(f *float64) *CommodityCreate {
	if f != nil {
		cc.SetMaxTemp(*f)
	}
	return cc
...
func (cc *CommodityCreate) SetSetPointTemp(f float64) *CommodityCreate {
	cc.mutation.SetSetPointTemp(f)
	return cc
}

// SetNillableSetPointTemp sets the "set_point_temp" field if the given value is not nil.
func (cc *CommodityCreate) SetNillableSetPointTemp(f *float64) *CommodityCreate {
	if f != nil {
		cc.SetSetPointTemp(*f)
	}
	return cc
}
...
func (cc *CommodityCreate) SetHazardousMaterialID(id uuid.UUID) *CommodityCreate {
	cc.mutation.SetHazardousMaterialID(id)
	return cc
}
...
func (cc *CommodityCreate) check() error {
	...
	if v, ok := cc.mutation.UnitOfMeasure(); ok {
	...
	if _, ok := cc.mutation.HazardousMaterialID(); !ok {
		return &ValidationError{Name: "hazardous_material", err: errors.New(`ent: missing required edge "Commodity.hazardous_material"`)}
	}
	return nil
}
...
func (cc *CommodityCreate) createSpec() (*Commodity, *sqlgraph.CreateSpec) {
	...
	if nodes := cc.mutation.HazardousMaterialIDs(); len(nodes) > 0 {
		...
		_node.hazardous_material_id = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	return _node, _spec
}
