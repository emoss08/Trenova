...
func (e InvoiceDateFormat) MarshalGQL(w io.Writer) {
	io.WriteString(w, strconv.Quote(e.String()))
}

// UnmarshalGQL implements graphql.Unmarshaler interface.
func (e *InvoiceDateFormat) UnmarshalGQL(val interface{}) error {
	str, ok := val.(string)
	if !ok {
		return fmt.Errorf("enum %T must be a string", val)
	}
	*e = InvoiceDateFormat(str)
	if err := InvoiceDateFormatValidator(*e); err != nil {
		return fmt.Errorf("%s is not a valid InvoiceDateFormat", str)
	}
	return nil
}
