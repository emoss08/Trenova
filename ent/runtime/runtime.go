...
func init() {
	...
	// accessorialchargeDescAmount is the schema descriptor for amount field.
	accessorialchargeDescAmount := accessorialchargeFields[5].Descriptor()
	// accessorialcharge.DefaultAmount holds the default value on creation for the amount field.
	accessorialcharge.DefaultAmount = accessorialchargeDescAmount.Default.(float64)
