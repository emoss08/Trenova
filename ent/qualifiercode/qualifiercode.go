...
const (
	// Label holds the string label denoting the qualifiercode type in the database.
	Label = "qualifier_code"
	...
	// Table holds the table name of the qualifiercode in the database.
	Table = "qualifier_codes"
	// BusinessUnitTable is the table that holds the business_unit relation/edge.
	BusinessUnitTable = "qualifier_codes"
	...
	OrganizationTable = "qualifier_codes"
...
// Columns holds all SQL columns for qualifiercode fields.
var Columns = []string{
	FieldID,
	FieldBusinessUnitID,
	FieldOrganizationID,
...
func StatusValidator(s Status) error {
	...
	case StatusA, StatusI:
		return nil
	default:
		return fmt.Errorf("qualifiercode: invalid enum value for status field: %q", s)
	}
}

// OrderOption defines the ordering options for the QualifierCode queries.
