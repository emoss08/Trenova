...
func MergeOptions(base, o Options) Options {
	...
	if o.PartyRoles != nil {
		...
		maps.Copy(out.PartyRoles, o.PartyRoles)
	}
	if o.StopTypeMap != nil {
		if out.StopTypeMap == nil {
			out.StopTypeMap = map[string]string{}
		}
		maps.Copy(out.StopTypeMap, o.StopTypeMap)
	}
	...
	if o.EquipmentTypeMap != nil {
		if out.EquipmentTypeMap == nil {
			out.EquipmentTypeMap = map[string]string{}
		}
		maps.Copy(out.EquipmentTypeMap, o.EquipmentTypeMap)
	}
	if o.EmitISODateTime {
		out.EmitISODateTime = true
	}
	if o.Timezone != "" {
		out.Timezone = o.Timezone
	}
	if len(o.ServiceLevelQuals) > 0 {
		out.ServiceLevelQuals = append([]string{}, o.ServiceLevelQuals...)
	}
	if o.ServiceLevelMap != nil {
		if out.ServiceLevelMap == nil {
			out.ServiceLevelMap = map[string]string{}
		}
		maps.Copy(out.ServiceLevelMap, o.ServiceLevelMap)
	}
	if len(o.AccessorialQuals) > 0 {
		out.AccessorialQuals = append([]string{}, o.AccessorialQuals...)
	}
	if o.AccessorialMap != nil {
		if out.AccessorialMap == nil {
			out.AccessorialMap = map[string]string{}
		}
		maps.Copy(out.AccessorialMap, o.AccessorialMap)
	}
	return out
}
