...
Measured on the Trenova workspace: 6 modules, 687 packages, 349 with tests,
...
Graph load: ~1.4s for 687 packages across 6 modules, loaded with
`golang.org/x/tools/go/packages` (`Tests: true`).

## Reading these numbers honestly

Package-graph TIA is excellent on small, focused commits and mediocre on large
ones. A single-file service change selects 7 of 349 packages. A commit touching
a widely-imported domain package selects 273.
