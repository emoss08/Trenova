...
from utils.exceptions import TrenovaCoreException


class RatingException(TrenovaCoreException):
    """
    Base class for all rating exceptions to be raised by Trenova.
    """
...
class SequenceException(TrenovaCoreException):
    """
    Base class for sequencing exceptions to be raised by Trenova.
    """
