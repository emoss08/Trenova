...
/**
 * Permission metadata for DocumentTemplate
 */
export const DocumentTemplateMetadata = {
  resourceName: 'document_template',
  operations: [
    {
      code: 1,
      name: 'create',
    ...
    },
    {
      ...
      name: 'read',
      displayName: 'Read',
      description: 'View document template information',
    },
    {
      code: 4,
      name: 'update',
      displayName: 'Update',
      description: 'Modify document template details',
    },
    {
      code: 8,
      name: 'delete',
    ...
    },
    {
      ...
      name: 'export',
      displayName: 'Export',
      description: 'Export document templates',
    },
    {
      code: 32,
      name: 'import',
      displayName: 'Import',
      description: 'Import document templates',
    },
  ],
  compositeOperations: {
    manage: 63,
...
/**
 * Permission metadata for GeneratedDocument
 */
export const GeneratedDocumentMetadata = {
  resourceName: 'generated_document',
  operations: [
    {
      code: 1,
      name: 'create',
    ...
    },
    {
      ...
      name: 'delete',
      displayName: 'Delete',
      description: 'Remove generated documents',
    },
  ],
  compositeOperations: {
    manage: 11,
...
/**
 * React hook for DocumentTemplate permissions
 * @example
 * const perms = useDocumentTemplatePermissions();
 * if (perms.canCreate) { ... }
 */
export const useDocumentTemplatePermissions = () => {
  const { can } = usePermissions();

  return {
    canCreate: can('document_template', 'create'),
    canRead: can('document_template', 'read'),
    canUpdate: can('document_template', 'update'),
    canDelete: can('document_template', 'delete'),
    canExport: can('document_template', 'export'),
    canImport: can('document_template', 'import'),
    hasManage: can('document_template', 'manage'),
    hasReadOnly: can('document_template', 'read_only'),
  };
};
...
/**
 * React hook for GeneratedDocument permissions
 * @example
 * const perms = useGeneratedDocumentPermissions();
 * if (perms.canCreate) { ... }
 */
export const useGeneratedDocumentPermissions = () => {
  const { can } = usePermissions();

  return {
    canCreate: can('generated_document', 'create'),
    canRead: can('generated_document', 'read'),
    canDelete: can('generated_document', 'delete'),
    hasManage: can('generated_document', 'manage'),
    hasReadOnly: can('generated_document', 'read_only'),
  };
};
