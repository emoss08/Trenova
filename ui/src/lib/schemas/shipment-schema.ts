...
export const shipmentSchema = z.object({
  ...
  ratingUnit: z.number().min(0, "Rating Unit is required"),
  ratingMethod: z.nativeEnum(RatingMethod),
  otherChargeAmount: z.number().optional(),
  freightChargeAmount: z.number().min(0, "Freight Charge Amount is required"),
  totalChargeAmount: z.number().min(0, "Total Charge Amount is required"),
