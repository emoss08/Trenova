...
export const workflowNodeSchema = z.object({
  id: z.string().min(1).optional(), // Optional for creation, generated by backend
  nodeKey: z.string().min(1), // Unique key for the node
  nodeType: NodeType, // Type of node (trigger, action, etc.)
  actionType: ActionType.optional(),
  label: z.string().min(1, "Node label is required"),
  description: z.string().optional(),
  config: z.record(z.any(), z.any()),
  positionX: z.number(), // X coordinate
  positionY: z.number(), // Y coordinate
});
...
export const workflowEdgeSchema = z.object({
  id: z.string().min(1).optional(), // Optional for creation, generated by backend
  sourceNodeId: z.string().min(1), // ID of source node (nodeKey)
  targetNodeId: z.string().min(1), // ID of target node (nodeKey)
