            ...
            {showCloseButton && (
              <div className="absolute right-2 top-2 z-20">
                <Button
                  ...
                  className="rounded-sm px-1.5 transition-[border-color,box-shadow] duration-100 ease-in-out focus:border focus:border-foreground focus:outline-hidden focus:ring-4 focus:ring-foreground/20 disabled:pointer-events-none [&_svg]:size-4 "
                >
