    ...
    >
      <Popover>
        ...
        >
          {uniqueSorting.length > 0 ? (
            <div className="flex flex-col gap-1">
              ...
              <p className="text-sm text-muted-foreground">
                Sorting is currently under BETA
              </p>
            </div>
          ) : (
            <div className="flex flex-col gap-1">
          ...
          <div className="flex max-h-40 flex-col gap-2 overflow-y-auto p-2">
                      ...
                      <Popover modal>
                        <PopoverTrigger asChild>
                          <Button
                            ...
                            size="sm"
                            role="combobox"
                            className="h-8 w-44 justify-between gap-2 rounded border-muted-foreground/20 bg-muted px-1.5 data-[state=open]:border-blue-600 data-[state=open]:outline-hidden data-[state=open]:ring-4 data-[state=open]:ring-blue-600/20"
                          ...
                          >
                            ...
                            <div className="ml-auto flex items-center gap-1">
                              ...
                              initialSorting[0]?.id === sort.id ? (
                                <Badge
                                  withDot={false}
                                  className="h-[1.125rem] rounded px-1 font-mono text-2xs font-normal"
                                >
                                  Default
                                </Badge>
                              ) : null}
