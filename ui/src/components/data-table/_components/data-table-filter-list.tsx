          ...
          <FacetedFilter>
            <FacetedFilterTrigger asChild>
              <Button
                ...
                className="w-full justify-start gap-2 rounded px-1.5 text-left text-muted-foreground hover:text-muted-foreground"
              >
                        ...
                        filterField?.options
                          ...
                          .map((option) => (
                            <Badge
                              withDot={false}
                              key={option.value}
                              className="truncate rounded-sm px-1 text-2xs font-normal"
                            >
                              {option.label}
                            </Badge>
                          ))
      ...
      case "date": {
        ...
        return (
          <Popover>
            ...
            <PopoverContent id={`${inputId}-calendar`} className="w-auto p-0">
  ...
  return (
    ...
    >
      <Popover
        ...
        onOpenChange={(open) => setFilterPopoverOpen(open)}
      >
        <PopoverTrigger asChild>
          <Button
            variant="outline"
          ...
          >
            <Icon icon={faBarsFilter} className="size-3" aria-hidden="true" />
            Filters
            {filters.length > 0 && (
              <Badge
                withDot={false}
                variant="secondary"
                className="h-[1.14rem] rounded-[0.2rem] px-[0.32rem] font-mono text-2xs font-normal"
              >
                {filters.length}
              </Badge>
            )}
        ...
        >
          ...
          <div className="flex max-h-40 flex-col gap-2 overflow-y-auto px-2 py-1">
