...
export const ExportDCModal: React.FC = ({}) => {
  const [loading, setLoading] = React.useState<boolean>(false);
  const [showExportModal, setShowExportModal] =
    divisionCodeTableStore.use("exportModalOpen");

  const { data: columnsData, isLoading: isColumnsLoading } = useQuery({
    queryKey: ["division-code-columns"],
    queryFn: () => getColumns("DivisionCode"),
  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Content>
          <Modal.Header>
            <Modal.Title>Export Division Codes</Modal.Title>
            <Modal.CloseButton />
          </Modal.Header>
          <Modal.Body>
            {isColumnsLoading ? (
