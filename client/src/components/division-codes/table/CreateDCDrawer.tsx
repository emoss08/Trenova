...
export const CreateDCDrawer: React.FC = () => {
  ...
  const mutation = useMutation(
      ...
      axios.post(`/division_codes/`, values),
    {
      onSuccess: () => {
        queryClient
          .invalidateQueries(["division-code-table-data", "division_codes"])
          .then(() => {
            notifications.show({
              title: "Success",
  ...
  const CreateDivisionCodeSchema = Yup.object().shape({
    ...
    ap_account: Yup.string().nullable(),
    cash_account: Yup.string().nullable(),
