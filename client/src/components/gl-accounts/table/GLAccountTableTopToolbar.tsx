...
export const GLAccountTableTopToolbar: React.FC<TopToolbarProps> = ({
  table,
}) => {
  const [showColumnFilters, setShowColumnFilters] =
    generalLedgerTableStore.use("columnFilters");
      ...
      >
        ...
        >
          ...
          <Button
            ...
            onClick={() => generalLedgerTableStore.set("exportModalOpen", true)}
          >
            Export
          </Button>
          <Button
            color="blue"
            onClick={() => generalLedgerTableStore.set("createModalOpen", true)}
