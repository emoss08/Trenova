...
export const ExportUsersModal: React.FC<ExportModalProps> = ({
  onClose,
  opened,
}) => {
  const [columns, setColumns] = useState<ExportModelOptionType[]>([]);
  const [loading, setLoading] = React.useState<boolean>(false);

  useEffect(() => {
    axios.get("get_columns/?model_name=User").then((res) => {
      const columnNames = res.data.results as string[];
  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Content>
          <Modal.Header>
            <Modal.Title>Export Users</Modal.Title>
            <Modal.CloseButton />
          </Modal.Header>
          <Modal.Body>
