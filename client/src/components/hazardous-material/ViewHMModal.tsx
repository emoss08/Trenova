...
import { ViewHMModalForm } from "@/components/hazardous-material/_partials/ViewHMModalForm";

export const ViewHMModal: React.FC = () => {
  const [showViewModal, setShowViewModal] =
    hazardousMaterialTableStore.use("viewModalOpen");
