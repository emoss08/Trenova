...
export const PTO_TYPE_META: Record<PTOType, PTOTypeMeta> = {
  Vacation: {
    label: "Vacation",
    badgeVariant: "info",
    barClass: "bg-accent-violet/80 text-foreground-on-solid",
  ...
  Sick: {
    label: "Sick",
    badgeVariant: "danger",
    barClass: "bg-danger/80 text-foreground-on-solid",
    dotClass: "bg-danger",
  ...
  Holiday: {
    label: "Holiday",
    badgeVariant: "info",
    barClass: "bg-info/80 text-foreground-on-solid",
    dotClass: "bg-info",
  ...
  Bereavement: {
    ...
    barClass: "bg-success/80 text-foreground-on-solid",
    dotClass: "bg-success",
  ...
  Maternity: {
    label: "Maternity",
    badgeVariant: "info",
    barClass: "bg-accent-rose/80 text-foreground-on-solid",
  ...
  Paternity: {
    label: "Paternity",
    badgeVariant: "info",
    barClass: "bg-accent-teal/80 text-foreground-on-solid",
...
export function ptoTypeMeta(type: PTOType | string): PTOTypeMeta {
  return (
    PTO_TYPE_META[type as PTOType] ?? {
      ...
      barClass: "bg-muted-foreground/60 text-foreground-on-solid",
