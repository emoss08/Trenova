...
export function ChargePayerChip({
  ...
  if (rows.length === 1) {
    return (
      <span
        className="text-2xs shrink-0 rounded bg-indigo-500/10 px-1 py-0.5 text-indigo-600 dark:text-indigo-400"
  ...
  return (
    <Tooltip>
      <TooltipTrigger>
        <span
          className="text-2xs flex shrink-0 items-center gap-1 rounded bg-indigo-500/10 px-1 py-0.5 text-indigo-600 dark:text-indigo-400"
          data-testid="charge-payer-chip"
        >
