...
const DEFAULT_ACCEPT = ".pdf,.jpg,.jpeg,.png,.webp,.gif,.doc,.docx,.xls,.xlsx,.txt,.csv";
...
export const DocumentUploadZone = forwardRef<DocumentUploadZoneHandle, DocumentUploadZoneProps>(
