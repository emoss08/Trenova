...
const TOOL_TITLES: Record<string, string> = {
  ...
  list_formula_templates: "List rating methods",
  ask_user: "Ask you to choose",
  find_tools: "Look for a tool",
  find_in_trenova: "Search the product guide",
  open_page: "Open a page",
  accept_field: "Accept a field",
  accept_all_confident: "Accept confident fields",
  set_field_value: "Set a field",
  set_required_field: "Choose a required record",
  set_stop_location: "Match a stop to a location",
  set_stop_schedule: "Schedule a stop",
  create_location: "Create location",
  describe_formula_schema: "Read the formula reference",
  test_formula_expression: "Price a formula",
  propose_formula: "Propose a formula",
