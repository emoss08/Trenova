      ...
      render={({ field: { value, onChange, disabled, onBlur, name, ref }, fieldState }) => (
        <div
          className={cn(
            ...
            outlined &&
              "border-input bg-field has-data-[state=checked]:border-foreground has-data-[state=checked]:ring-foreground/20 border transition-[border-color,box-shadow] duration-200 ease-in-out has-data-[state=checked]:ring-4",
          )}
        >
          <Checkbox
            id={inputId}
