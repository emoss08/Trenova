...
function injectSensitiveBadgesIntoHtml(html: string): string {
  const badge =
    '<span title="Sensitive data omitted" class="ml-1 inline-flex h-4 select-none items-center rounded-md border border-warning-border bg-warning-subtle px-1 text-2xs leading-none text-warning-foreground">Sensitive</span>';
