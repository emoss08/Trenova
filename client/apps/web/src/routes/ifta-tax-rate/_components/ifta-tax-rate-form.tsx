        ...
        <FormGroup cols={2}>
          <FormControl>
            <NumberField
              ...
              max={IFTA_MAX_YEAR}
              rules={{ required: true }}
              description={t("The calendar year of the quarter the rate was published for.")}
            />
          </FormControl>
          <FormControl>
            <SelectField
          ...
          <FormControl>
            <IftaJurisdictionAutocompleteField<IftaTaxRateFormValues>
              ...
              description={t("The state or province that levies the tax.")}
            />
          </FormControl>
          <FormControl>
            <SelectField
        ...
        <FormGroup cols={2}>
          <FormControl>
            <InputField
              control={control}
              name="ratePerGallon"
              label={t("Rate per gallon")}
              placeholder="0.2000"
              inputMode="decimal"
              rules={{ required: true }}
              description={t("Up to four decimals. Zero is a published rate, not a missing one.")}
            />
          </FormControl>
          <FormControl>
            <InputField
              ...
              placeholder="0.1100"
              inputMode="decimal"
              description={t("Only for jurisdictions that publish one. Empty is stored as zero.")}
            />
          </FormControl>
        </FormGroup>
      </FormSection>
        ...
        <FormGroup cols={1}>
          <FormControl>
            <InputField
              ...
              maxLength={500}
              description={t("A link to the matrix page or bulletin the rate was taken from.")}
            />
          </FormControl>
          <FormControl>
            <TextareaField
