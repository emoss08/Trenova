        ...
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            <span className="mt-2 block">
              {t("A return already generated for {0} keeps its figures until it is recomputed, so recompute the return after deleting if the quarter is still open. {1}", quarter ?? "its quarter", purchase?.source === "CardImport"
