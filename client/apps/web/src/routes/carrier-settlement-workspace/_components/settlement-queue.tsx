      ...
      >
        {loading ? (
          ...
          <BillingListEmpty
            ...
            description={
              hasActiveFilters
                ? "No settlement fits the search and status chip. Widen them, or clear them to see the whole queue."
                : "Every settlement in this pay period has been voided. Generate again once new cost has accrued."
            }
