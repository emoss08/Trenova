/**
 * The Web Speech API's recognition side, which TypeScript's DOM library does
 * not declare. Only what the composer's dictation uses is described; the
 * vendor-prefixed constructor is the one Chromium and Safari expose.
 */
