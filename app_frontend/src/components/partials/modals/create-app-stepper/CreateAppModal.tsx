...
import { StepperComponent } from "@/utils/assets/ts/components";
...
const modalsRoot = typeof document !== 'undefined' ? document.getElementById('root-modals') || document.body : null;
    ...
    >
      <div className='modal-header'>
        ...
        <div className='btn btn-sm btn-icon btn-active-color-primary' onClick={handleClose}>
          <img className='svg-icon-1' src='/media/icons/duotune/arrows/arr061.svg' />
        </div>
        {/* end::Close */}
      </div>
