  ...
  return (
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 pt-5'>
        ...
        <div className='card-toolbar' data-mt-buttons='true'>
          <a
            ...
            id='mt_charts_widget_5_year_btn'
          >
            Year
          </a>
          ...
          <a
            ...
            id='mt_charts_widget_5_month_btn'
          >
            Month
          </a>
          ...
          <a
            ...
            id='mt_charts_widget_5_week_btn'
          >
            Week
          </a>
        </div>
      ...
      <div className='card-body'>
        {/* begin::Chart */}
        <div ref={chartRef} id='mt_charts_widget_5_chart' style={{height: '350px'}}></div>
        {/* end::Chart */}
      </div>
      {/* end::Body */}
    </div>
