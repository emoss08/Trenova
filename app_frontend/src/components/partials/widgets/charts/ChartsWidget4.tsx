  ...
  return (
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 pt-5'>
        ...
        {/* begin::Toolbar */}
        <div className='card-toolbar' data-mt-buttons='true'>
          <a
            className='btn btn-sm btn-color-muted btn-active btn-active-primary active px-4 me-1'
            id='mt_charts_widget_4_year_btn'
          >
            Year
          </a>
          ...
          <a
            ...
            id='mt_charts_widget_4_month_btn'
          >
            Month
          </a>
          ...
          <a
            ...
            id='mt_charts_widget_4_week_btn'
          >
            Week
          </a>
        </div>
      ...
      <div className='card-body'>
        {/* begin::Chart */}
        <div ref={chartRef} id='mt_charts_widget_4_chart' style={{height: '350px'}}></div>
        {/* end::Chart */}
      </div>
      {/* end::Body */}
    </div>
