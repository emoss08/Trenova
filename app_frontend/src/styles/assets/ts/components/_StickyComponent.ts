...
class StickyComponent {
  ...
  constructor(_element: HTMLElement, options: StickyOptions) {
    ...
    this.instanceName = this.element.getAttribute('data-mt-sticky-name')
    this.attributeName = 'data-mt-sticky-' + this.instanceName
  ...
  private getOption = (name: string) => {
    const dataStickyAttr = 'data-mt-sticky-' + name
  ...
  public static bootstrap(attr: string = '[data-mt-sticky="true"]') {
    StickyComponent.createInstances(attr)
  }

  public static reInitialization(attr: string = '[data-mt-sticky="true"]') {
    StickyComponent.createInstances(attr)
  }
}
