...
class MenuComponent {
  ...
  constructor(_element: HTMLElement, options: MenuOptions) {
    ...
    // this.element.setAttribute('data-mt-menu', 'true')
  ...
  private _setTriggerElement = () => {
    const target = document.querySelector(
      `[data-mt-menu-target="#${this.element.getAttribute('id')}"`
    )

    if (target) {
      this.triggerElement = target as HTMLElement
    } else if (this.element.closest('[data-mt-menu-trigger]')) {
      this.triggerElement = this.element.closest('[data-mt-menu-trigger]') as HTMLElement
    } else if (
      this.element.parentNode &&
      getElementChild(this.element.parentNode as HTMLElement, '[data-mt-menu-trigger]')
    ) {
      const child = getElementChild(
        this.element.parentNode as HTMLElement,
        '[data-mt-menu-trigger]'
      )
      if (child) {
  ...
  private _getItemOption = (item: HTMLElement, name: string) => {
    ...
    if (item && item.hasAttribute('data-mt-menu-' + name)) {
      const attr = item.getAttribute('data-mt-menu-' + name) || ''
  ...
  private _getItemElement = (_element: HTMLElement): HTMLElement | undefined => {
    ...
    if (_element.hasAttribute('data-mt-menu-trigger')) {
      return _element
    }
    ...
    const item = _element.closest<HTMLElement>('.menu-item[data-mt-menu-trigger]')
    if (item) {
      return item
    }
  ...
  private _getItemParentElement = (item: HTMLElement) => {
    ...
    const parentItem = sub.closest<HTMLElement>('.menu-item[data-mt-menu-trigger]')
    if (sub && parentItem) {
      return parentItem
    }
  ...
  private _getItemChildElement = (item: HTMLElement): HTMLElement | null => {
    ...
    if (selector) {
      //element = selector.querySelector('.show.menu-item[data-mt-menu-trigger]');
      const element = selector.querySelector<HTMLElement>('.menu-item[data-mt-menu-trigger]')
      if (element) {
        return element
      }
    }
  ...
  private _hasItemSub = (item: HTMLElement) => {
    return item.classList.contains('menu-item') && item.hasAttribute('data-mt-menu-trigger')
  }
  ...
  private _hideAccordions = (item: HTMLElement) => {
    const itemsToHide = this.element.querySelectorAll('.show[data-mt-menu-trigger]')
  ...
  private _update = () => {
    const items = this.element.querySelectorAll('.menu-item[data-mt-menu-trigger]')
  ...
  public static hideDropdowns = (skip: HTMLElement | undefined) => {
    const items = document.querySelectorAll<HTMLElement>(
      '.show.menu-dropdown[data-mt-menu-trigger]'
    )
  ...
  public static updateDropdowns = () => {
    const items = document.querySelectorAll('.show.menu-dropdown[data-mt-menu-trigger]')
    if (items && items.length > 0) {
  ...
  public static initGlobalHandlers = () => {
    ...
    document.addEventListener('click', (e) => {
      var menuItems = document.querySelectorAll('.show.menu-dropdown[data-mt-menu-trigger]:not([data-mt-menu-static="true"])');
    ...
    DOMEventHandlerUtil.on(
      document.body,
      '.menu-item[data-mt-menu-trigger] > .menu-link, [data-mt-menu-trigger]:not(.menu-item):not([data-mt-menu-trigger="auto"])',
      'click',
    ...
    DOMEventHandlerUtil.on(
      document.body,
      '.menu-item:not([data-mt-menu-trigger]) > .menu-link',
      'click',
      function (this: HTMLElement, e: Event) {
        e.stopPropagation()
    ...
    window.addEventListener('resize', () => {
      ...
      throttle(
        ...
        () => {
          ...
          const elements = document.querySelectorAll('[data-mt-menu="true"]')
          elements.forEach((el) => {
  ...
  public static bootstrap = () => {
    ...
    MenuComponent.createInstances('[data-mt-menu="true"]')
  }
