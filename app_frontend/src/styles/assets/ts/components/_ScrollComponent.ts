...
class ScrollComponent {
  ...
  constructor(_element: HTMLElement, options: ScrollOptions) {
    ...
    this.update()
    // this.element.setAttribute('data-mt-scrolltop', 'true')
    DataUtil.set(this.element, 'scroll', this)
  }

  private getOption = (name: string) => {
    if (this.element.hasAttribute('data-mt-scroll-' + name) === true) {
      const attr = this.element.getAttribute('data-mt-scroll-' + name) || ''
  ...
  public update = () => {
    ...
    if (
      ...
      !this.element.hasAttribute('data-mt-scroll-activate')
    ) {
      this.setupHeight()
  ...
  public static destroyAll(attr: string = '[data-mt-scroll="true"]') {}

  public static bootstrap(attr: string = '[data-mt-scroll="true"]') {
  ...
  public static reinitialization(attr: string = '[data-mt-scroll="true"]') {
    ScrollComponent.createInstances(attr)
  }

  public static updateAll() {
    const elements = document.body.querySelectorAll('[data-mt-scroll="true"]')
    elements.forEach((element: Element) => {
