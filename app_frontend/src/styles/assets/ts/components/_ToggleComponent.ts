...
class ToggleComponent {
  ...
  constructor(_element: HTMLElement, options: ToggleOptions) {
    ...
    const elementTargetAttr = this.element.getAttribute('data-mt-toggle-target')
    if (elementTargetAttr) {
      this.target = document.querySelector(elementTargetAttr)
    }
    const elementToggleAttr = this.element.getAttribute('data-mt-toggle-state')
    this.state = elementToggleAttr || ''
    const elementModeAttr = this.element.getAttribute('data-mt-toggle-mode')
    this.mode = elementModeAttr || ''
    this.attribute = 'data-mt-' + this.element.getAttribute('data-mt-toggle-name')
  ...
  public static reinitialization = () => {
    ToggleComponent.createInstances('[data-mt-toggle]')
  }
