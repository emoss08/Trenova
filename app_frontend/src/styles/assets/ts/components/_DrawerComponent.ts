...
class DrawerComponent {
  ...
  constructor(_element: HTMLElement, options: DrawerOptions) {
    ...
    this.name = this.element.getAttribute('data-mt-drawer-name') || ''
    this.shown = false
  ...
  private _update = () => {
    ...
    const bodyCanvasAttr = String(document.body.getAttribute(`data-mt-drawer-${this.name}-`))
  ...
  private _getOption = (name: string) => {
    const attr = this.element.getAttribute(`data-mt-drawer-${name}`)
    if (attr) {
  ...
  private _hide = () => {
    ...
    this.shown = false
    this._deleteOverlay()
    document.body.removeAttribute(`data-mt-drawer-${this.name}`)
    document.body.removeAttribute(`data-mt-drawer`)
  ...
  private _show = () => {
    ...
    this.shown = true
    this._createOverlay()
    document.body.setAttribute(`data-mt-drawer-${this.name}`, 'on')
    document.body.setAttribute('data-mt-drawer', 'on')
  ...
  public static handleDismiss = () => {
    ...
    DOMEventHandlerUtil.on(document.body, '[data-mt-drawer-dismiss="true"]', 'click', () => {
      /* @ts-ignore */
      const element = this.closest('[data-mt-drawer="true"]')
      if (element) {
    ...
    window.addEventListener('resize', function () {
      ...
      throttle(
        ...
        () => {
          ...
          const elements = document.body.querySelectorAll('[data-mt-drawer="true"]')
          elements.forEach((el) => {
  ...
  public static bootstrap = () => {
    DrawerComponent.createInstances('[data-mt-drawer="true"]')
