 ...
 */
type TStatusChoiceProps = "Active" | "Inactive";
...
export type WorkerTypeChoiceProps = "Employee" | "Contractor";

/** Returns comment type severity choices for a select input. */
export const workerTypeChoices = [
  { value: "Employee", label: "Employee", color: "#dc2626" },
  { value: "Contractor", label: "Contractor", color: "#2563eb" },
] satisfies ReadonlyArray<IChoiceProps<WorkerTypeChoiceProps>>;

/** Type for Worker Type */
export type WorkerEndorsementChoicesProps =
  | "None"
  | "Tanker"
  | "Hazmat"
  | "TankerHazmat";
...
/** Returns comment type severity choices for a select input. */
export const workerEndorsementChoices = [
  { value: "None", label: "None", color: "#16a34a" },
  { value: "Tanker", label: "Tanker", color: "#ca8a04" },
  { value: "Hazmat", label: "Hazmat", color: "#9333ea" },
  { value: "TankerHazmat", label: "X", color: "#2563eb" },
] satisfies ReadonlyArray<IChoiceProps<WorkerEndorsementChoicesProps>>;
