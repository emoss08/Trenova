...
var tagCatalog = map[string]tagDescriptor{
	...
	"GL Accounts": {
		Name:        "GL Accounts",
		DisplayName: "General Ledger Accounts",
		Group:       "Master Data",
	},
	"Fiscal Years": {
		Name:        "Fiscal Years",
	...
	"US States": {
		Name:        "US States",
		DisplayName: "U.S. States",
		Group:       "Master Data",
	},
	"DOT Hazmat References": {
		Name:        "DOT Hazmat References",
		DisplayName: "DOT Hazmat References",
		Group:       "Master Data",
	},
	"Hazardous Materials": {
	...
	"Hazmat Segregation Rules": {
		Name:        "Hazmat Segregation Rules",
		DisplayName: "Hazmat Segregation Rules",
		Group:       "Master Data",
	},
	"Accounting Controls": {
		Name:        "Accounting Controls",
		DisplayName: "Accounting Controls",
	...
	"Billing Controls": {
		...
		DisplayName: "Billing Controls",
		Group:       "Controls & Configuration",
	},
	"Dispatch Controls": {
		Name:        "Dispatch Controls",
		DisplayName: "Dispatch Controls",
		Group:       "Controls & Configuration",
	},
	"Shipment Controls": {
		Name:        "Shipment Controls",
		DisplayName: "Shipment Controls",
		Group:       "Controls & Configuration",
	},
	"Sequence Configs": {
		Name:        "Sequence Configs",
		DisplayName: "Sequence Configurations",
		Group:       "Controls & Configuration",
	},
	"Table Configurations": {
		Name:        "Table Configurations",
		DisplayName: "Table Configurations",
		Group:       "Controls & Configuration",
	},
	"Distance Overrides": {
		Name:        "Distance Overrides",
		DisplayName: "Distance Overrides",
		Group:       "Controls & Configuration",
	},
	"Formula Templates": {
