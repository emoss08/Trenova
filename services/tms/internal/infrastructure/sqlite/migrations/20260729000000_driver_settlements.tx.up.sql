...
CREATE TABLE IF NOT EXISTS settlement_controls(
    ...
    "variance_threshold_pct" NUMERIC NOT NULL DEFAULT 25,
    "variance_lookback_weeks" INTEGER NOT NULL DEFAULT 8,
    "default_escrow_interest_rate" NUMERIC NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS driver_pay_profiles(
    ...
    "per_diem_rate_per_mile" NUMERIC NOT NULL DEFAULT 0,
