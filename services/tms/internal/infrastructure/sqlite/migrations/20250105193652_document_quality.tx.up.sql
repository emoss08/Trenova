...
CREATE TABLE IF NOT EXISTS "document_quality_configs" (
    ...
    "min_brightness" NUMERIC NOT NULL DEFAULT 40,
    "max_brightness" NUMERIC NOT NULL DEFAULT 220,
    "min_contrast" NUMERIC NOT NULL DEFAULT 40,
    "min_sharpness" NUMERIC NOT NULL DEFAULT 50,
    "min_word_count" INTEGER NOT NULL DEFAULT 50,
    "min_text_density" NUMERIC NOT NULL DEFAULT 0.1,
    "model_id" TEXT NOT NULL,
    "allow_training" INTEGER NOT NULL DEFAULT 1,
    "auto_reject_score" NUMERIC NOT NULL DEFAULT 0.2,
    "manual_review_score" NUMERIC NOT NULL DEFAULT 0.4,
