...
CREATE TABLE IF NOT EXISTS "shipments"(
    ...
    "freight_charge_amount" REAL NOT NULL DEFAULT 0 CHECK ("freight_charge_amount" >= 0),
    "other_charge_amount" REAL NOT NULL DEFAULT 0 CHECK ("other_charge_amount" >= 0),
    "total_charge_amount" REAL NOT NULL DEFAULT 0 CHECK ("total_charge_amount" >= 0),
    "pieces" INTEGER,
    "weight" INTEGER,
    "canceled_by_id" TEXT,
    "canceled_at" INTEGER,
