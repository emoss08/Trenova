...
import (
	...
	"github.com/emoss08/trenova/internal/infrastructure/postgres/repositories/userpreferencerepository"
...
var Module = fx.Module("postgres-repositories",
	fx.Provide(
		...
		workflowrepository.NewNodeRepository,
		workflowrepository.NewConnectionRepository,
		workflowrepository.NewInstanceRepository,
		workflowrepository.NewNodeExecutionRepository,
		workflowrepository.NewVersionRepository,
