...
ALTER TABLE "trailers"
    ADD COLUMN IF NOT EXISTS search_vector tsvector GENERATED ALWAYS AS (
        ...
        setweight(immutable_to_tsvector('simple', COALESCE("vin", '')), 'B') ||
        setweight(immutable_to_tsvector('simple', COALESCE("license_plate_number", '')), 'C') ||
        setweight(immutable_to_tsvector('simple', COALESCE("registration_number", '')), 'D')
    ) STORED;
