...
CREATE TABLE IF NOT EXISTS "hazardous_materials"(
    ...
    "un_number" varchar(4),
    "packing_group" packing_group_enum NOT NULL,
    "subsidiary_hazard_class" varchar(20),
    "erg_guide_number" varchar(10),
    "label_codes" varchar(50),
    "special_provisions" text,
    "proper_shipping_name" text,
    "handling_instructions" text,
    "emergency_contact" text,
    "emergency_contact_phone_number" text,
    "quantity_threshold" varchar(20),
    ...
    "inhalation_hazard" boolean NOT NULL DEFAULT FALSE,
    -- Metadata
