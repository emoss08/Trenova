...
CREATE TABLE IF NOT EXISTS "dispatch_controls"(
    ...
    "enforce_worker_assign" boolean NOT NULL DEFAULT FALSE,
    "enforce_trailer_continuity" boolean NOT NULL DEFAULT FALSE,
    "enforce_hos_compliance" boolean NOT NULL DEFAULT FALSE,
    "enforce_worker_pta_restrictions" boolean NOT NULL DEFAULT FALSE,
    "enforce_worker_tractor_fleet_continuity" boolean NOT NULL DEFAULT FALSE,
    "enforce_driver_qualification_compliance" boolean NOT NULL DEFAULT FALSE,
    "enforce_medical_cert_compliance" boolean NOT NULL DEFAULT FALSE,
    "enforce_hazmat_compliance" boolean NOT NULL DEFAULT FALSE,
    "enforce_drug_and_alcohol_compliance" boolean NOT NULL DEFAULT FALSE,
