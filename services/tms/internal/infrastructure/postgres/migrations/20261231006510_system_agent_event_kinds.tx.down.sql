...
SET "event_kinds" = ARRAY['billing_queue.item_exception']::TEXT[],
...
UPDATE "agent_definitions"
SET "event_kinds" = ARRAY['shipment_move.coverage_at_risk']::TEXT[],
    "updated_at" = extract(epoch FROM current_timestamp)::bigint
WHERE "system_key" = 'dispatch_assignment'
  AND "event_kinds" = ARRAY['shipment_move.coverage_at_risk', 'shipment_move.unassigned']::TEXT[];
