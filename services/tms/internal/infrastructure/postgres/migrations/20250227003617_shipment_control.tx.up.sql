CREATE TABLE IF NOT EXISTS "shipment_controls"(
    ...
    "auto_delay_shipments" boolean NOT NULL DEFAULT FALSE,
    "auto_delay_shipments_threshold" integer DEFAULT 30,
    "track_detention_time" boolean NOT NULL DEFAULT FALSE,
    "auto_generate_detention_charges" boolean NOT NULL DEFAULT FALSE,
