DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'edi_tender_recipient_kind_enum') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'edi_tender_recipient_status_enum') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'edi_tender_recipient_baseline_status_enum') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'edi_tender_change_status_enum') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'edi_message_delivery_status_enum') THEN
