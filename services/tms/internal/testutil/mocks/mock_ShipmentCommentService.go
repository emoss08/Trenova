...
func (_mock *MockShipmentCommentService) ListByShipmentID(ctx context.Context, req *repositories.ListShipmentCommentsRequest) (*pagination.CursorListResult[*shipment.ShipmentComment], error) {
	ret := _mock.Called(ctx, req)
...
func (_c *MockShipmentCommentService_ListByShipmentID_Call) Return(cursorListResult *pagination.CursorListResult[*shipment.ShipmentComment], err error) *MockShipmentCommentService_ListByShipmentID_Call {
	_c.Call.Return(cursorListResult, err)
	return _c
}

func (_c *MockShipmentCommentService_ListByShipmentID_Call) RunAndReturn(run func(ctx context.Context, req *repositories.ListShipmentCommentsRequest) (*pagination.CursorListResult[*shipment.ShipmentComment], error)) *MockShipmentCommentService_ListByShipmentID_Call {
	_c.Call.Return(run)
	return _c
}
