...
func (h *Handler) RegisterRoutes(rg *gin.RouterGroup) {
	...
	api.GET(
		"/correction-groups/:correctionGroupID/",
		h.pm.RequirePermission(permission.ResourceInvoice.String(), permission.OpRead),
		h.groupLineage,
	)
	api.GET(
	...
	api.POST(
		...
		h.pm.RequirePermission(permission.ResourceInvoice.String(), permission.OpApprove),
		h.approve,
	)
	api.POST(
		"/:adjustmentID/reject/",
...
func (h *Handler) previewDraft(c *gin.Context) {
	...
	resp, err := h.service.PreviewDraft(
		c.Request.Context(),
...
func (h *Handler) submitDraft(c *gin.Context) {
	...
	resp, err := h.service.SubmitDraft(
		c.Request.Context(),
		&services.GetInvoiceAdjustmentDetailRequest{
			AdjustmentID: adjustmentID,
			TenantInfo: pagination.TenantInfo{
...
func (h *Handler) reconciliationExceptions(c *gin.Context) {
	...
	pagination.List(
		...
		req,
		h.eh,
		func() (*pagination.ListResult[*repositories.InvoiceAdjustmentReconciliationQueueItem], error) {
...
func (h *Handler) listBatches(c *gin.Context) {
	...
	pagination.List(
		...
		req,
		h.eh,
		func() (*pagination.ListResult[*invoiceadjustment.InvoiceAdjustmentBatch], error) {
