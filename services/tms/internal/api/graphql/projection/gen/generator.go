...
var nonProjectionObjects = map[string]string{
	...
	"FormulaTemplateVariableDefinition":  "GraphQL value object stored as JSONB without Bun projection metadata",
	"FormulaTemplateBreakdownDefinition": "GraphQL value object stored as JSONB without Bun projection metadata",
	...
	"HomeWidgetCategory":                 "GraphQL home widget catalog DTO",
	...
	"DocumentTemplatePreview":            "GraphQL template preview DTO",
	"ShipmentAxleWeight":                 "GraphQL shipment workflow DTO",
	"ShipmentContractRateAccessorial":    "GraphQL shipment workflow DTO",
	...
	// Assembled in Go from the documents table rather than stored; the parent
	// field is bun:"-", so there is no column to project.
	"ShipmentCommentAttachment": "GraphQL shipment comment DTO without Bun projection metadata",
