...
func TestGraphQLSurfaceLostOnEnforceIsReviewed(t *testing.T) {
	...
	require.ElementsMatchf(
		...
		[]string{
			...
			"workforce.self_service: Mutation.acknowledgeMyPolicy",
			"workforce.self_service: Mutation.inviteWorkerToPortal",
			"workforce.self_service: Mutation.revokeWorkerPortalAccess",
			"workforce.self_service: Mutation.updateMyContactInfo",
			"workforce.self_service: Mutation.withdrawMyProfileChange",
			"workforce.self_service: Query.myComplianceProfile",
			"workforce.self_service: Query.myCredentials",
			"workforce.self_service: Query.myPolicies",
			"workforce.self_service: Query.myPolicyDocumentUrl",
			"workforce.self_service: Query.myProfileChangeRequests",
			"workforce.self_service: Query.workerPortalStatus",
			...
			"workforce.time_off: Mutation.cancelMyPto",
			"workforce.time_off: Mutation.requestMyPto",
			"workforce.time_off: Query.myLeave",
			"workforce.time_off: Query.myPto",
			"workforce.time_off: Query.myPtoBalances",
			"workforce.time_off: pto_policy.graphqls",
			"workforce.time_off: worker_leave.graphqls",
			"workforce.time_tracking: Mutation.proposeMyShiftSwap",
			"workforce.time_tracking: Mutation.respondToMyShiftSwap",
			"workforce.time_tracking: Mutation.setMyAvailability",
			"workforce.time_tracking: Query.myAvailability",
			"workforce.time_tracking: Query.mySchedule",
			"workforce.time_tracking: Query.myShiftSwaps",
