...
func (b *SequenceQueryBuilder) WithBusinessUnit() *SequenceRelationChainBuilder {
	chain := &SequenceRelationChainBuilder{
		parent: b,
		chain:  NewSequenceRelationChain(),
	}
...
func (b *SequenceQueryBuilder) WithOrganization() *SequenceRelationChainBuilder {
	chain := &SequenceRelationChainBuilder{
		parent: b,
		chain:  NewSequenceRelationChain(),
	}
