...
// ReportMetadataRelationChain provides a fluent API for building nested relationship chains
type ReportMetadataRelationChain struct {
	relations []string
	options   map[string]func(*bun.SelectQuery) *bun.SelectQuery
}

// NewReportMetadataRelationChain creates a new relation chain builder
func NewReportMetadataRelationChain() *ReportMetadataRelationChain {
	return &ReportMetadataRelationChain{
		relations: []string{},
...
func (rc *ReportMetadataRelationChain) Add(relation string, opts ...func(*bun.SelectQuery) *bun.SelectQuery) *ReportMetadataRelationChain {
...
func (rc *ReportMetadataRelationChain) Build() []string {
	return rc.relations
}

// Apply applies the relation chain to a query
func (rc *ReportMetadataRelationChain) Apply(q *bun.SelectQuery) *bun.SelectQuery {
...
func (b *ReportMetadataQueryBuilder) WithBusinessUnit() *ReportMetadataRelationChainBuilder {
	chain := &ReportMetadataRelationChainBuilder{
		parent: b,
		chain:  NewReportMetadataRelationChain(),
	}
...
func (b *ReportMetadataQueryBuilder) WithOrganization() *ReportMetadataRelationChainBuilder {
	chain := &ReportMetadataRelationChainBuilder{
		parent: b,
		chain:  NewReportMetadataRelationChain(),
	}
...
// ReportMetadataRelationChainBuilder provides fluent API for building nested relations
type ReportMetadataRelationChainBuilder struct {
	parent *ReportMetadataQueryBuilder
	chain  *ReportMetadataRelationChain
}

// Load applies the relation chain and returns to the parent builder
func (rb *ReportMetadataRelationChainBuilder) Load() *ReportMetadataQueryBuilder {
	rb.parent.query = rb.chain.Apply(rb.parent.query)
	return rb.parent
}

// ThenLoad adds another relation to the chain
func (rb *ReportMetadataRelationChainBuilder) ThenLoad(relation string, opts ...func(*bun.SelectQuery) *bun.SelectQuery) *ReportMetadataRelationChainBuilder {
	rb.chain.Add(relation, opts...)
	return rb
}

// OrderBy adds ordering to the current relation in the chain
func (rb *ReportMetadataRelationChainBuilder) OrderBy(order string) *ReportMetadataRelationChainBuilder {
...
func (rb *ReportMetadataRelationChainBuilder) Where(condition string, args ...interface{}) *ReportMetadataRelationChainBuilder {
	if len(rb.chain.relations) > 0 {
		lastRel := rb.chain.relations[len(rb.chain.relations)-1]
		currentOpt := rb.chain.options[lastRel]
		rb.chain.options[lastRel] = func(q *bun.SelectQuery) *bun.SelectQuery {
