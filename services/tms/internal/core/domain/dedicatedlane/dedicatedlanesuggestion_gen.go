...
// DedicatedLaneSuggestionRelationChain provides a fluent API for building nested relationship chains
type DedicatedLaneSuggestionRelationChain struct {
	relations []string
	options   map[string]func(*bun.SelectQuery) *bun.SelectQuery
}

// NewDedicatedLaneSuggestionRelationChain creates a new relation chain builder
func NewDedicatedLaneSuggestionRelationChain() *DedicatedLaneSuggestionRelationChain {
	return &DedicatedLaneSuggestionRelationChain{
		relations: []string{},
...
func (rc *DedicatedLaneSuggestionRelationChain) Add(relation string, opts ...func(*bun.SelectQuery) *bun.SelectQuery) *DedicatedLaneSuggestionRelationChain {
...
func (rc *DedicatedLaneSuggestionRelationChain) Build() []string {
	return rc.relations
}

// Apply applies the relation chain to a query
func (rc *DedicatedLaneSuggestionRelationChain) Apply(q *bun.SelectQuery) *bun.SelectQuery {
...
func (b *DedicatedLaneSuggestionQueryBuilder) WithBusinessUnit() *DedicatedLaneSuggestionRelationChainBuilder {
	chain := &DedicatedLaneSuggestionRelationChainBuilder{
		parent: b,
		chain:  NewDedicatedLaneSuggestionRelationChain(),
	}
...
func (b *DedicatedLaneSuggestionQueryBuilder) WithOrganization() *DedicatedLaneSuggestionRelationChainBuilder {
	chain := &DedicatedLaneSuggestionRelationChainBuilder{
		parent: b,
		chain:  NewDedicatedLaneSuggestionRelationChain(),
	}
...
func (b *DedicatedLaneSuggestionQueryBuilder) WithCustomer() *DedicatedLaneSuggestionRelationChainBuilder {
	chain := &DedicatedLaneSuggestionRelationChainBuilder{
		parent: b,
		chain:  NewDedicatedLaneSuggestionRelationChain(),
	}
...
func (b *DedicatedLaneSuggestionQueryBuilder) WithOriginLocation() *DedicatedLaneSuggestionRelationChainBuilder {
	chain := &DedicatedLaneSuggestionRelationChainBuilder{
		parent: b,
		chain:  NewDedicatedLaneSuggestionRelationChain(),
	}
...
func (b *DedicatedLaneSuggestionQueryBuilder) WithDestinationLocation() *DedicatedLaneSuggestionRelationChainBuilder {
	chain := &DedicatedLaneSuggestionRelationChainBuilder{
		parent: b,
		chain:  NewDedicatedLaneSuggestionRelationChain(),
	}
...
func (b *DedicatedLaneSuggestionQueryBuilder) WithServiceType() *DedicatedLaneSuggestionRelationChainBuilder {
	chain := &DedicatedLaneSuggestionRelationChainBuilder{
		parent: b,
		chain:  NewDedicatedLaneSuggestionRelationChain(),
	}
...
func (b *DedicatedLaneSuggestionQueryBuilder) WithShipmentType() *DedicatedLaneSuggestionRelationChainBuilder {
	chain := &DedicatedLaneSuggestionRelationChainBuilder{
		parent: b,
		chain:  NewDedicatedLaneSuggestionRelationChain(),
	}
...
func (b *DedicatedLaneSuggestionQueryBuilder) WithTractorType() *DedicatedLaneSuggestionRelationChainBuilder {
	chain := &DedicatedLaneSuggestionRelationChainBuilder{
		parent: b,
		chain:  NewDedicatedLaneSuggestionRelationChain(),
	}
...
func (b *DedicatedLaneSuggestionQueryBuilder) WithTrailerType() *DedicatedLaneSuggestionRelationChainBuilder {
	chain := &DedicatedLaneSuggestionRelationChainBuilder{
		parent: b,
		chain:  NewDedicatedLaneSuggestionRelationChain(),
	}
...
// WithProcessedBy creates a relation chain starting with ProcessedBy
func (b *DedicatedLaneSuggestionQueryBuilder) WithProcessedBy() *DedicatedLaneSuggestionRelationChainBuilder {
	chain := &DedicatedLaneSuggestionRelationChainBuilder{
		parent: b,
		chain:  NewDedicatedLaneSuggestionRelationChain(),
	}
	chain.chain.Add("ProcessedBy")
	return chain
}

// WithCreatedDedicatedLane creates a relation chain starting with CreatedDedicatedLane
func (b *DedicatedLaneSuggestionQueryBuilder) WithCreatedDedicatedLane() *DedicatedLaneSuggestionRelationChainBuilder {
	chain := &DedicatedLaneSuggestionRelationChainBuilder{
		parent: b,
		chain:  NewDedicatedLaneSuggestionRelationChain(),
	}
	chain.chain.Add("CreatedDedicatedLane")
	return chain
}

// DedicatedLaneSuggestionRelationChainBuilder provides fluent API for building nested relations
type DedicatedLaneSuggestionRelationChainBuilder struct {
	parent *DedicatedLaneSuggestionQueryBuilder
	chain  *DedicatedLaneSuggestionRelationChain
}

// Load applies the relation chain and returns to the parent builder
func (rb *DedicatedLaneSuggestionRelationChainBuilder) Load() *DedicatedLaneSuggestionQueryBuilder {
	rb.parent.query = rb.chain.Apply(rb.parent.query)
	return rb.parent
}

// ThenLoad adds another relation to the chain
func (rb *DedicatedLaneSuggestionRelationChainBuilder) ThenLoad(relation string, opts ...func(*bun.SelectQuery) *bun.SelectQuery) *DedicatedLaneSuggestionRelationChainBuilder {
	rb.chain.Add(relation, opts...)
	return rb
}

// OrderBy adds ordering to the current relation in the chain
func (rb *DedicatedLaneSuggestionRelationChainBuilder) OrderBy(order string) *DedicatedLaneSuggestionRelationChainBuilder {
...
func (rb *DedicatedLaneSuggestionRelationChainBuilder) Where(condition string, args ...interface{}) *DedicatedLaneSuggestionRelationChainBuilder {
	if len(rb.chain.relations) > 0 {
		lastRel := rb.chain.relations[len(rb.chain.relations)-1]
		currentOpt := rb.chain.options[lastRel]
		rb.chain.options[lastRel] = func(q *bun.SelectQuery) *bun.SelectQuery {
