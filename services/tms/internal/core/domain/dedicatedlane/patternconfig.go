...
var (
	...
	_ validationframework.TenantedEntity = (*PatternConfig)(nil)
)
...
type PatternConfig struct {
	...
	WeightRecentShipments bool            `json:"weightRecentShipments" bun:"weight_recent_shipments,type:BOOLEAN,notnull"`
