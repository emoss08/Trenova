...
// PatternConfigRelationChain provides a fluent API for building nested relationship chains
type PatternConfigRelationChain struct {
	relations []string
	options   map[string]func(*bun.SelectQuery) *bun.SelectQuery
}

// NewPatternConfigRelationChain creates a new relation chain builder
func NewPatternConfigRelationChain() *PatternConfigRelationChain {
	return &PatternConfigRelationChain{
		relations: []string{},
...
func (rc *PatternConfigRelationChain) Add(relation string, opts ...func(*bun.SelectQuery) *bun.SelectQuery) *PatternConfigRelationChain {
...
func (rc *PatternConfigRelationChain) Build() []string {
	return rc.relations
}

// Apply applies the relation chain to a query
func (rc *PatternConfigRelationChain) Apply(q *bun.SelectQuery) *bun.SelectQuery {
...
func (b *PatternConfigQueryBuilder) WithBusinessUnit() *PatternConfigRelationChainBuilder {
	chain := &PatternConfigRelationChainBuilder{
		parent: b,
		chain:  NewPatternConfigRelationChain(),
	}
...
func (b *PatternConfigQueryBuilder) WithOrganization() *PatternConfigRelationChainBuilder {
	chain := &PatternConfigRelationChainBuilder{
		parent: b,
		chain:  NewPatternConfigRelationChain(),
	}
...
// PatternConfigRelationChainBuilder provides fluent API for building nested relations
type PatternConfigRelationChainBuilder struct {
	parent *PatternConfigQueryBuilder
	chain  *PatternConfigRelationChain
}

// Load applies the relation chain and returns to the parent builder
func (rb *PatternConfigRelationChainBuilder) Load() *PatternConfigQueryBuilder {
	rb.parent.query = rb.chain.Apply(rb.parent.query)
	return rb.parent
}

// ThenLoad adds another relation to the chain
func (rb *PatternConfigRelationChainBuilder) ThenLoad(relation string, opts ...func(*bun.SelectQuery) *bun.SelectQuery) *PatternConfigRelationChainBuilder {
	rb.chain.Add(relation, opts...)
	return rb
}

// OrderBy adds ordering to the current relation in the chain
func (rb *PatternConfigRelationChainBuilder) OrderBy(order string) *PatternConfigRelationChainBuilder {
...
func (rb *PatternConfigRelationChainBuilder) Where(condition string, args ...interface{}) *PatternConfigRelationChainBuilder {
	if len(rb.chain.relations) > 0 {
		lastRel := rb.chain.relations[len(rb.chain.relations)-1]
		currentOpt := rb.chain.options[lastRel]
		rb.chain.options[lastRel] = func(q *bun.SelectQuery) *bun.SelectQuery {
