...
var (
	...
	_ validationframework.TenantedEntity = (*Suggestion)(nil)
...
type Suggestion struct {
	...
	// CreatedDedicatedLane *               `json:"createdDedicatedLane,omitzero" bun:"rel:belongs-to,join:created_dedicated_lane_id=id"`
}
