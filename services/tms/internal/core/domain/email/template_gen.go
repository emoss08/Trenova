...
func (b *TemplateQueryBuilder) WithBusinessUnit() *TemplateRelationChainBuilder {
	chain := &TemplateRelationChainBuilder{
		parent: b,
		chain:  NewTemplateRelationChain(),
	}
...
func (b *TemplateQueryBuilder) WithOrganization() *TemplateRelationChainBuilder {
	chain := &TemplateRelationChainBuilder{
		parent: b,
		chain:  NewTemplateRelationChain(),
	}
