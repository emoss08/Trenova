...
type BillingControl struct {
	...
	SendAutoBillNotifications     bool              `json:"sendAutoBillNotifications"     bun:"send_auto_bill_notifications,type:BOOLEAN,notnull,default:false"`    // * Send notifications when invoices are generated through the automated billing process
