...
type ShipmentControl struct {
	...
	AutoCancelShipments          bool      `json:"autoCancelShipments"          bun:"auto_cancel_shipments,type:BOOLEAN,notnull"`
	TrackDetentionTime           bool      `json:"trackDetentionTime"           bun:"track_detention_time,type:BOOLEAN,notnull"`
	AutoGenerateDetentionCharges bool      `json:"autoGenerateDetentionCharges" bun:"auto_generate_detention_charges,type:BOOLEAN,notnull"`
