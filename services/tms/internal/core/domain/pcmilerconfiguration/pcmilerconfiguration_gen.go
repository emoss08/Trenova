...
// PCMilerConfigurationRelationChain provides a fluent API for building nested relationship chains
type PCMilerConfigurationRelationChain struct {
	relations []string
	options   map[string]func(*bun.SelectQuery) *bun.SelectQuery
}

// NewPCMilerConfigurationRelationChain creates a new relation chain builder
func NewPCMilerConfigurationRelationChain() *PCMilerConfigurationRelationChain {
	return &PCMilerConfigurationRelationChain{
		relations: []string{},
...
func (rc *PCMilerConfigurationRelationChain) Add(relation string, opts ...func(*bun.SelectQuery) *bun.SelectQuery) *PCMilerConfigurationRelationChain {
...
func (rc *PCMilerConfigurationRelationChain) Build() []string {
	return rc.relations
}

// Apply applies the relation chain to a query
func (rc *PCMilerConfigurationRelationChain) Apply(q *bun.SelectQuery) *bun.SelectQuery {
...
func (b *PCMilerConfigurationQueryBuilder) WithBusinessUnit() *PCMilerConfigurationRelationChainBuilder {
	chain := &PCMilerConfigurationRelationChainBuilder{
		parent: b,
		chain:  NewPCMilerConfigurationRelationChain(),
	}
...
func (b *PCMilerConfigurationQueryBuilder) WithOrganization() *PCMilerConfigurationRelationChainBuilder {
	chain := &PCMilerConfigurationRelationChainBuilder{
		parent: b,
		chain:  NewPCMilerConfigurationRelationChain(),
	}
...
// PCMilerConfigurationRelationChainBuilder provides fluent API for building nested relations
type PCMilerConfigurationRelationChainBuilder struct {
	parent *PCMilerConfigurationQueryBuilder
	chain  *PCMilerConfigurationRelationChain
}

// Load applies the relation chain and returns to the parent builder
func (rb *PCMilerConfigurationRelationChainBuilder) Load() *PCMilerConfigurationQueryBuilder {
	rb.parent.query = rb.chain.Apply(rb.parent.query)
	return rb.parent
}

// ThenLoad adds another relation to the chain
func (rb *PCMilerConfigurationRelationChainBuilder) ThenLoad(relation string, opts ...func(*bun.SelectQuery) *bun.SelectQuery) *PCMilerConfigurationRelationChainBuilder {
	rb.chain.Add(relation, opts...)
	return rb
}

// OrderBy adds ordering to the current relation in the chain
func (rb *PCMilerConfigurationRelationChainBuilder) OrderBy(order string) *PCMilerConfigurationRelationChainBuilder {
...
func (rb *PCMilerConfigurationRelationChainBuilder) Where(condition string, args ...interface{}) *PCMilerConfigurationRelationChainBuilder {
	if len(rb.chain.relations) > 0 {
		lastRel := rb.chain.relations[len(rb.chain.relations)-1]
		currentOpt := rb.chain.options[lastRel]
		rb.chain.options[lastRel] = func(q *bun.SelectQuery) *bun.SelectQuery {
