...
// LocationRelationChain provides a fluent API for building nested relationship chains
type LocationRelationChain struct {
	relations []string
	options   map[string]func(*bun.SelectQuery) *bun.SelectQuery
}

// NewLocationRelationChain creates a new relation chain builder
func NewLocationRelationChain() *LocationRelationChain {
	return &LocationRelationChain{
		relations: []string{},
...
func (rc *LocationRelationChain) Add(relation string, opts ...func(*bun.SelectQuery) *bun.SelectQuery) *LocationRelationChain {
...
func (rc *LocationRelationChain) Build() []string {
	return rc.relations
}

// Apply applies the relation chain to a query
func (rc *LocationRelationChain) Apply(q *bun.SelectQuery) *bun.SelectQuery {
...
func (b *LocationQueryBuilder) WithBusinessUnit() *LocationRelationChainBuilder {
	chain := &LocationRelationChainBuilder{
		parent: b,
		chain:  NewLocationRelationChain(),
	}
...
func (b *LocationQueryBuilder) WithOrganization() *LocationRelationChainBuilder {
	chain := &LocationRelationChainBuilder{
		parent: b,
		chain:  NewLocationRelationChain(),
	}
...
func (b *LocationQueryBuilder) WithState() *LocationRelationChainBuilder {
	chain := &LocationRelationChainBuilder{
		parent: b,
		chain:  NewLocationRelationChain(),
	}
...
// WithLocationCategory creates a relation chain starting with LocationCategory
func (b *LocationQueryBuilder) WithLocationCategory() *LocationRelationChainBuilder {
	chain := &LocationRelationChainBuilder{
		parent: b,
		chain:  NewLocationRelationChain(),
	}
	chain.chain.Add("LocationCategory")
	return chain
}

// LocationRelationChainBuilder provides fluent API for building nested relations
type LocationRelationChainBuilder struct {
	parent *LocationQueryBuilder
	chain  *LocationRelationChain
}

// Load applies the relation chain and returns to the parent builder
func (rb *LocationRelationChainBuilder) Load() *LocationQueryBuilder {
	rb.parent.query = rb.chain.Apply(rb.parent.query)
	return rb.parent
}

// ThenLoad adds another relation to the chain
func (rb *LocationRelationChainBuilder) ThenLoad(relation string, opts ...func(*bun.SelectQuery) *bun.SelectQuery) *LocationRelationChainBuilder {
	rb.chain.Add(relation, opts...)
	return rb
}

// OrderBy adds ordering to the current relation in the chain
func (rb *LocationRelationChainBuilder) OrderBy(order string) *LocationRelationChainBuilder {
...
func (rb *LocationRelationChainBuilder) Where(condition string, args ...interface{}) *LocationRelationChainBuilder {
	if len(rb.chain.relations) > 0 {
		lastRel := rb.chain.relations[len(rb.chain.relations)-1]
		currentOpt := rb.chain.options[lastRel]
		rb.chain.options[lastRel] = func(q *bun.SelectQuery) *bun.SelectQuery {
