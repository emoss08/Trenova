...
type Content struct {
	...
	PageCount                int            `json:"pageCount"                bun:"page_count,type:INTEGER,notnull"`
	...
	ClassificationConfidence float64        `json:"classificationConfidence" bun:"classification_confidence,type:DOUBLE PRECISION,notnull"`
