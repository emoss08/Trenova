...
// PageFavoriteRelationChain provides a fluent API for building nested relationship chains
type PageFavoriteRelationChain struct {
	relations []string
	options   map[string]func(*bun.SelectQuery) *bun.SelectQuery
}

// NewPageFavoriteRelationChain creates a new relation chain builder
func NewPageFavoriteRelationChain() *PageFavoriteRelationChain {
	return &PageFavoriteRelationChain{
		relations: []string{},
...
func (rc *PageFavoriteRelationChain) Add(relation string, opts ...func(*bun.SelectQuery) *bun.SelectQuery) *PageFavoriteRelationChain {
...
func (rc *PageFavoriteRelationChain) Build() []string {
	return rc.relations
}

// Apply applies the relation chain to a query
func (rc *PageFavoriteRelationChain) Apply(q *bun.SelectQuery) *bun.SelectQuery {
...
func (b *PageFavoriteQueryBuilder) WithBusinessUnit() *PageFavoriteRelationChainBuilder {
	chain := &PageFavoriteRelationChainBuilder{
		parent: b,
		chain:  NewPageFavoriteRelationChain(),
	}
...
func (b *PageFavoriteQueryBuilder) WithOrganization() *PageFavoriteRelationChainBuilder {
	chain := &PageFavoriteRelationChainBuilder{
		parent: b,
		chain:  NewPageFavoriteRelationChain(),
	}
...
func (b *PageFavoriteQueryBuilder) WithUser() *PageFavoriteRelationChainBuilder {
	chain := &PageFavoriteRelationChainBuilder{
		parent: b,
		chain:  NewPageFavoriteRelationChain(),
	}
...
// PageFavoriteRelationChainBuilder provides fluent API for building nested relations
type PageFavoriteRelationChainBuilder struct {
	parent *PageFavoriteQueryBuilder
	chain  *PageFavoriteRelationChain
}

// Load applies the relation chain and returns to the parent builder
func (rb *PageFavoriteRelationChainBuilder) Load() *PageFavoriteQueryBuilder {
	rb.parent.query = rb.chain.Apply(rb.parent.query)
	return rb.parent
}

// ThenLoad adds another relation to the chain
func (rb *PageFavoriteRelationChainBuilder) ThenLoad(relation string, opts ...func(*bun.SelectQuery) *bun.SelectQuery) *PageFavoriteRelationChainBuilder {
	rb.chain.Add(relation, opts...)
	return rb
}

// OrderBy adds ordering to the current relation in the chain
func (rb *PageFavoriteRelationChainBuilder) OrderBy(order string) *PageFavoriteRelationChainBuilder {
...
func (rb *PageFavoriteRelationChainBuilder) Where(condition string, args ...interface{}) *PageFavoriteRelationChainBuilder {
	if len(rb.chain.relations) > 0 {
		lastRel := rb.chain.relations[len(rb.chain.relations)-1]
		currentOpt := rb.chain.options[lastRel]
		rb.chain.options[lastRel] = func(q *bun.SelectQuery) *bun.SelectQuery {
