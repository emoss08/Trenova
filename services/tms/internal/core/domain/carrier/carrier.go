...
type Carrier struct {
	...
	IntelRiskLevel      string           `json:"intelRiskLevel"      bun:"intel_risk_level,type:VARCHAR(20),nullzero"`
	IntelReviewRequired bool             `json:"intelReviewRequired" bun:"intel_review_required,type:BOOLEAN,notnull"`
	IntelBlockingCount  int              `json:"intelBlockingCount"  bun:"intel_blocking_count,type:INTEGER,notnull"`
