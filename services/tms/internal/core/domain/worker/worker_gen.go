...
// WorkerRelationChain provides a fluent API for building nested relationship chains
type WorkerRelationChain struct {
	relations []string
	options   map[string]func(*bun.SelectQuery) *bun.SelectQuery
}

// NewWorkerRelationChain creates a new relation chain builder
func NewWorkerRelationChain() *WorkerRelationChain {
	return &WorkerRelationChain{
		relations: []string{},
...
func (rc *WorkerRelationChain) Add(relation string, opts ...func(*bun.SelectQuery) *bun.SelectQuery) *WorkerRelationChain {
...
func (rc *WorkerRelationChain) Build() []string {
	return rc.relations
}

// Apply applies the relation chain to a query
func (rc *WorkerRelationChain) Apply(q *bun.SelectQuery) *bun.SelectQuery {
...
func (b *WorkerQueryBuilder) WithBusinessUnit() *WorkerRelationChainBuilder {
	chain := &WorkerRelationChainBuilder{
		parent: b,
		chain:  NewWorkerRelationChain(),
	}
...
func (b *WorkerQueryBuilder) WithOrganization() *WorkerRelationChainBuilder {
	chain := &WorkerRelationChainBuilder{
		parent: b,
		chain:  NewWorkerRelationChain(),
	}
...
func (b *WorkerQueryBuilder) WithState() *WorkerRelationChainBuilder {
	chain := &WorkerRelationChainBuilder{
		parent: b,
		chain:  NewWorkerRelationChain(),
	}
...
// WithProfile creates a relation chain starting with Profile
func (b *WorkerQueryBuilder) WithProfile() *WorkerRelationChainBuilder {
	chain := &WorkerRelationChainBuilder{
		parent: b,
		chain:  NewWorkerRelationChain(),
	}
	chain.chain.Add("Profile")
	return chain
}

// WithPTO creates a relation chain starting with PTO
func (b *WorkerQueryBuilder) WithPTO(opts ...func(*bun.SelectQuery) *bun.SelectQuery) *WorkerRelationChainBuilder {
	chain := &WorkerRelationChainBuilder{
		parent: b,
		chain:  NewWorkerRelationChain(),
	}
	chain.chain.Add("PTO", opts...)
	return chain
}

// WorkerRelationChainBuilder provides fluent API for building nested relations
type WorkerRelationChainBuilder struct {
	parent *WorkerQueryBuilder
	chain  *WorkerRelationChain
}

// Load applies the relation chain and returns to the parent builder
func (rb *WorkerRelationChainBuilder) Load() *WorkerQueryBuilder {
	rb.parent.query = rb.chain.Apply(rb.parent.query)
	return rb.parent
}

// ThenLoad adds another relation to the chain
func (rb *WorkerRelationChainBuilder) ThenLoad(relation string, opts ...func(*bun.SelectQuery) *bun.SelectQuery) *WorkerRelationChainBuilder {
	rb.chain.Add(relation, opts...)
	return rb
}

// OrderBy adds ordering to the current relation in the chain
func (rb *WorkerRelationChainBuilder) OrderBy(order string) *WorkerRelationChainBuilder {
...
func (rb *WorkerRelationChainBuilder) Where(condition string, args ...interface{}) *WorkerRelationChainBuilder {
	if len(rb.chain.relations) > 0 {
		lastRel := rb.chain.relations[len(rb.chain.relations)-1]
		currentOpt := rb.chain.options[lastRel]
		rb.chain.options[lastRel] = func(q *bun.SelectQuery) *bun.SelectQuery {
