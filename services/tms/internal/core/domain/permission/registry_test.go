...
func TestResource_String(t *testing.T) {
	...
	tests := []struct {
		...
		{ResourceWorkerCredential, "worker_credential"},
		{ResourceWorkerCredentialType, "worker_credential_type"},
		{ResourceWorkerEmploymentEvent, "worker_employment_event"},
		{ResourceWorkerChecklist, "worker_checklist"},
		{ResourceWorkerChecklistTemplate, "worker_checklist_template"},
		{ResourceOrgHoliday, "org_holiday"},
		{ResourceTrainingCourse, "training_course"},
		{ResourceWorkerTraining, "worker_training"},
		{ResourceWorkerSafetyEvent, "worker_safety_event"},
		{ResourceWorkerDisciplinaryAction, "worker_disciplinary_action"},
		{ResourceWorkerRecognition, "worker_recognition"},
		{ResourcePerformanceReviewTemplate, "performance_review_template"},
		{ResourcePerformanceReview, "performance_review"},
...
func TestRegistry_RegisterAll_KnownResources(t *testing.T) {
	...
	knownResources := []string{
		...
		ResourceWorkerCredential.String(),
		ResourceWorkerCredentialType.String(),
		ResourceWorkerEmploymentEvent.String(),
		ResourceWorkerChecklist.String(),
		ResourceWorkerChecklistTemplate.String(),
		ResourceOrgHoliday.String(),
		ResourceTrainingCourse.String(),
		ResourceWorkerTraining.String(),
		ResourceWorkerSafetyEvent.String(),
		ResourceWorkerDisciplinaryAction.String(),
		ResourceWorkerRecognition.String(),
		ResourcePerformanceReviewTemplate.String(),
		ResourcePerformanceReview.String(),
