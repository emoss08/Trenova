...
var CatalogDefinitions = []CatalogItem{
	...
	},
	{
		...
		LogoDarkURL:   "/integrations/logos/wex-logo-dark.svg",
	...
	},
	{
		...
		Category:      integration.CategoryFuelCards,
		CategoryLabel: catalogFuelCardsLabel,
		LogoURL:       "/integrations/logos/ramp-logo-light.svg",
		LogoLightURL:  "/integrations/logos/ramp-logo-light.svg",
		LogoDarkURL:   "/integrations/logos/ramp-logo-dark.svg",
