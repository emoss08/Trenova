...
// RetentionActivity removes briefings older than the window a reader can
// page back through.
func (a *Activities) RetentionActivity(ctx context.Context) (*BriefingRetentionResult, error) {
