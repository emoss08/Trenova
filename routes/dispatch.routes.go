...
func DispatchControlRoutes(r *mux.Router, db *gorm.DB, validator *tools.Validator) {
...
func FeasibilityToolControlRoutes(r *mux.Router, db *gorm.DB, validator *tools.Validator) {
