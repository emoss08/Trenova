...
var SequenceQuery = struct {
	...
	Where: struct {
		...
		YearIn: func(q *bun.SelectQuery, v []int16) *bun.SelectQuery {
			return q.Where("? IN (?)", bun.Ident("seq.year"), bun.In(v))
		},
		YearNotIn: func(q *bun.SelectQuery, v []int16) *bun.SelectQuery {
			return q.Where("? NOT IN (?)", bun.Ident("seq.year"), bun.In(v))
		},
		YearGT: func(q *bun.SelectQuery, v int16) *bun.SelectQuery {
			return q.Where("? > ?", bun.Ident("seq.year"), v)
		},
		...
		MonthEQ: func(q *bun.SelectQuery, v int16) *bun.SelectQuery {
			return q.Where("? = ?", bun.Ident("seq.month"), v)
		},
		MonthNEQ: func(q *bun.SelectQuery, v int16) *bun.SelectQuery {
			return q.Where("? != ?", bun.Ident("seq.month"), v)
		},
		MonthIn: func(q *bun.SelectQuery, v []int16) *bun.SelectQuery {
			return q.Where("? IN (?)", bun.Ident("seq.month"), bun.In(v))
		},
		MonthNotIn: func(q *bun.SelectQuery, v []int16) *bun.SelectQuery {
			return q.Where("? NOT IN (?)", bun.Ident("seq.month"), bun.In(v))
		},
		MonthGT: func(q *bun.SelectQuery, v int16) *bun.SelectQuery {
			return q.Where("? > ?", bun.Ident("seq.month"), v)
		},
		...
		CurrentSequenceEQ: func(q *bun.SelectQuery, v int64) *bun.SelectQuery {
			return q.Where("? = ?", bun.Ident("seq.current_sequence"), v)
		},
		CurrentSequenceNEQ: func(q *bun.SelectQuery, v int64) *bun.SelectQuery {
			return q.Where("? != ?", bun.Ident("seq.current_sequence"), v)
		},
		CurrentSequenceIn: func(q *bun.SelectQuery, v []int64) *bun.SelectQuery {
			return q.Where("? IN (?)", bun.Ident("seq.current_sequence"), bun.In(v))
		},
		CurrentSequenceNotIn: func(q *bun.SelectQuery, v []int64) *bun.SelectQuery {
			return q.Where("? NOT IN (?)", bun.Ident("seq.current_sequence"), bun.In(v))
		},
		CurrentSequenceGT: func(q *bun.SelectQuery, v int64) *bun.SelectQuery {
			return q.Where("? > ?", bun.Ident("seq.current_sequence"), v)
		},
		...
		VersionEQ: func(q *bun.SelectQuery, v int64) *bun.SelectQuery {
			return q.Where("? = ?", bun.Ident("seq.version"), v)
		},
		VersionNEQ: func(q *bun.SelectQuery, v int64) *bun.SelectQuery {
			return q.Where("? != ?", bun.Ident("seq.version"), v)
		},
		VersionIn: func(q *bun.SelectQuery, v []int64) *bun.SelectQuery {
			return q.Where("? IN (?)", bun.Ident("seq.version"), bun.In(v))
		},
		VersionNotIn: func(q *bun.SelectQuery, v []int64) *bun.SelectQuery {
			return q.Where("? NOT IN (?)", bun.Ident("seq.version"), bun.In(v))
		},
		VersionGT: func(q *bun.SelectQuery, v int64) *bun.SelectQuery {
			return q.Where("? > ?", bun.Ident("seq.version"), v)
		},
		...
		CreatedAtEQ: func(q *bun.SelectQuery, v int64) *bun.SelectQuery {
			return q.Where("? = ?", bun.Ident("seq.created_at"), v)
		},
		CreatedAtNEQ: func(q *bun.SelectQuery, v int64) *bun.SelectQuery {
			return q.Where("? != ?", bun.Ident("seq.created_at"), v)
		},
		CreatedAtIn: func(q *bun.SelectQuery, v []int64) *bun.SelectQuery {
			return q.Where("? IN (?)", bun.Ident("seq.created_at"), bun.In(v))
		},
		CreatedAtNotIn: func(q *bun.SelectQuery, v []int64) *bun.SelectQuery {
			return q.Where("? NOT IN (?)", bun.Ident("seq.created_at"), bun.In(v))
		},
		CreatedAtGT: func(q *bun.SelectQuery, v int64) *bun.SelectQuery {
			return q.Where("? > ?", bun.Ident("seq.created_at"), v)
		},
		...
		UpdatedAtEQ: func(q *bun.SelectQuery, v int64) *bun.SelectQuery {
			return q.Where("? = ?", bun.Ident("seq.updated_at"), v)
		},
		UpdatedAtNEQ: func(q *bun.SelectQuery, v int64) *bun.SelectQuery {
			return q.Where("? != ?", bun.Ident("seq.updated_at"), v)
		},
		UpdatedAtIn: func(q *bun.SelectQuery, v []int64) *bun.SelectQuery {
			return q.Where("? IN (?)", bun.Ident("seq.updated_at"), bun.In(v))
		},
		UpdatedAtNotIn: func(q *bun.SelectQuery, v []int64) *bun.SelectQuery {
			return q.Where("? NOT IN (?)", bun.Ident("seq.updated_at"), bun.In(v))
		},
		UpdatedAtGT: func(q *bun.SelectQuery, v int64) *bun.SelectQuery {
			return q.Where("? > ?", bun.Ident("seq.updated_at"), v)
		},
		...
		Tenant: func(q *bun.SelectQuery, orgID, buID pulid.ID) *bun.SelectQuery {
			return q.
				Where("? = ?", bun.Ident("seq.organization_id"), orgID).
				Where("? = ?", bun.Ident("seq.business_unit_id"), buID)
		},
	},
	...
	Update: struct {
		...
		WhereIDAndVersion: func(q *bun.UpdateQuery, id pulid.ID, version int64) *bun.UpdateQuery {
			return q.
				Where("? = ?", bun.Ident("seq.id"), id).
				Where("? = ?", bun.Ident("seq.version"), version)
		},
	},
	...
	OrderBy: struct {
		...
		CreatedAt: func(desc bool) string {
			if desc {
				return "seq.created_at DESC"
			}
			return "seq.created_at ASC"
		},
		UpdatedAt: func(desc bool) string {
			if desc {
				return "seq.updated_at DESC"
			}
			return "seq.updated_at ASC"
		},
	},
	...
	FieldConfig: func() map[string]sequenceFieldConfig {
		return map[string]sequenceFieldConfig{
			...
			"organization_id": {
				...
				Column:     "seq.organization_id",
				Sortable:   false,
				Filterable: true,
			},
			"business_unit_id": {
				Name:       "business_unit_id",
				Column:     "seq.business_unit_id",
				Sortable:   false,
				Filterable: true,
			},
			"year": {
			...
			"created_at": {
				Name:       "created_at",
				Column:     "seq.created_at",
				Sortable:   true,
				Filterable: true,
			},
			"updated_at": {
				Name:       "updated_at",
				Column:     "seq.updated_at",
				Sortable:   true,
				Filterable: true,
			},
		}
