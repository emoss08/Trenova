...
func (s *PreferenceService) List(
	...
	if !result.Allowed {
		return nil, errors.NewAuthorizationError("You do not have permission to read notification preferences")
	}
...
func (s *PreferenceService) Create(
	...
	if pref.UserID != userID {
		...
		if !result.Allowed {
			return nil, errors.NewAuthorizationError("You do not have permission to create notification preferences for other users")
		}
	}
...
func (s *PreferenceService) Update(
	...
	if original.UserID != userID {
		...
		if !result.Allowed {
			return nil, errors.NewAuthorizationError("You do not have permission to update this notification preference")
		}
	}
...
func (s *PreferenceService) Delete(
	...
	if pref.UserID != userID {
		...
		if !result.Allowed {
			return errors.NewAuthorizationError("You do not have permission to delete this notification preference")
		}
	}
