...
// ServiceParams holds the dependencies for the audit service
...
// NewService creates a new improved audit service
//
...
func (s *service) validateConfig(cfg *config.AuditConfig) error {
...
func (s *service) deepCopyMap(m map[string]any) map[string]any {
	if m == nil {
		return nil
	}
...
func (s *service) SetSensitiveDataMaskStrategy(strategy MaskStrategy) {
...
func (s *service) SetSensitiveDataAutoDetect(enabled bool) {
...
func (s *service) ClearSensitiveDataCache() {
	s.sdm.ClearCache()
