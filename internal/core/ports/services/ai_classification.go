...
type AIClassificationService interface {
	...
	ClassifyLocation(ctx context.Context, req *ai.ClassificationRequest) (*ai.ClassificationResponse, error)
	
	// ClassifyLocationBatch classifies multiple locations in batch
	ClassifyLocationBatch(ctx context.Context, req *ai.BatchClassificationRequest) (*ai.BatchClassificationResponse, error)
}