...
type NotificationPreferenceRepository interface {
	...
	Create(ctx context.Context, pref *notification.NotificationPreference) (*notification.NotificationPreference, error)

	// Update updates an existing notification preference
	Update(ctx context.Context, pref *notification.NotificationPreference) (*notification.NotificationPreference, error)
	...
	GetUserPreferences(ctx context.Context, req *GetUserPreferencesRequest) ([]*notification.NotificationPreference, error)

	// List retrieves all notification preferences with filtering
	List(ctx context.Context, req ListNotificationPreferencesRequest) (*ports.ListResult[*notification.NotificationPreference], error)
}
