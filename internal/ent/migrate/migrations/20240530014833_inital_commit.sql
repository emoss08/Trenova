...
-- Create "rates" table
CREATE TABLE "rates" ("id" uuid NOT NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "version" bigint NOT NULL DEFAULT 1, "status" character varying(1) NOT NULL DEFAULT 'A', "rate_number" character varying(22) NOT NULL, "effective_date" date NULL, "expiration_date" date NULL, "rating_method" character varying NOT NULL DEFAULT 'FlatRate', "rate_amount" numeric(19,4) NOT NULL, "comment" text NULL, "approved_date" date NULL, "usage_count" bigint NULL DEFAULT 0, "minimum_charge" numeric(19,4) NULL, "maximum_charge" numeric(19,4) NULL, "commodity_id" uuid NULL, "customer_id" uuid NOT NULL, "origin_location_id" uuid NULL, "destination_location_id" uuid NULL, "business_unit_id" uuid NOT NULL, "organization_id" uuid NOT NULL, "shipment_type_id" uuid NULL, "approved_by_id" uuid NULL, PRIMARY KEY ("id"), CONSTRAINT "rates_business_units_business_unit" FOREIGN KEY ("business_unit_id") REFERENCES "business_units" ("id") ON UPDATE NO ACTION ON DELETE CASCADE, CONSTRAINT "rates_commodities_rates" FOREIGN KEY ("commodity_id") REFERENCES "commodities" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, CONSTRAINT "rates_customers_rates" FOREIGN KEY ("customer_id") REFERENCES "customers" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION, CONSTRAINT "rates_locations_rates_destination" FOREIGN KEY ("destination_location_id") REFERENCES "locations" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, CONSTRAINT "rates_locations_rates_origin" FOREIGN KEY ("origin_location_id") REFERENCES "locations" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, CONSTRAINT "rates_organizations_organization" FOREIGN KEY ("organization_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE CASCADE, CONSTRAINT "rates_shipment_types_rates" FOREIGN KEY ("shipment_type_id") REFERENCES "shipment_types" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, CONSTRAINT "rates_users_rates_approved" FOREIGN KEY ("approved_by_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE SET NULL);
...
CREATE TABLE "table_change_alerts" ("id" uuid NOT NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "version" bigint NOT NULL DEFAULT 1, "status" character varying NOT NULL DEFAULT 'A', "name" character varying(50) NOT NULL, "database_action" character varying(6) NOT NULL, "topic_name" character varying NULL, "description" text NULL, "custom_subject" character varying NULL, "delivery_method" character varying(5) NOT NULL DEFAULT 'Email', "email_recipients" text NULL, "effective_date" date NULL, "expiration_date" date NULL, "conditional_logic" jsonb NULL, "business_unit_id" uuid NOT NULL, "organization_id" uuid NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "table_change_alerts_business_units_business_unit" FOREIGN KEY ("business_unit_id") REFERENCES "business_units" ("id") ON UPDATE NO ACTION ON DELETE CASCADE, CONSTRAINT "table_change_alerts_organizations_organization" FOREIGN KEY ("organization_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
