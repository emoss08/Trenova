...
const (
	...
	// FieldIsPayableContact holds the string denoting the is_payable_contact field in the database.
	FieldIsPayableContact = "is_payable_contact"
	...
	BusinessUnitTable = "customer_contacts"
	...
	OrganizationTable = "customer_contacts"
	...
	CustomerTable = "customer_contacts"
...
var (
	...
	// DefaultIsPayableContact holds the default value on creation for the "is_payable_contact" field.
	DefaultIsPayableContact bool
...
// ByIsPayableContact orders the results by the is_payable_contact field.
func ByIsPayableContact(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldIsPayableContact, opts...).ToFunc()
}
