...
const (
	// Label holds the string label denoting the customreport type in the database.
	Label = "custom_report"
	...
	// Table holds the table name of the customreport in the database.
	Table = "custom_reports"
	// BusinessUnitTable is the table that holds the business_unit relation/edge.
	BusinessUnitTable = "custom_reports"
	...
	OrganizationTable = "custom_reports"
...
// Columns holds all SQL columns for customreport fields.
var Columns = []string{
	FieldID,
	FieldBusinessUnitID,
	FieldOrganizationID,
...
// OrderOption defines the ordering options for the CustomReport queries.
