...
type AccountingControl struct {
	...
	AutoCreateJournalEntries bool `json:"autoCreateJournalEntries" validate:"omitempty"`
	// JournalEntryCriteria holds the value of the "journal_entry_criteria" field.
	JournalEntryCriteria accountingcontrol.JournalEntryCriteria `json:"journalEntryCriteria" validate:"required"`
	// RestrictManualJournalEntries holds the value of the "restrict_manual_journal_entries" field.
	RestrictManualJournalEntries bool `json:"restrictManualJournalEntries" validate:"omitempty"`
	// RequireJournalEntryApproval holds the value of the "require_journal_entry_approval" field.
	RequireJournalEntryApproval bool `json:"requireJournalEntryApproval" validate:"omitempty"`
	// EnableRecNotifications holds the value of the "enable_rec_notifications" field.
	EnableRecNotifications bool `json:"enableRecNotifications" validate:"required"`
	// HaltOnPendingRec holds the value of the "halt_on_pending_rec" field.
	HaltOnPendingRec bool `json:"haltOnPendingRec" validate:"omitempty"`
	// CriticalProcesses holds the value of the "critical_processes" field.
	CriticalProcesses string `json:"criticalProcesses" validate:"omitempty"`
	// DefaultRevAccountID holds the value of the "default_rev_account_id" field.
	DefaultRevAccountID *uuid.UUID `json:"defaultRevAccountId" validate:"omitempty"`
	// DefaultExpAccountID holds the value of the "default_exp_account_id" field.
	DefaultExpAccountID *uuid.UUID `json:"defaultExpAccountId" validate:"omitempty"`
...
func (*AccountingControl) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case accountingcontrol.FieldRecThresholdAction, accountingcontrol.FieldJournalEntryCriteria, accountingcontrol.FieldCriticalProcesses:
...
func (ac *AccountingControl) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case accountingcontrol.FieldJournalEntryCriteria:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field journal_entry_criteria", values[i])
			} else if value.Valid {
				ac.JournalEntryCriteria = accountingcontrol.JournalEntryCriteria(value.String)
			}
...
func (ac *AccountingControl) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("journal_entry_criteria=")
	builder.WriteString(fmt.Sprintf("%v", ac.JournalEntryCriteria))
	builder.WriteString(", ")
