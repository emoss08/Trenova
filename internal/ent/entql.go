...
var schemaGraph = func() *sqlgraph.Schema {
	...
	graph.Nodes[7] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			Table:   customreport.Table,
			Columns: customreport.Columns,
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeUUID,
				Column: customreport.FieldID,
			},
		},
		Type: "CustomReport",
		Fields: map[string]*sqlgraph.FieldSpec{
			customreport.FieldBusinessUnitID: {Type: field.TypeUUID, Column: customreport.FieldBusinessUnitID},
			customreport.FieldOrganizationID: {Type: field.TypeUUID, Column: customreport.FieldOrganizationID},
			customreport.FieldCreatedAt:      {Type: field.TypeTime, Column: customreport.FieldCreatedAt},
			customreport.FieldUpdatedAt:      {Type: field.TypeTime, Column: customreport.FieldUpdatedAt},
			customreport.FieldVersion:        {Type: field.TypeInt, Column: customreport.FieldVersion},
			customreport.FieldName:           {Type: field.TypeString, Column: customreport.FieldName},
			customreport.FieldDescription:    {Type: field.TypeString, Column: customreport.FieldDescription},
			customreport.FieldTable:          {Type: field.TypeString, Column: customreport.FieldTable},
		},
	}
	...
	graph.Nodes[9] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			...
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeUUID,
				Column: customercontact.FieldID,
			},
		},
		Type: "CustomerContact",
		Fields: map[string]*sqlgraph.FieldSpec{
			customercontact.FieldBusinessUnitID:   {Type: field.TypeUUID, Column: customercontact.FieldBusinessUnitID},
			customercontact.FieldOrganizationID:   {Type: field.TypeUUID, Column: customercontact.FieldOrganizationID},
			customercontact.FieldCreatedAt:        {Type: field.TypeTime, Column: customercontact.FieldCreatedAt},
			customercontact.FieldUpdatedAt:        {Type: field.TypeTime, Column: customercontact.FieldUpdatedAt},
			customercontact.FieldVersion:          {Type: field.TypeInt, Column: customercontact.FieldVersion},
			customercontact.FieldCustomerID:       {Type: field.TypeUUID, Column: customercontact.FieldCustomerID},
			customercontact.FieldName:             {Type: field.TypeString, Column: customercontact.FieldName},
			customercontact.FieldEmail:            {Type: field.TypeString, Column: customercontact.FieldEmail},
			customercontact.FieldTitle:            {Type: field.TypeString, Column: customercontact.FieldTitle},
			customercontact.FieldPhoneNumber:      {Type: field.TypeString, Column: customercontact.FieldPhoneNumber},
			customercontact.FieldIsPayableContact: {Type: field.TypeBool, Column: customercontact.FieldIsPayableContact},
		},
	}
	graph.Nodes[10] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			Table:   customerdetentionpolicy.Table,
			Columns: customerdetentionpolicy.Columns,
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeUUID,
				Column: customerdetentionpolicy.FieldID,
			},
		},
		Type: "CustomerDetentionPolicy",
		Fields: map[string]*sqlgraph.FieldSpec{
			customerdetentionpolicy.FieldBusinessUnitID:      {Type: field.TypeUUID, Column: customerdetentionpolicy.FieldBusinessUnitID},
			customerdetentionpolicy.FieldOrganizationID:      {Type: field.TypeUUID, Column: customerdetentionpolicy.FieldOrganizationID},
			customerdetentionpolicy.FieldCreatedAt:           {Type: field.TypeTime, Column: customerdetentionpolicy.FieldCreatedAt},
			customerdetentionpolicy.FieldUpdatedAt:           {Type: field.TypeTime, Column: customerdetentionpolicy.FieldUpdatedAt},
			customerdetentionpolicy.FieldVersion:             {Type: field.TypeInt, Column: customerdetentionpolicy.FieldVersion},
			customerdetentionpolicy.FieldStatus:              {Type: field.TypeEnum, Column: customerdetentionpolicy.FieldStatus},
			customerdetentionpolicy.FieldCustomerID:          {Type: field.TypeUUID, Column: customerdetentionpolicy.FieldCustomerID},
			customerdetentionpolicy.FieldCommodityID:         {Type: field.TypeUUID, Column: customerdetentionpolicy.FieldCommodityID},
			customerdetentionpolicy.FieldRevenueCodeID:       {Type: field.TypeUUID, Column: customerdetentionpolicy.FieldRevenueCodeID},
			customerdetentionpolicy.FieldShipmentTypeID:      {Type: field.TypeUUID, Column: customerdetentionpolicy.FieldShipmentTypeID},
			customerdetentionpolicy.FieldApplicationScope:    {Type: field.TypeEnum, Column: customerdetentionpolicy.FieldApplicationScope},
			customerdetentionpolicy.FieldChargeFreeTime:      {Type: field.TypeInt, Column: customerdetentionpolicy.FieldChargeFreeTime},
			customerdetentionpolicy.FieldPaymentFreeTime:     {Type: field.TypeInt, Column: customerdetentionpolicy.FieldPaymentFreeTime},
			customerdetentionpolicy.FieldLateArrivalPolicy:   {Type: field.TypeBool, Column: customerdetentionpolicy.FieldLateArrivalPolicy},
			customerdetentionpolicy.FieldGracePeriod:         {Type: field.TypeInt, Column: customerdetentionpolicy.FieldGracePeriod},
			customerdetentionpolicy.FieldAccessorialChargeID: {Type: field.TypeUUID, Column: customerdetentionpolicy.FieldAccessorialChargeID},
			customerdetentionpolicy.FieldUnits:               {Type: field.TypeInt, Column: customerdetentionpolicy.FieldUnits},
			customerdetentionpolicy.FieldAmount:              {Type: field.TypeFloat64, Column: customerdetentionpolicy.FieldAmount},
			customerdetentionpolicy.FieldNotes:               {Type: field.TypeString, Column: customerdetentionpolicy.FieldNotes},
			customerdetentionpolicy.FieldEffectiveDate:       {Type: field.TypeOther, Column: customerdetentionpolicy.FieldEffectiveDate},
			customerdetentionpolicy.FieldExpirationDate:      {Type: field.TypeOther, Column: customerdetentionpolicy.FieldExpirationDate},
		},
	}
	graph.Nodes[11] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			Table:   customeremailprofile.Table,
			Columns: customeremailprofile.Columns,
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeUUID,
				Column: customeremailprofile.FieldID,
			},
		},
		Type: "CustomerEmailProfile",
		Fields: map[string]*sqlgraph.FieldSpec{
			customeremailprofile.FieldBusinessUnitID:    {Type: field.TypeUUID, Column: customeremailprofile.FieldBusinessUnitID},
			customeremailprofile.FieldOrganizationID:    {Type: field.TypeUUID, Column: customeremailprofile.FieldOrganizationID},
			customeremailprofile.FieldCreatedAt:         {Type: field.TypeTime, Column: customeremailprofile.FieldCreatedAt},
			customeremailprofile.FieldUpdatedAt:         {Type: field.TypeTime, Column: customeremailprofile.FieldUpdatedAt},
			customeremailprofile.FieldVersion:           {Type: field.TypeInt, Column: customeremailprofile.FieldVersion},
			customeremailprofile.FieldCustomerID:        {Type: field.TypeUUID, Column: customeremailprofile.FieldCustomerID},
			customeremailprofile.FieldSubject:           {Type: field.TypeString, Column: customeremailprofile.FieldSubject},
			customeremailprofile.FieldEmailProfileID:    {Type: field.TypeUUID, Column: customeremailprofile.FieldEmailProfileID},
			customeremailprofile.FieldEmailRecipients:   {Type: field.TypeString, Column: customeremailprofile.FieldEmailRecipients},
			customeremailprofile.FieldEmailCcRecipients: {Type: field.TypeString, Column: customeremailprofile.FieldEmailCcRecipients},
			customeremailprofile.FieldAttachmentName:    {Type: field.TypeString, Column: customeremailprofile.FieldAttachmentName},
			customeremailprofile.FieldEmailFormat:       {Type: field.TypeEnum, Column: customeremailprofile.FieldEmailFormat},
		},
	}
	graph.Nodes[12] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			Table:   customerruleprofile.Table,
			Columns: customerruleprofile.Columns,
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeUUID,
				Column: customerruleprofile.FieldID,
			},
		},
		Type: "CustomerRuleProfile",
		Fields: map[string]*sqlgraph.FieldSpec{
			customerruleprofile.FieldBusinessUnitID: {Type: field.TypeUUID, Column: customerruleprofile.FieldBusinessUnitID},
			customerruleprofile.FieldOrganizationID: {Type: field.TypeUUID, Column: customerruleprofile.FieldOrganizationID},
			customerruleprofile.FieldCreatedAt:      {Type: field.TypeTime, Column: customerruleprofile.FieldCreatedAt},
			customerruleprofile.FieldUpdatedAt:      {Type: field.TypeTime, Column: customerruleprofile.FieldUpdatedAt},
			customerruleprofile.FieldVersion:        {Type: field.TypeInt, Column: customerruleprofile.FieldVersion},
			customerruleprofile.FieldCustomerID:     {Type: field.TypeUUID, Column: customerruleprofile.FieldCustomerID},
			customerruleprofile.FieldBillingCycle:   {Type: field.TypeEnum, Column: customerruleprofile.FieldBillingCycle},
		},
	}
	graph.Nodes[13] = &sqlgraph.Node{
		...
		Fields: map[string]*sqlgraph.FieldSpec{
			...
			delaycode.FieldColor:            {Type: field.TypeString, Column: delaycode.FieldColor},
		},
	}
	graph.Nodes[14] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			Table:   deliveryslot.Table,
			Columns: deliveryslot.Columns,
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeUUID,
				Column: deliveryslot.FieldID,
			},
		},
		Type: "DeliverySlot",
		Fields: map[string]*sqlgraph.FieldSpec{
			deliveryslot.FieldBusinessUnitID: {Type: field.TypeUUID, Column: deliveryslot.FieldBusinessUnitID},
			deliveryslot.FieldOrganizationID: {Type: field.TypeUUID, Column: deliveryslot.FieldOrganizationID},
			deliveryslot.FieldCreatedAt:      {Type: field.TypeTime, Column: deliveryslot.FieldCreatedAt},
			deliveryslot.FieldUpdatedAt:      {Type: field.TypeTime, Column: deliveryslot.FieldUpdatedAt},
			deliveryslot.FieldVersion:        {Type: field.TypeInt, Column: deliveryslot.FieldVersion},
			deliveryslot.FieldCustomerID:     {Type: field.TypeUUID, Column: deliveryslot.FieldCustomerID},
			deliveryslot.FieldLocationID:     {Type: field.TypeUUID, Column: deliveryslot.FieldLocationID},
			deliveryslot.FieldDayOfWeek:      {Type: field.TypeEnum, Column: deliveryslot.FieldDayOfWeek},
			deliveryslot.FieldStartTime:      {Type: field.TypeOther, Column: deliveryslot.FieldStartTime},
			deliveryslot.FieldEndTime:        {Type: field.TypeOther, Column: deliveryslot.FieldEndTime},
		},
	}
	...
	graph.Nodes[24] = &sqlgraph.Node{
		...
		Fields: map[string]*sqlgraph.FieldSpec{
			...
			fleetcode.FieldColor:          {Type: field.TypeString, Column: fleetcode.FieldColor},
		},
	}
	graph.Nodes[25] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			Table:   formulatemplate.Table,
			Columns: formulatemplate.Columns,
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeUUID,
				Column: formulatemplate.FieldID,
			},
		},
		Type: "FormulaTemplate",
		Fields: map[string]*sqlgraph.FieldSpec{
			formulatemplate.FieldBusinessUnitID: {Type: field.TypeUUID, Column: formulatemplate.FieldBusinessUnitID},
			formulatemplate.FieldOrganizationID: {Type: field.TypeUUID, Column: formulatemplate.FieldOrganizationID},
			formulatemplate.FieldCreatedAt:      {Type: field.TypeTime, Column: formulatemplate.FieldCreatedAt},
			formulatemplate.FieldUpdatedAt:      {Type: field.TypeTime, Column: formulatemplate.FieldUpdatedAt},
			formulatemplate.FieldVersion:        {Type: field.TypeInt, Column: formulatemplate.FieldVersion},
			formulatemplate.FieldName:           {Type: field.TypeString, Column: formulatemplate.FieldName},
			formulatemplate.FieldFormulaText:    {Type: field.TypeString, Column: formulatemplate.FieldFormulaText},
			formulatemplate.FieldDescription:    {Type: field.TypeString, Column: formulatemplate.FieldDescription},
			formulatemplate.FieldTemplateType:   {Type: field.TypeEnum, Column: formulatemplate.FieldTemplateType},
			formulatemplate.FieldCustomerID:     {Type: field.TypeUUID, Column: formulatemplate.FieldCustomerID},
			formulatemplate.FieldShipmentTypeID: {Type: field.TypeUUID, Column: formulatemplate.FieldShipmentTypeID},
			formulatemplate.FieldAutoApply:      {Type: field.TypeBool, Column: formulatemplate.FieldAutoApply},
		},
	}
	...
	graph.Nodes[39] = &sqlgraph.Node{
		...
		Type: "Rate",
		Fields: map[string]*sqlgraph.FieldSpec{
			rate.FieldBusinessUnitID:        {Type: field.TypeUUID, Column: rate.FieldBusinessUnitID},
			rate.FieldOrganizationID:        {Type: field.TypeUUID, Column: rate.FieldOrganizationID},
			rate.FieldCreatedAt:             {Type: field.TypeTime, Column: rate.FieldCreatedAt},
			rate.FieldUpdatedAt:             {Type: field.TypeTime, Column: rate.FieldUpdatedAt},
			rate.FieldVersion:               {Type: field.TypeInt, Column: rate.FieldVersion},
			rate.FieldStatus:                {Type: field.TypeEnum, Column: rate.FieldStatus},
			rate.FieldRateNumber:            {Type: field.TypeString, Column: rate.FieldRateNumber},
			rate.FieldCustomerID:            {Type: field.TypeUUID, Column: rate.FieldCustomerID},
			rate.FieldEffectiveDate:         {Type: field.TypeOther, Column: rate.FieldEffectiveDate},
			rate.FieldExpirationDate:        {Type: field.TypeOther, Column: rate.FieldExpirationDate},
			rate.FieldCommodityID:           {Type: field.TypeUUID, Column: rate.FieldCommodityID},
			rate.FieldShipmentTypeID:        {Type: field.TypeUUID, Column: rate.FieldShipmentTypeID},
			rate.FieldOriginLocationID:      {Type: field.TypeUUID, Column: rate.FieldOriginLocationID},
			rate.FieldDestinationLocationID: {Type: field.TypeUUID, Column: rate.FieldDestinationLocationID},
	...
	graph.Nodes[43] = &sqlgraph.Node{
		...
		Type: "Role",
		Fields: map[string]*sqlgraph.FieldSpec{
			role.FieldBusinessUnitID: {Type: field.TypeUUID, Column: role.FieldBusinessUnitID},
			role.FieldOrganizationID: {Type: field.TypeUUID, Column: role.FieldOrganizationID},
	...
	graph.Nodes[47] = &sqlgraph.Node{
		...
		Type: "Shipment",
		Fields: map[string]*sqlgraph.FieldSpec{
			shipment.FieldBusinessUnitID:              {Type: field.TypeUUID, Column: shipment.FieldBusinessUnitID},
			shipment.FieldOrganizationID:              {Type: field.TypeUUID, Column: shipment.FieldOrganizationID},
			...
			shipment.FieldVersion:                     {Type: field.TypeInt, Column: shipment.FieldVersion},
			shipment.FieldProNumber:                   {Type: field.TypeString, Column: shipment.FieldProNumber},
			shipment.FieldStatus:                      {Type: field.TypeEnum, Column: shipment.FieldStatus},
			shipment.FieldOriginLocationID:            {Type: field.TypeUUID, Column: shipment.FieldOriginLocationID},
			shipment.FieldOriginAddressLine:           {Type: field.TypeString, Column: shipment.FieldOriginAddressLine},
			shipment.FieldOriginAppointmentStart:      {Type: field.TypeTime, Column: shipment.FieldOriginAppointmentStart},
			shipment.FieldOriginAppointmentEnd:        {Type: field.TypeTime, Column: shipment.FieldOriginAppointmentEnd},
			shipment.FieldDestinationLocationID:       {Type: field.TypeUUID, Column: shipment.FieldDestinationLocationID},
			shipment.FieldDestinationAddressLine:      {Type: field.TypeString, Column: shipment.FieldDestinationAddressLine},
			shipment.FieldDestinationAppointmentStart: {Type: field.TypeTime, Column: shipment.FieldDestinationAppointmentStart},
			shipment.FieldDestinationAppointmentEnd:   {Type: field.TypeTime, Column: shipment.FieldDestinationAppointmentEnd},
			shipment.FieldShipmentTypeID:              {Type: field.TypeUUID, Column: shipment.FieldShipmentTypeID},
			shipment.FieldRevenueCodeID:               {Type: field.TypeUUID, Column: shipment.FieldRevenueCodeID},
			shipment.FieldServiceTypeID:               {Type: field.TypeUUID, Column: shipment.FieldServiceTypeID},
			shipment.FieldRatingUnit:                  {Type: field.TypeInt, Column: shipment.FieldRatingUnit},
			shipment.FieldMileage:                     {Type: field.TypeFloat64, Column: shipment.FieldMileage},
			shipment.FieldOtherChargeAmount:           {Type: field.TypeFloat64, Column: shipment.FieldOtherChargeAmount},
			shipment.FieldFreightChargeAmount:         {Type: field.TypeFloat64, Column: shipment.FieldFreightChargeAmount},
			shipment.FieldRatingMethod:                {Type: field.TypeEnum, Column: shipment.FieldRatingMethod},
			shipment.FieldCustomerID:                  {Type: field.TypeUUID, Column: shipment.FieldCustomerID},
			shipment.FieldPieces:                      {Type: field.TypeFloat64, Column: shipment.FieldPieces},
			shipment.FieldWeight:                      {Type: field.TypeFloat64, Column: shipment.FieldWeight},
			shipment.FieldReadyToBill:                 {Type: field.TypeBool, Column: shipment.FieldReadyToBill},
			shipment.FieldBillDate:                    {Type: field.TypeOther, Column: shipment.FieldBillDate},
			shipment.FieldShipDate:                    {Type: field.TypeOther, Column: shipment.FieldShipDate},
			shipment.FieldBilled:                      {Type: field.TypeBool, Column: shipment.FieldBilled},
			shipment.FieldTransferredToBilling:        {Type: field.TypeBool, Column: shipment.FieldTransferredToBilling},
			shipment.FieldTransferredToBillingDate:    {Type: field.TypeOther, Column: shipment.FieldTransferredToBillingDate},
			shipment.FieldTotalChargeAmount:           {Type: field.TypeFloat64, Column: shipment.FieldTotalChargeAmount},
			shipment.FieldTrailerTypeID:               {Type: field.TypeUUID, Column: shipment.FieldTrailerTypeID},
			shipment.FieldTractorTypeID:               {Type: field.TypeUUID, Column: shipment.FieldTractorTypeID},
			shipment.FieldTemperatureMin:              {Type: field.TypeInt, Column: shipment.FieldTemperatureMin},
			shipment.FieldTemperatureMax:              {Type: field.TypeInt, Column: shipment.FieldTemperatureMax},
			shipment.FieldBillOfLadingNumber:          {Type: field.TypeString, Column: shipment.FieldBillOfLadingNumber},
			shipment.FieldConsigneeReferenceNumber:    {Type: field.TypeString, Column: shipment.FieldConsigneeReferenceNumber},
			shipment.FieldComment:                     {Type: field.TypeString, Column: shipment.FieldComment},
			shipment.FieldVoidedComment:               {Type: field.TypeString, Column: shipment.FieldVoidedComment},
			shipment.FieldAutoRated:                   {Type: field.TypeBool, Column: shipment.FieldAutoRated},
			shipment.FieldCurrentSuffix:               {Type: field.TypeString, Column: shipment.FieldCurrentSuffix},
			shipment.FieldEntryMethod:                 {Type: field.TypeEnum, Column: shipment.FieldEntryMethod},
			shipment.FieldCreatedBy:                   {Type: field.TypeUUID, Column: shipment.FieldCreatedBy},
			shipment.FieldIsHazardous:                 {Type: field.TypeBool, Column: shipment.FieldIsHazardous},
		},
	}
	graph.Nodes[48] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			Table:   shipmentcharges.Table,
			Columns: shipmentcharges.Columns,
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeUUID,
				Column: shipmentcharges.FieldID,
			},
		},
		Type: "ShipmentCharges",
		Fields: map[string]*sqlgraph.FieldSpec{
			shipmentcharges.FieldBusinessUnitID:      {Type: field.TypeUUID, Column: shipmentcharges.FieldBusinessUnitID},
			shipmentcharges.FieldOrganizationID:      {Type: field.TypeUUID, Column: shipmentcharges.FieldOrganizationID},
			shipmentcharges.FieldCreatedAt:           {Type: field.TypeTime, Column: shipmentcharges.FieldCreatedAt},
			shipmentcharges.FieldUpdatedAt:           {Type: field.TypeTime, Column: shipmentcharges.FieldUpdatedAt},
			shipmentcharges.FieldVersion:             {Type: field.TypeInt, Column: shipmentcharges.FieldVersion},
			shipmentcharges.FieldShipmentID:          {Type: field.TypeUUID, Column: shipmentcharges.FieldShipmentID},
			shipmentcharges.FieldAccessorialChargeID: {Type: field.TypeUUID, Column: shipmentcharges.FieldAccessorialChargeID},
			shipmentcharges.FieldDescription:         {Type: field.TypeString, Column: shipmentcharges.FieldDescription},
			shipmentcharges.FieldChargeAmount:        {Type: field.TypeFloat64, Column: shipmentcharges.FieldChargeAmount},
			shipmentcharges.FieldUnits:               {Type: field.TypeInt, Column: shipmentcharges.FieldUnits},
			shipmentcharges.FieldSubTotal:            {Type: field.TypeFloat64, Column: shipmentcharges.FieldSubTotal},
			shipmentcharges.FieldCreatedBy:           {Type: field.TypeUUID, Column: shipmentcharges.FieldCreatedBy},
		},
	}
	graph.Nodes[49] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			Table:   shipmentcomment.Table,
			Columns: shipmentcomment.Columns,
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeUUID,
				Column: shipmentcomment.FieldID,
			},
		},
		Type: "ShipmentComment",
		Fields: map[string]*sqlgraph.FieldSpec{
			shipmentcomment.FieldBusinessUnitID: {Type: field.TypeUUID, Column: shipmentcomment.FieldBusinessUnitID},
			shipmentcomment.FieldOrganizationID: {Type: field.TypeUUID, Column: shipmentcomment.FieldOrganizationID},
			shipmentcomment.FieldCreatedAt:      {Type: field.TypeTime, Column: shipmentcomment.FieldCreatedAt},
			shipmentcomment.FieldUpdatedAt:      {Type: field.TypeTime, Column: shipmentcomment.FieldUpdatedAt},
			shipmentcomment.FieldVersion:        {Type: field.TypeInt, Column: shipmentcomment.FieldVersion},
			shipmentcomment.FieldShipmentID:     {Type: field.TypeUUID, Column: shipmentcomment.FieldShipmentID},
			shipmentcomment.FieldCommentTypeID:  {Type: field.TypeUUID, Column: shipmentcomment.FieldCommentTypeID},
			shipmentcomment.FieldComment:        {Type: field.TypeString, Column: shipmentcomment.FieldComment},
			shipmentcomment.FieldCreatedBy:      {Type: field.TypeUUID, Column: shipmentcomment.FieldCreatedBy},
		},
	}
	graph.Nodes[50] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			Table:   shipmentcommodity.Table,
			Columns: shipmentcommodity.Columns,
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeUUID,
				Column: shipmentcommodity.FieldID,
			},
		},
		Type: "ShipmentCommodity",
		Fields: map[string]*sqlgraph.FieldSpec{
			shipmentcommodity.FieldBusinessUnitID:      {Type: field.TypeUUID, Column: shipmentcommodity.FieldBusinessUnitID},
			shipmentcommodity.FieldOrganizationID:      {Type: field.TypeUUID, Column: shipmentcommodity.FieldOrganizationID},
			shipmentcommodity.FieldCreatedAt:           {Type: field.TypeTime, Column: shipmentcommodity.FieldCreatedAt},
			shipmentcommodity.FieldUpdatedAt:           {Type: field.TypeTime, Column: shipmentcommodity.FieldUpdatedAt},
			shipmentcommodity.FieldVersion:             {Type: field.TypeInt, Column: shipmentcommodity.FieldVersion},
			shipmentcommodity.FieldShipmentID:          {Type: field.TypeUUID, Column: shipmentcommodity.FieldShipmentID},
			shipmentcommodity.FieldCommodityID:         {Type: field.TypeUUID, Column: shipmentcommodity.FieldCommodityID},
			shipmentcommodity.FieldHazardousMaterialID: {Type: field.TypeUUID, Column: shipmentcommodity.FieldHazardousMaterialID},
			shipmentcommodity.FieldSubTotal:            {Type: field.TypeFloat64, Column: shipmentcommodity.FieldSubTotal},
			shipmentcommodity.FieldPlacardNeeded:       {Type: field.TypeBool, Column: shipmentcommodity.FieldPlacardNeeded},
		},
	}
	...
	graph.Nodes[52] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			Table:   shipmentdocumentation.Table,
			Columns: shipmentdocumentation.Columns,
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeUUID,
				Column: shipmentdocumentation.FieldID,
			},
		},
		Type: "ShipmentDocumentation",
		Fields: map[string]*sqlgraph.FieldSpec{
			shipmentdocumentation.FieldBusinessUnitID:           {Type: field.TypeUUID, Column: shipmentdocumentation.FieldBusinessUnitID},
			shipmentdocumentation.FieldOrganizationID:           {Type: field.TypeUUID, Column: shipmentdocumentation.FieldOrganizationID},
			shipmentdocumentation.FieldCreatedAt:                {Type: field.TypeTime, Column: shipmentdocumentation.FieldCreatedAt},
			shipmentdocumentation.FieldUpdatedAt:                {Type: field.TypeTime, Column: shipmentdocumentation.FieldUpdatedAt},
			shipmentdocumentation.FieldVersion:                  {Type: field.TypeInt, Column: shipmentdocumentation.FieldVersion},
			shipmentdocumentation.FieldShipmentID:               {Type: field.TypeUUID, Column: shipmentdocumentation.FieldShipmentID},
			shipmentdocumentation.FieldDocumentURL:              {Type: field.TypeString, Column: shipmentdocumentation.FieldDocumentURL},
			shipmentdocumentation.FieldDocumentClassificationID: {Type: field.TypeUUID, Column: shipmentdocumentation.FieldDocumentClassificationID},
		},
	}
	graph.Nodes[53] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			Table:   shipmentmove.Table,
			Columns: shipmentmove.Columns,
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeUUID,
				Column: shipmentmove.FieldID,
			},
		},
		Type: "ShipmentMove",
		Fields: map[string]*sqlgraph.FieldSpec{
			shipmentmove.FieldBusinessUnitID:    {Type: field.TypeUUID, Column: shipmentmove.FieldBusinessUnitID},
			shipmentmove.FieldOrganizationID:    {Type: field.TypeUUID, Column: shipmentmove.FieldOrganizationID},
			shipmentmove.FieldCreatedAt:         {Type: field.TypeTime, Column: shipmentmove.FieldCreatedAt},
			shipmentmove.FieldUpdatedAt:         {Type: field.TypeTime, Column: shipmentmove.FieldUpdatedAt},
			shipmentmove.FieldVersion:           {Type: field.TypeInt, Column: shipmentmove.FieldVersion},
			shipmentmove.FieldReferenceNumber:   {Type: field.TypeString, Column: shipmentmove.FieldReferenceNumber},
			shipmentmove.FieldStatus:            {Type: field.TypeEnum, Column: shipmentmove.FieldStatus},
			shipmentmove.FieldIsLoaded:          {Type: field.TypeBool, Column: shipmentmove.FieldIsLoaded},
			shipmentmove.FieldShipmentID:        {Type: field.TypeUUID, Column: shipmentmove.FieldShipmentID},
			shipmentmove.FieldTractorID:         {Type: field.TypeUUID, Column: shipmentmove.FieldTractorID},
			shipmentmove.FieldTrailerID:         {Type: field.TypeUUID, Column: shipmentmove.FieldTrailerID},
			shipmentmove.FieldPrimaryWorkerID:   {Type: field.TypeUUID, Column: shipmentmove.FieldPrimaryWorkerID},
			shipmentmove.FieldSecondaryWorkerID: {Type: field.TypeUUID, Column: shipmentmove.FieldSecondaryWorkerID},
		},
	}
	graph.Nodes[54] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			Table:   shipmentroute.Table,
			Columns: shipmentroute.Columns,
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeUUID,
				Column: shipmentroute.FieldID,
			},
		},
		Type: "ShipmentRoute",
		Fields: map[string]*sqlgraph.FieldSpec{
			shipmentroute.FieldBusinessUnitID:        {Type: field.TypeUUID, Column: shipmentroute.FieldBusinessUnitID},
			shipmentroute.FieldOrganizationID:        {Type: field.TypeUUID, Column: shipmentroute.FieldOrganizationID},
			shipmentroute.FieldCreatedAt:             {Type: field.TypeTime, Column: shipmentroute.FieldCreatedAt},
			shipmentroute.FieldUpdatedAt:             {Type: field.TypeTime, Column: shipmentroute.FieldUpdatedAt},
			shipmentroute.FieldVersion:               {Type: field.TypeInt, Column: shipmentroute.FieldVersion},
			shipmentroute.FieldOriginLocationID:      {Type: field.TypeUUID, Column: shipmentroute.FieldOriginLocationID},
			shipmentroute.FieldDestinationLocationID: {Type: field.TypeUUID, Column: shipmentroute.FieldDestinationLocationID},
			shipmentroute.FieldMileage:               {Type: field.TypeFloat64, Column: shipmentroute.FieldMileage},
			shipmentroute.FieldDuration:              {Type: field.TypeInt, Column: shipmentroute.FieldDuration},
			shipmentroute.FieldDistanceMethod:        {Type: field.TypeString, Column: shipmentroute.FieldDistanceMethod},
			shipmentroute.FieldAutoGenerated:         {Type: field.TypeBool, Column: shipmentroute.FieldAutoGenerated},
		},
	}
	graph.Nodes[55] = &sqlgraph.Node{
		...
		Fields: map[string]*sqlgraph.FieldSpec{
			...
			shipmenttype.FieldColor:          {Type: field.TypeString, Column: shipmenttype.FieldColor},
		},
	}
	graph.Nodes[56] = &sqlgraph.Node{
		...
		Type: "Stop",
		Fields: map[string]*sqlgraph.FieldSpec{
			stop.FieldBusinessUnitID:   {Type: field.TypeUUID, Column: stop.FieldBusinessUnitID},
			stop.FieldOrganizationID:   {Type: field.TypeUUID, Column: stop.FieldOrganizationID},
			stop.FieldCreatedAt:        {Type: field.TypeTime, Column: stop.FieldCreatedAt},
			stop.FieldUpdatedAt:        {Type: field.TypeTime, Column: stop.FieldUpdatedAt},
			stop.FieldVersion:          {Type: field.TypeInt, Column: stop.FieldVersion},
			stop.FieldStatus:           {Type: field.TypeEnum, Column: stop.FieldStatus},
			stop.FieldShipmentMoveID:   {Type: field.TypeUUID, Column: stop.FieldShipmentMoveID},
			stop.FieldStopType:         {Type: field.TypeEnum, Column: stop.FieldStopType},
			stop.FieldSequence:         {Type: field.TypeInt, Column: stop.FieldSequence},
			stop.FieldLocationID:       {Type: field.TypeUUID, Column: stop.FieldLocationID},
			stop.FieldPieces:           {Type: field.TypeFloat64, Column: stop.FieldPieces},
			stop.FieldWeight:           {Type: field.TypeFloat64, Column: stop.FieldWeight},
			stop.FieldAddressLine:      {Type: field.TypeString, Column: stop.FieldAddressLine},
			stop.FieldAppointmentStart: {Type: field.TypeTime, Column: stop.FieldAppointmentStart},
			stop.FieldAppointmentEnd:   {Type: field.TypeTime, Column: stop.FieldAppointmentEnd},
			stop.FieldArrivalTime:      {Type: field.TypeTime, Column: stop.FieldArrivalTime},
			stop.FieldDepartureTime:    {Type: field.TypeTime, Column: stop.FieldDepartureTime},
		},
	}
	...
	graph.Nodes[64] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			...
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeUUID,
				Column: usernotification.FieldID,
			},
		},
		Type: "UserNotification",
		Fields: map[string]*sqlgraph.FieldSpec{
			usernotification.FieldBusinessUnitID: {Type: field.TypeUUID, Column: usernotification.FieldBusinessUnitID},
			usernotification.FieldOrganizationID: {Type: field.TypeUUID, Column: usernotification.FieldOrganizationID},
			usernotification.FieldCreatedAt:      {Type: field.TypeTime, Column: usernotification.FieldCreatedAt},
			usernotification.FieldUpdatedAt:      {Type: field.TypeTime, Column: usernotification.FieldUpdatedAt},
			usernotification.FieldVersion:        {Type: field.TypeInt, Column: usernotification.FieldVersion},
			usernotification.FieldUserID:         {Type: field.TypeUUID, Column: usernotification.FieldUserID},
			usernotification.FieldIsRead:         {Type: field.TypeBool, Column: usernotification.FieldIsRead},
			usernotification.FieldTitle:          {Type: field.TypeString, Column: usernotification.FieldTitle},
			usernotification.FieldDescription:    {Type: field.TypeString, Column: usernotification.FieldDescription},
			usernotification.FieldActionURL:      {Type: field.TypeString, Column: usernotification.FieldActionURL},
		},
	}
	graph.Nodes[65] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			...
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeUUID,
				Column: userreport.FieldID,
			},
		},
		Type: "UserReport",
		Fields: map[string]*sqlgraph.FieldSpec{
			userreport.FieldBusinessUnitID: {Type: field.TypeUUID, Column: userreport.FieldBusinessUnitID},
			userreport.FieldOrganizationID: {Type: field.TypeUUID, Column: userreport.FieldOrganizationID},
			userreport.FieldCreatedAt:      {Type: field.TypeTime, Column: userreport.FieldCreatedAt},
			userreport.FieldUpdatedAt:      {Type: field.TypeTime, Column: userreport.FieldUpdatedAt},
			userreport.FieldVersion:        {Type: field.TypeInt, Column: userreport.FieldVersion},
			userreport.FieldReportURL:      {Type: field.TypeString, Column: userreport.FieldReportURL},
			userreport.FieldUserID:         {Type: field.TypeUUID, Column: userreport.FieldUserID},
		},
	}
	...
	graph.MustAddE(
		...
		&sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   shipment.ShipmentMovesTable,
			Columns: []string{shipment.ShipmentMovesColumn},
			Bidi:    false,
		},
		"Shipment",
		"ShipmentMove",
...
// WhereHasShipmentCharges applies a predicate to check if query has an edge shipment_charges.
func (f *AccessorialChargeFilter) WhereHasShipmentCharges() {
	f.Where(entql.HasEdge("shipment_charges"))
}

// WhereHasShipmentChargesWith applies a predicate to check if query has an edge shipment_charges with a given conditions (other predicates).
func (f *AccessorialChargeFilter) WhereHasShipmentChargesWith(preds ...predicate.ShipmentCharges) {
	f.Where(entql.HasEdgeWith("shipment_charges", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereHasShipmentComments applies a predicate to check if query has an edge shipment_comments.
func (f *CommentTypeFilter) WhereHasShipmentComments() {
	f.Where(entql.HasEdge("shipment_comments"))
}

// WhereHasShipmentCommentsWith applies a predicate to check if query has an edge shipment_comments with a given conditions (other predicates).
func (f *CommentTypeFilter) WhereHasShipmentCommentsWith(preds ...predicate.ShipmentComment) {
	f.Where(entql.HasEdgeWith("shipment_comments", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereHasRates applies a predicate to check if query has an edge rates.
func (f *CommodityFilter) WhereHasRates() {
	f.Where(entql.HasEdge("rates"))
}

// WhereHasRatesWith applies a predicate to check if query has an edge rates with a given conditions (other predicates).
func (f *CommodityFilter) WhereHasRatesWith(preds ...predicate.Rate) {
	f.Where(entql.HasEdgeWith("rates", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// addPredicate implements the predicateAdder interface.
func (crq *CustomReportQuery) addPredicate(pred func(s *sql.Selector)) {
	crq.predicates = append(crq.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the CustomReportQuery builder.
func (crq *CustomReportQuery) Filter() *CustomReportFilter {
	return &CustomReportFilter{config: crq.config, predicateAdder: crq}
}

// addPredicate implements the predicateAdder interface.
func (m *CustomReportMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the CustomReportMutation builder.
func (m *CustomReportMutation) Filter() *CustomReportFilter {
	return &CustomReportFilter{config: m.config, predicateAdder: m}
}

// CustomReportFilter provides a generic filtering capability at runtime for CustomReportQuery.
...
// Where applies the entql predicate on the query filter.
func (f *CustomReportFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql [16]byte predicate on the id field.
func (f *CustomReportFilter) WhereID(p entql.ValueP) {
	f.Where(p.Field(customreport.FieldID))
}

// WhereBusinessUnitID applies the entql [16]byte predicate on the business_unit_id field.
func (f *CustomReportFilter) WhereBusinessUnitID(p entql.ValueP) {
	f.Where(p.Field(customreport.FieldBusinessUnitID))
}

// WhereOrganizationID applies the entql [16]byte predicate on the organization_id field.
func (f *CustomReportFilter) WhereOrganizationID(p entql.ValueP) {
	f.Where(p.Field(customreport.FieldOrganizationID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *CustomReportFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(customreport.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *CustomReportFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(customreport.FieldUpdatedAt))
}

// WhereVersion applies the entql int predicate on the version field.
func (f *CustomReportFilter) WhereVersion(p entql.IntP) {
	f.Where(p.Field(customreport.FieldVersion))
}

// WhereName applies the entql string predicate on the name field.
func (f *CustomReportFilter) WhereName(p entql.StringP) {
	f.Where(p.Field(customreport.FieldName))
}

// WhereDescription applies the entql string predicate on the description field.
func (f *CustomReportFilter) WhereDescription(p entql.StringP) {
	f.Where(p.Field(customreport.FieldDescription))
}

// WhereTable applies the entql string predicate on the table field.
func (f *CustomReportFilter) WhereTable(p entql.StringP) {
	f.Where(p.Field(customreport.FieldTable))
}

// WhereHasBusinessUnit applies a predicate to check if query has an edge business_unit.
func (f *CustomReportFilter) WhereHasBusinessUnit() {
	f.Where(entql.HasEdge("business_unit"))
}

// WhereHasBusinessUnitWith applies a predicate to check if query has an edge business_unit with a given conditions (other predicates).
func (f *CustomReportFilter) WhereHasBusinessUnitWith(preds ...predicate.BusinessUnit) {
	f.Where(entql.HasEdgeWith("business_unit", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOrganization applies a predicate to check if query has an edge organization.
func (f *CustomReportFilter) WhereHasOrganization() {
	f.Where(entql.HasEdge("organization"))
}

// WhereHasOrganizationWith applies a predicate to check if query has an edge organization with a given conditions (other predicates).
func (f *CustomReportFilter) WhereHasOrganizationWith(preds ...predicate.Organization) {
	f.Where(entql.HasEdgeWith("organization", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasEmailProfile applies a predicate to check if query has an edge email_profile.
func (f *CustomerFilter) WhereHasEmailProfile() {
	f.Where(entql.HasEdge("email_profile"))
}

// WhereHasEmailProfileWith applies a predicate to check if query has an edge email_profile with a given conditions (other predicates).
func (f *CustomerFilter) WhereHasEmailProfileWith(preds ...predicate.CustomerEmailProfile) {
	f.Where(entql.HasEdgeWith("email_profile", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereHasRuleProfile applies a predicate to check if query has an edge rule_profile.
func (f *CustomerFilter) WhereHasRuleProfile() {
	f.Where(entql.HasEdge("rule_profile"))
}

// WhereHasRuleProfileWith applies a predicate to check if query has an edge rule_profile with a given conditions (other predicates).
func (f *CustomerFilter) WhereHasRuleProfileWith(preds ...predicate.CustomerRuleProfile) {
	f.Where(entql.HasEdgeWith("rule_profile", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereHasDetentionPolicies applies a predicate to check if query has an edge detention_policies.
func (f *CustomerFilter) WhereHasDetentionPolicies() {
	f.Where(entql.HasEdge("detention_policies"))
}

// WhereHasDetentionPoliciesWith applies a predicate to check if query has an edge detention_policies with a given conditions (other predicates).
func (f *CustomerFilter) WhereHasDetentionPoliciesWith(preds ...predicate.CustomerDetentionPolicy) {
	f.Where(entql.HasEdgeWith("detention_policies", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *CustomerFilter) WhereHasContactsWith(preds ...predicate.CustomerContact) {
...
// WhereHasDeliverySlots applies a predicate to check if query has an edge delivery_slots.
func (f *CustomerFilter) WhereHasDeliverySlots() {
	f.Where(entql.HasEdge("delivery_slots"))
}

// WhereHasDeliverySlotsWith applies a predicate to check if query has an edge delivery_slots with a given conditions (other predicates).
func (f *CustomerFilter) WhereHasDeliverySlotsWith(preds ...predicate.DeliverySlot) {
	f.Where(entql.HasEdgeWith("delivery_slots", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereHasRates applies a predicate to check if query has an edge rates.
func (f *CustomerFilter) WhereHasRates() {
	f.Where(entql.HasEdge("rates"))
}

// WhereHasRatesWith applies a predicate to check if query has an edge rates with a given conditions (other predicates).
func (f *CustomerFilter) WhereHasRatesWith(preds ...predicate.Rate) {
	f.Where(entql.HasEdgeWith("rates", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// addPredicate implements the predicateAdder interface.
func (ccq *CustomerContactQuery) addPredicate(pred func(s *sql.Selector)) {
	ccq.predicates = append(ccq.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the CustomerContactQuery builder.
func (ccq *CustomerContactQuery) Filter() *CustomerContactFilter {
	return &CustomerContactFilter{config: ccq.config, predicateAdder: ccq}
}

// addPredicate implements the predicateAdder interface.
func (m *CustomerContactMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the CustomerContactMutation builder.
func (m *CustomerContactMutation) Filter() *CustomerContactFilter {
	return &CustomerContactFilter{config: m.config, predicateAdder: m}
}

// CustomerContactFilter provides a generic filtering capability at runtime for CustomerContactQuery.
...
// Where applies the entql predicate on the query filter.
func (f *CustomerContactFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql [16]byte predicate on the id field.
func (f *CustomerContactFilter) WhereID(p entql.ValueP) {
	f.Where(p.Field(customercontact.FieldID))
}

// WhereBusinessUnitID applies the entql [16]byte predicate on the business_unit_id field.
func (f *CustomerContactFilter) WhereBusinessUnitID(p entql.ValueP) {
	f.Where(p.Field(customercontact.FieldBusinessUnitID))
}

// WhereOrganizationID applies the entql [16]byte predicate on the organization_id field.
func (f *CustomerContactFilter) WhereOrganizationID(p entql.ValueP) {
	f.Where(p.Field(customercontact.FieldOrganizationID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *CustomerContactFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(customercontact.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *CustomerContactFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(customercontact.FieldUpdatedAt))
}

// WhereVersion applies the entql int predicate on the version field.
func (f *CustomerContactFilter) WhereVersion(p entql.IntP) {
	f.Where(p.Field(customercontact.FieldVersion))
}

// WhereCustomerID applies the entql [16]byte predicate on the customer_id field.
func (f *CustomerContactFilter) WhereCustomerID(p entql.ValueP) {
	f.Where(p.Field(customercontact.FieldCustomerID))
}

// WhereName applies the entql string predicate on the name field.
func (f *CustomerContactFilter) WhereName(p entql.StringP) {
	f.Where(p.Field(customercontact.FieldName))
}

// WhereEmail applies the entql string predicate on the email field.
func (f *CustomerContactFilter) WhereEmail(p entql.StringP) {
	f.Where(p.Field(customercontact.FieldEmail))
}

// WhereTitle applies the entql string predicate on the title field.
func (f *CustomerContactFilter) WhereTitle(p entql.StringP) {
	f.Where(p.Field(customercontact.FieldTitle))
}

// WherePhoneNumber applies the entql string predicate on the phone_number field.
func (f *CustomerContactFilter) WherePhoneNumber(p entql.StringP) {
	f.Where(p.Field(customercontact.FieldPhoneNumber))
}

// WhereIsPayableContact applies the entql bool predicate on the is_payable_contact field.
func (f *CustomerContactFilter) WhereIsPayableContact(p entql.BoolP) {
	f.Where(p.Field(customercontact.FieldIsPayableContact))
}

// WhereHasBusinessUnit applies a predicate to check if query has an edge business_unit.
func (f *CustomerContactFilter) WhereHasBusinessUnit() {
	f.Where(entql.HasEdge("business_unit"))
}

// WhereHasBusinessUnitWith applies a predicate to check if query has an edge business_unit with a given conditions (other predicates).
func (f *CustomerContactFilter) WhereHasBusinessUnitWith(preds ...predicate.BusinessUnit) {
	f.Where(entql.HasEdgeWith("business_unit", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOrganization applies a predicate to check if query has an edge organization.
func (f *CustomerContactFilter) WhereHasOrganization() {
	f.Where(entql.HasEdge("organization"))
}

// WhereHasOrganizationWith applies a predicate to check if query has an edge organization with a given conditions (other predicates).
func (f *CustomerContactFilter) WhereHasOrganizationWith(preds ...predicate.Organization) {
	f.Where(entql.HasEdgeWith("organization", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
func (f *CustomerContactFilter) WhereHasCustomer() {
...
func (f *CustomerContactFilter) WhereHasCustomerWith(preds ...predicate.Customer) {
...
// addPredicate implements the predicateAdder interface.
func (cdpq *CustomerDetentionPolicyQuery) addPredicate(pred func(s *sql.Selector)) {
	cdpq.predicates = append(cdpq.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the CustomerDetentionPolicyQuery builder.
func (cdpq *CustomerDetentionPolicyQuery) Filter() *CustomerDetentionPolicyFilter {
	return &CustomerDetentionPolicyFilter{config: cdpq.config, predicateAdder: cdpq}
}

// addPredicate implements the predicateAdder interface.
func (m *CustomerDetentionPolicyMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the CustomerDetentionPolicyMutation builder.
func (m *CustomerDetentionPolicyMutation) Filter() *CustomerDetentionPolicyFilter {
	return &CustomerDetentionPolicyFilter{config: m.config, predicateAdder: m}
}

// CustomerDetentionPolicyFilter provides a generic filtering capability at runtime for CustomerDetentionPolicyQuery.
type CustomerDetentionPolicyFilter struct {
	predicateAdder
	config
}

// Where applies the entql predicate on the query filter.
func (f *CustomerDetentionPolicyFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql [16]byte predicate on the id field.
func (f *CustomerDetentionPolicyFilter) WhereID(p entql.ValueP) {
	f.Where(p.Field(customerdetentionpolicy.FieldID))
}

// WhereBusinessUnitID applies the entql [16]byte predicate on the business_unit_id field.
func (f *CustomerDetentionPolicyFilter) WhereBusinessUnitID(p entql.ValueP) {
	f.Where(p.Field(customerdetentionpolicy.FieldBusinessUnitID))
}

// WhereOrganizationID applies the entql [16]byte predicate on the organization_id field.
func (f *CustomerDetentionPolicyFilter) WhereOrganizationID(p entql.ValueP) {
	f.Where(p.Field(customerdetentionpolicy.FieldOrganizationID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *CustomerDetentionPolicyFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(customerdetentionpolicy.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *CustomerDetentionPolicyFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(customerdetentionpolicy.FieldUpdatedAt))
}

// WhereVersion applies the entql int predicate on the version field.
func (f *CustomerDetentionPolicyFilter) WhereVersion(p entql.IntP) {
	f.Where(p.Field(customerdetentionpolicy.FieldVersion))
}

// WhereStatus applies the entql string predicate on the status field.
func (f *CustomerDetentionPolicyFilter) WhereStatus(p entql.StringP) {
	f.Where(p.Field(customerdetentionpolicy.FieldStatus))
}

// WhereCustomerID applies the entql [16]byte predicate on the customer_id field.
func (f *CustomerDetentionPolicyFilter) WhereCustomerID(p entql.ValueP) {
	f.Where(p.Field(customerdetentionpolicy.FieldCustomerID))
}

// WhereCommodityID applies the entql [16]byte predicate on the commodity_id field.
func (f *CustomerDetentionPolicyFilter) WhereCommodityID(p entql.ValueP) {
	f.Where(p.Field(customerdetentionpolicy.FieldCommodityID))
}

// WhereRevenueCodeID applies the entql [16]byte predicate on the revenue_code_id field.
func (f *CustomerDetentionPolicyFilter) WhereRevenueCodeID(p entql.ValueP) {
	f.Where(p.Field(customerdetentionpolicy.FieldRevenueCodeID))
}

// WhereShipmentTypeID applies the entql [16]byte predicate on the shipment_type_id field.
func (f *CustomerDetentionPolicyFilter) WhereShipmentTypeID(p entql.ValueP) {
	f.Where(p.Field(customerdetentionpolicy.FieldShipmentTypeID))
}

// WhereApplicationScope applies the entql string predicate on the application_scope field.
func (f *CustomerDetentionPolicyFilter) WhereApplicationScope(p entql.StringP) {
	f.Where(p.Field(customerdetentionpolicy.FieldApplicationScope))
}

// WhereChargeFreeTime applies the entql int predicate on the charge_free_time field.
func (f *CustomerDetentionPolicyFilter) WhereChargeFreeTime(p entql.IntP) {
	f.Where(p.Field(customerdetentionpolicy.FieldChargeFreeTime))
}

// WherePaymentFreeTime applies the entql int predicate on the payment_free_time field.
func (f *CustomerDetentionPolicyFilter) WherePaymentFreeTime(p entql.IntP) {
	f.Where(p.Field(customerdetentionpolicy.FieldPaymentFreeTime))
}

// WhereLateArrivalPolicy applies the entql bool predicate on the late_arrival_policy field.
func (f *CustomerDetentionPolicyFilter) WhereLateArrivalPolicy(p entql.BoolP) {
	f.Where(p.Field(customerdetentionpolicy.FieldLateArrivalPolicy))
}

// WhereGracePeriod applies the entql int predicate on the grace_period field.
func (f *CustomerDetentionPolicyFilter) WhereGracePeriod(p entql.IntP) {
	f.Where(p.Field(customerdetentionpolicy.FieldGracePeriod))
}

// WhereAccessorialChargeID applies the entql [16]byte predicate on the accessorial_charge_id field.
func (f *CustomerDetentionPolicyFilter) WhereAccessorialChargeID(p entql.ValueP) {
	f.Where(p.Field(customerdetentionpolicy.FieldAccessorialChargeID))
}

// WhereUnits applies the entql int predicate on the units field.
func (f *CustomerDetentionPolicyFilter) WhereUnits(p entql.IntP) {
	f.Where(p.Field(customerdetentionpolicy.FieldUnits))
}

// WhereAmount applies the entql float64 predicate on the amount field.
func (f *CustomerDetentionPolicyFilter) WhereAmount(p entql.Float64P) {
	f.Where(p.Field(customerdetentionpolicy.FieldAmount))
}

// WhereNotes applies the entql string predicate on the notes field.
func (f *CustomerDetentionPolicyFilter) WhereNotes(p entql.StringP) {
	f.Where(p.Field(customerdetentionpolicy.FieldNotes))
}

// WhereEffectiveDate applies the entql other predicate on the effective_date field.
func (f *CustomerDetentionPolicyFilter) WhereEffectiveDate(p entql.OtherP) {
	f.Where(p.Field(customerdetentionpolicy.FieldEffectiveDate))
}

// WhereExpirationDate applies the entql other predicate on the expiration_date field.
func (f *CustomerDetentionPolicyFilter) WhereExpirationDate(p entql.OtherP) {
	f.Where(p.Field(customerdetentionpolicy.FieldExpirationDate))
}

// WhereHasBusinessUnit applies a predicate to check if query has an edge business_unit.
func (f *CustomerDetentionPolicyFilter) WhereHasBusinessUnit() {
	f.Where(entql.HasEdge("business_unit"))
}

// WhereHasBusinessUnitWith applies a predicate to check if query has an edge business_unit with a given conditions (other predicates).
func (f *CustomerDetentionPolicyFilter) WhereHasBusinessUnitWith(preds ...predicate.BusinessUnit) {
	f.Where(entql.HasEdgeWith("business_unit", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOrganization applies a predicate to check if query has an edge organization.
func (f *CustomerDetentionPolicyFilter) WhereHasOrganization() {
	f.Where(entql.HasEdge("organization"))
}

// WhereHasOrganizationWith applies a predicate to check if query has an edge organization with a given conditions (other predicates).
func (f *CustomerDetentionPolicyFilter) WhereHasOrganizationWith(preds ...predicate.Organization) {
	f.Where(entql.HasEdgeWith("organization", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasCustomer applies a predicate to check if query has an edge customer.
func (f *CustomerDetentionPolicyFilter) WhereHasCustomer() {
	f.Where(entql.HasEdge("customer"))
}

// WhereHasCustomerWith applies a predicate to check if query has an edge customer with a given conditions (other predicates).
func (f *CustomerDetentionPolicyFilter) WhereHasCustomerWith(preds ...predicate.Customer) {
	f.Where(entql.HasEdgeWith("customer", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
func (f *CustomerDetentionPolicyFilter) WhereHasCommodity() {
...
func (f *CustomerDetentionPolicyFilter) WhereHasCommodityWith(preds ...predicate.Commodity) {
...
// WhereHasRevenueCode applies a predicate to check if query has an edge revenue_code.
func (f *CustomerDetentionPolicyFilter) WhereHasRevenueCode() {
	f.Where(entql.HasEdge("revenue_code"))
}

// WhereHasRevenueCodeWith applies a predicate to check if query has an edge revenue_code with a given conditions (other predicates).
func (f *CustomerDetentionPolicyFilter) WhereHasRevenueCodeWith(preds ...predicate.RevenueCode) {
	f.Where(entql.HasEdgeWith("revenue_code", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereHasShipmentType applies a predicate to check if query has an edge shipment_type.
func (f *CustomerDetentionPolicyFilter) WhereHasShipmentType() {
	f.Where(entql.HasEdge("shipment_type"))
}

// WhereHasShipmentTypeWith applies a predicate to check if query has an edge shipment_type with a given conditions (other predicates).
func (f *CustomerDetentionPolicyFilter) WhereHasShipmentTypeWith(preds ...predicate.ShipmentType) {
	f.Where(entql.HasEdgeWith("shipment_type", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereHasAccessorialCharge applies a predicate to check if query has an edge accessorial_charge.
func (f *CustomerDetentionPolicyFilter) WhereHasAccessorialCharge() {
	f.Where(entql.HasEdge("accessorial_charge"))
}

// WhereHasAccessorialChargeWith applies a predicate to check if query has an edge accessorial_charge with a given conditions (other predicates).
func (f *CustomerDetentionPolicyFilter) WhereHasAccessorialChargeWith(preds ...predicate.AccessorialCharge) {
	f.Where(entql.HasEdgeWith("accessorial_charge", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// addPredicate implements the predicateAdder interface.
func (cepq *CustomerEmailProfileQuery) addPredicate(pred func(s *sql.Selector)) {
	cepq.predicates = append(cepq.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the CustomerEmailProfileQuery builder.
func (cepq *CustomerEmailProfileQuery) Filter() *CustomerEmailProfileFilter {
	return &CustomerEmailProfileFilter{config: cepq.config, predicateAdder: cepq}
}

// addPredicate implements the predicateAdder interface.
func (m *CustomerEmailProfileMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the CustomerEmailProfileMutation builder.
func (m *CustomerEmailProfileMutation) Filter() *CustomerEmailProfileFilter {
	return &CustomerEmailProfileFilter{config: m.config, predicateAdder: m}
}

// CustomerEmailProfileFilter provides a generic filtering capability at runtime for CustomerEmailProfileQuery.
type CustomerEmailProfileFilter struct {
	predicateAdder
	config
}

// Where applies the entql predicate on the query filter.
func (f *CustomerEmailProfileFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql [16]byte predicate on the id field.
func (f *CustomerEmailProfileFilter) WhereID(p entql.ValueP) {
	f.Where(p.Field(customeremailprofile.FieldID))
}

// WhereBusinessUnitID applies the entql [16]byte predicate on the business_unit_id field.
func (f *CustomerEmailProfileFilter) WhereBusinessUnitID(p entql.ValueP) {
	f.Where(p.Field(customeremailprofile.FieldBusinessUnitID))
}

// WhereOrganizationID applies the entql [16]byte predicate on the organization_id field.
func (f *CustomerEmailProfileFilter) WhereOrganizationID(p entql.ValueP) {
	f.Where(p.Field(customeremailprofile.FieldOrganizationID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *CustomerEmailProfileFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(customeremailprofile.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *CustomerEmailProfileFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(customeremailprofile.FieldUpdatedAt))
}

// WhereVersion applies the entql int predicate on the version field.
func (f *CustomerEmailProfileFilter) WhereVersion(p entql.IntP) {
	f.Where(p.Field(customeremailprofile.FieldVersion))
}

// WhereCustomerID applies the entql [16]byte predicate on the customer_id field.
func (f *CustomerEmailProfileFilter) WhereCustomerID(p entql.ValueP) {
	f.Where(p.Field(customeremailprofile.FieldCustomerID))
}

// WhereSubject applies the entql string predicate on the subject field.
func (f *CustomerEmailProfileFilter) WhereSubject(p entql.StringP) {
	f.Where(p.Field(customeremailprofile.FieldSubject))
}

// WhereEmailProfileID applies the entql [16]byte predicate on the email_profile_id field.
func (f *CustomerEmailProfileFilter) WhereEmailProfileID(p entql.ValueP) {
	f.Where(p.Field(customeremailprofile.FieldEmailProfileID))
}

// WhereEmailRecipients applies the entql string predicate on the email_recipients field.
func (f *CustomerEmailProfileFilter) WhereEmailRecipients(p entql.StringP) {
	f.Where(p.Field(customeremailprofile.FieldEmailRecipients))
}

// WhereEmailCcRecipients applies the entql string predicate on the email_cc_recipients field.
func (f *CustomerEmailProfileFilter) WhereEmailCcRecipients(p entql.StringP) {
	f.Where(p.Field(customeremailprofile.FieldEmailCcRecipients))
}

// WhereAttachmentName applies the entql string predicate on the attachment_name field.
func (f *CustomerEmailProfileFilter) WhereAttachmentName(p entql.StringP) {
	f.Where(p.Field(customeremailprofile.FieldAttachmentName))
}

// WhereEmailFormat applies the entql string predicate on the email_format field.
func (f *CustomerEmailProfileFilter) WhereEmailFormat(p entql.StringP) {
	f.Where(p.Field(customeremailprofile.FieldEmailFormat))
}

// WhereHasBusinessUnit applies a predicate to check if query has an edge business_unit.
func (f *CustomerEmailProfileFilter) WhereHasBusinessUnit() {
	f.Where(entql.HasEdge("business_unit"))
}

// WhereHasBusinessUnitWith applies a predicate to check if query has an edge business_unit with a given conditions (other predicates).
func (f *CustomerEmailProfileFilter) WhereHasBusinessUnitWith(preds ...predicate.BusinessUnit) {
	f.Where(entql.HasEdgeWith("business_unit", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOrganization applies a predicate to check if query has an edge organization.
func (f *CustomerEmailProfileFilter) WhereHasOrganization() {
	f.Where(entql.HasEdge("organization"))
}

// WhereHasOrganizationWith applies a predicate to check if query has an edge organization with a given conditions (other predicates).
func (f *CustomerEmailProfileFilter) WhereHasOrganizationWith(preds ...predicate.Organization) {
	f.Where(entql.HasEdgeWith("organization", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasCustomer applies a predicate to check if query has an edge customer.
func (f *CustomerEmailProfileFilter) WhereHasCustomer() {
	f.Where(entql.HasEdge("customer"))
}

// WhereHasCustomerWith applies a predicate to check if query has an edge customer with a given conditions (other predicates).
func (f *CustomerEmailProfileFilter) WhereHasCustomerWith(preds ...predicate.Customer) {
	f.Where(entql.HasEdgeWith("customer", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasEmailProfile applies a predicate to check if query has an edge email_profile.
func (f *CustomerEmailProfileFilter) WhereHasEmailProfile() {
	f.Where(entql.HasEdge("email_profile"))
}

// WhereHasEmailProfileWith applies a predicate to check if query has an edge email_profile with a given conditions (other predicates).
func (f *CustomerEmailProfileFilter) WhereHasEmailProfileWith(preds ...predicate.EmailProfile) {
	f.Where(entql.HasEdgeWith("email_profile", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// addPredicate implements the predicateAdder interface.
func (crpq *CustomerRuleProfileQuery) addPredicate(pred func(s *sql.Selector)) {
	crpq.predicates = append(crpq.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the CustomerRuleProfileQuery builder.
func (crpq *CustomerRuleProfileQuery) Filter() *CustomerRuleProfileFilter {
	return &CustomerRuleProfileFilter{config: crpq.config, predicateAdder: crpq}
}

// addPredicate implements the predicateAdder interface.
func (m *CustomerRuleProfileMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the CustomerRuleProfileMutation builder.
func (m *CustomerRuleProfileMutation) Filter() *CustomerRuleProfileFilter {
	return &CustomerRuleProfileFilter{config: m.config, predicateAdder: m}
}

// CustomerRuleProfileFilter provides a generic filtering capability at runtime for CustomerRuleProfileQuery.
type CustomerRuleProfileFilter struct {
	predicateAdder
	config
}

// Where applies the entql predicate on the query filter.
func (f *CustomerRuleProfileFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql [16]byte predicate on the id field.
func (f *CustomerRuleProfileFilter) WhereID(p entql.ValueP) {
	f.Where(p.Field(customerruleprofile.FieldID))
}

// WhereBusinessUnitID applies the entql [16]byte predicate on the business_unit_id field.
func (f *CustomerRuleProfileFilter) WhereBusinessUnitID(p entql.ValueP) {
	f.Where(p.Field(customerruleprofile.FieldBusinessUnitID))
}

// WhereOrganizationID applies the entql [16]byte predicate on the organization_id field.
func (f *CustomerRuleProfileFilter) WhereOrganizationID(p entql.ValueP) {
	f.Where(p.Field(customerruleprofile.FieldOrganizationID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *CustomerRuleProfileFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(customerruleprofile.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *CustomerRuleProfileFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(customerruleprofile.FieldUpdatedAt))
}

// WhereVersion applies the entql int predicate on the version field.
func (f *CustomerRuleProfileFilter) WhereVersion(p entql.IntP) {
	f.Where(p.Field(customerruleprofile.FieldVersion))
}

// WhereCustomerID applies the entql [16]byte predicate on the customer_id field.
func (f *CustomerRuleProfileFilter) WhereCustomerID(p entql.ValueP) {
	f.Where(p.Field(customerruleprofile.FieldCustomerID))
}

// WhereBillingCycle applies the entql string predicate on the billing_cycle field.
func (f *CustomerRuleProfileFilter) WhereBillingCycle(p entql.StringP) {
	f.Where(p.Field(customerruleprofile.FieldBillingCycle))
}

// WhereHasBusinessUnit applies a predicate to check if query has an edge business_unit.
func (f *CustomerRuleProfileFilter) WhereHasBusinessUnit() {
	f.Where(entql.HasEdge("business_unit"))
}

// WhereHasBusinessUnitWith applies a predicate to check if query has an edge business_unit with a given conditions (other predicates).
func (f *CustomerRuleProfileFilter) WhereHasBusinessUnitWith(preds ...predicate.BusinessUnit) {
	f.Where(entql.HasEdgeWith("business_unit", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOrganization applies a predicate to check if query has an edge organization.
func (f *CustomerRuleProfileFilter) WhereHasOrganization() {
	f.Where(entql.HasEdge("organization"))
}

// WhereHasOrganizationWith applies a predicate to check if query has an edge organization with a given conditions (other predicates).
func (f *CustomerRuleProfileFilter) WhereHasOrganizationWith(preds ...predicate.Organization) {
	f.Where(entql.HasEdgeWith("organization", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasCustomer applies a predicate to check if query has an edge customer.
func (f *CustomerRuleProfileFilter) WhereHasCustomer() {
	f.Where(entql.HasEdge("customer"))
}

// WhereHasCustomerWith applies a predicate to check if query has an edge customer with a given conditions (other predicates).
func (f *CustomerRuleProfileFilter) WhereHasCustomerWith(preds ...predicate.Customer) {
	f.Where(entql.HasEdgeWith("customer", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasDocumentClassifications applies a predicate to check if query has an edge document_classifications.
func (f *CustomerRuleProfileFilter) WhereHasDocumentClassifications() {
	f.Where(entql.HasEdge("document_classifications"))
}

// WhereHasDocumentClassificationsWith applies a predicate to check if query has an edge document_classifications with a given conditions (other predicates).
func (f *CustomerRuleProfileFilter) WhereHasDocumentClassificationsWith(preds ...predicate.DocumentClassification) {
	f.Where(entql.HasEdgeWith("document_classifications", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *DelayCodeFilter) WhereColor(p entql.StringP) {
	f.Where(p.Field(delaycode.FieldColor))
}
...
// addPredicate implements the predicateAdder interface.
func (dsq *DeliverySlotQuery) addPredicate(pred func(s *sql.Selector)) {
	dsq.predicates = append(dsq.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the DeliverySlotQuery builder.
func (dsq *DeliverySlotQuery) Filter() *DeliverySlotFilter {
	return &DeliverySlotFilter{config: dsq.config, predicateAdder: dsq}
}

// addPredicate implements the predicateAdder interface.
func (m *DeliverySlotMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the DeliverySlotMutation builder.
func (m *DeliverySlotMutation) Filter() *DeliverySlotFilter {
	return &DeliverySlotFilter{config: m.config, predicateAdder: m}
}

// DeliverySlotFilter provides a generic filtering capability at runtime for DeliverySlotQuery.
type DeliverySlotFilter struct {
	predicateAdder
	config
}

// Where applies the entql predicate on the query filter.
func (f *DeliverySlotFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql [16]byte predicate on the id field.
func (f *DeliverySlotFilter) WhereID(p entql.ValueP) {
	f.Where(p.Field(deliveryslot.FieldID))
}

// WhereBusinessUnitID applies the entql [16]byte predicate on the business_unit_id field.
func (f *DeliverySlotFilter) WhereBusinessUnitID(p entql.ValueP) {
	f.Where(p.Field(deliveryslot.FieldBusinessUnitID))
}

// WhereOrganizationID applies the entql [16]byte predicate on the organization_id field.
func (f *DeliverySlotFilter) WhereOrganizationID(p entql.ValueP) {
	f.Where(p.Field(deliveryslot.FieldOrganizationID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *DeliverySlotFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(deliveryslot.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *DeliverySlotFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(deliveryslot.FieldUpdatedAt))
}

// WhereVersion applies the entql int predicate on the version field.
func (f *DeliverySlotFilter) WhereVersion(p entql.IntP) {
	f.Where(p.Field(deliveryslot.FieldVersion))
}

// WhereCustomerID applies the entql [16]byte predicate on the customer_id field.
func (f *DeliverySlotFilter) WhereCustomerID(p entql.ValueP) {
	f.Where(p.Field(deliveryslot.FieldCustomerID))
}

// WhereLocationID applies the entql [16]byte predicate on the location_id field.
func (f *DeliverySlotFilter) WhereLocationID(p entql.ValueP) {
	f.Where(p.Field(deliveryslot.FieldLocationID))
}

// WhereDayOfWeek applies the entql string predicate on the day_of_week field.
func (f *DeliverySlotFilter) WhereDayOfWeek(p entql.StringP) {
	f.Where(p.Field(deliveryslot.FieldDayOfWeek))
}

// WhereStartTime applies the entql other predicate on the start_time field.
func (f *DeliverySlotFilter) WhereStartTime(p entql.OtherP) {
	f.Where(p.Field(deliveryslot.FieldStartTime))
}

// WhereEndTime applies the entql other predicate on the end_time field.
func (f *DeliverySlotFilter) WhereEndTime(p entql.OtherP) {
	f.Where(p.Field(deliveryslot.FieldEndTime))
}

// WhereHasBusinessUnit applies a predicate to check if query has an edge business_unit.
func (f *DeliverySlotFilter) WhereHasBusinessUnit() {
	f.Where(entql.HasEdge("business_unit"))
}

// WhereHasBusinessUnitWith applies a predicate to check if query has an edge business_unit with a given conditions (other predicates).
func (f *DeliverySlotFilter) WhereHasBusinessUnitWith(preds ...predicate.BusinessUnit) {
	f.Where(entql.HasEdgeWith("business_unit", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOrganization applies a predicate to check if query has an edge organization.
func (f *DeliverySlotFilter) WhereHasOrganization() {
	f.Where(entql.HasEdge("organization"))
}

// WhereHasOrganizationWith applies a predicate to check if query has an edge organization with a given conditions (other predicates).
func (f *DeliverySlotFilter) WhereHasOrganizationWith(preds ...predicate.Organization) {
	f.Where(entql.HasEdgeWith("organization", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasCustomer applies a predicate to check if query has an edge customer.
func (f *DeliverySlotFilter) WhereHasCustomer() {
	f.Where(entql.HasEdge("customer"))
}

// WhereHasCustomerWith applies a predicate to check if query has an edge customer with a given conditions (other predicates).
func (f *DeliverySlotFilter) WhereHasCustomerWith(preds ...predicate.Customer) {
	f.Where(entql.HasEdgeWith("customer", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
func (f *DeliverySlotFilter) WhereHasLocation() {
...
func (f *DeliverySlotFilter) WhereHasLocationWith(preds ...predicate.Location) {
...
// WhereHasShipmentDocumentation applies a predicate to check if query has an edge shipment_documentation.
func (f *DocumentClassificationFilter) WhereHasShipmentDocumentation() {
	f.Where(entql.HasEdge("shipment_documentation"))
}

// WhereHasShipmentDocumentationWith applies a predicate to check if query has an edge shipment_documentation with a given conditions (other predicates).
func (f *DocumentClassificationFilter) WhereHasShipmentDocumentationWith(preds ...predicate.ShipmentDocumentation) {
	f.Where(entql.HasEdgeWith("shipment_documentation", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereHasCustomerRuleProfile applies a predicate to check if query has an edge customer_rule_profile.
func (f *DocumentClassificationFilter) WhereHasCustomerRuleProfile() {
	f.Where(entql.HasEdge("customer_rule_profile"))
}

// WhereHasCustomerRuleProfileWith applies a predicate to check if query has an edge customer_rule_profile with a given conditions (other predicates).
func (f *DocumentClassificationFilter) WhereHasCustomerRuleProfileWith(preds ...predicate.CustomerRuleProfile) {
	f.Where(entql.HasEdgeWith("customer_rule_profile", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereColor applies the entql string predicate on the color field.
func (f *FleetCodeFilter) WhereColor(p entql.StringP) {
	f.Where(p.Field(fleetcode.FieldColor))
}
...
// addPredicate implements the predicateAdder interface.
func (ftq *FormulaTemplateQuery) addPredicate(pred func(s *sql.Selector)) {
	ftq.predicates = append(ftq.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the FormulaTemplateQuery builder.
func (ftq *FormulaTemplateQuery) Filter() *FormulaTemplateFilter {
	return &FormulaTemplateFilter{config: ftq.config, predicateAdder: ftq}
}

// addPredicate implements the predicateAdder interface.
func (m *FormulaTemplateMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the FormulaTemplateMutation builder.
func (m *FormulaTemplateMutation) Filter() *FormulaTemplateFilter {
	return &FormulaTemplateFilter{config: m.config, predicateAdder: m}
}

// FormulaTemplateFilter provides a generic filtering capability at runtime for FormulaTemplateQuery.
type FormulaTemplateFilter struct {
	predicateAdder
	config
}

// Where applies the entql predicate on the query filter.
func (f *FormulaTemplateFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql [16]byte predicate on the id field.
func (f *FormulaTemplateFilter) WhereID(p entql.ValueP) {
	f.Where(p.Field(formulatemplate.FieldID))
}

// WhereBusinessUnitID applies the entql [16]byte predicate on the business_unit_id field.
func (f *FormulaTemplateFilter) WhereBusinessUnitID(p entql.ValueP) {
	f.Where(p.Field(formulatemplate.FieldBusinessUnitID))
}

// WhereOrganizationID applies the entql [16]byte predicate on the organization_id field.
func (f *FormulaTemplateFilter) WhereOrganizationID(p entql.ValueP) {
	f.Where(p.Field(formulatemplate.FieldOrganizationID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *FormulaTemplateFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(formulatemplate.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *FormulaTemplateFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(formulatemplate.FieldUpdatedAt))
}

// WhereVersion applies the entql int predicate on the version field.
func (f *FormulaTemplateFilter) WhereVersion(p entql.IntP) {
	f.Where(p.Field(formulatemplate.FieldVersion))
}

// WhereName applies the entql string predicate on the name field.
func (f *FormulaTemplateFilter) WhereName(p entql.StringP) {
	f.Where(p.Field(formulatemplate.FieldName))
}

// WhereFormulaText applies the entql string predicate on the formula_text field.
func (f *FormulaTemplateFilter) WhereFormulaText(p entql.StringP) {
	f.Where(p.Field(formulatemplate.FieldFormulaText))
}

// WhereDescription applies the entql string predicate on the description field.
func (f *FormulaTemplateFilter) WhereDescription(p entql.StringP) {
	f.Where(p.Field(formulatemplate.FieldDescription))
}

// WhereTemplateType applies the entql string predicate on the template_type field.
func (f *FormulaTemplateFilter) WhereTemplateType(p entql.StringP) {
	f.Where(p.Field(formulatemplate.FieldTemplateType))
}

// WhereCustomerID applies the entql [16]byte predicate on the customer_id field.
func (f *FormulaTemplateFilter) WhereCustomerID(p entql.ValueP) {
	f.Where(p.Field(formulatemplate.FieldCustomerID))
}

// WhereShipmentTypeID applies the entql [16]byte predicate on the shipment_type_id field.
func (f *FormulaTemplateFilter) WhereShipmentTypeID(p entql.ValueP) {
	f.Where(p.Field(formulatemplate.FieldShipmentTypeID))
}

// WhereAutoApply applies the entql bool predicate on the auto_apply field.
func (f *FormulaTemplateFilter) WhereAutoApply(p entql.BoolP) {
	f.Where(p.Field(formulatemplate.FieldAutoApply))
}

// WhereHasBusinessUnit applies a predicate to check if query has an edge business_unit.
func (f *FormulaTemplateFilter) WhereHasBusinessUnit() {
	f.Where(entql.HasEdge("business_unit"))
}

// WhereHasBusinessUnitWith applies a predicate to check if query has an edge business_unit with a given conditions (other predicates).
func (f *FormulaTemplateFilter) WhereHasBusinessUnitWith(preds ...predicate.BusinessUnit) {
	f.Where(entql.HasEdgeWith("business_unit", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOrganization applies a predicate to check if query has an edge organization.
func (f *FormulaTemplateFilter) WhereHasOrganization() {
	f.Where(entql.HasEdge("organization"))
}

// WhereHasOrganizationWith applies a predicate to check if query has an edge organization with a given conditions (other predicates).
func (f *FormulaTemplateFilter) WhereHasOrganizationWith(preds ...predicate.Organization) {
	f.Where(entql.HasEdgeWith("organization", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasCustomer applies a predicate to check if query has an edge customer.
func (f *FormulaTemplateFilter) WhereHasCustomer() {
	f.Where(entql.HasEdge("customer"))
}

// WhereHasCustomerWith applies a predicate to check if query has an edge customer with a given conditions (other predicates).
func (f *FormulaTemplateFilter) WhereHasCustomerWith(preds ...predicate.Customer) {
	f.Where(entql.HasEdgeWith("customer", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasShipmentType applies a predicate to check if query has an edge shipment_type.
func (f *FormulaTemplateFilter) WhereHasShipmentType() {
	f.Where(entql.HasEdge("shipment_type"))
}

// WhereHasShipmentTypeWith applies a predicate to check if query has an edge shipment_type with a given conditions (other predicates).
func (f *FormulaTemplateFilter) WhereHasShipmentTypeWith(preds ...predicate.ShipmentType) {
	f.Where(entql.HasEdgeWith("shipment_type", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOriginRouteLocations applies a predicate to check if query has an edge origin_route_locations.
func (f *LocationFilter) WhereHasOriginRouteLocations() {
	f.Where(entql.HasEdge("origin_route_locations"))
}

// WhereHasOriginRouteLocationsWith applies a predicate to check if query has an edge origin_route_locations with a given conditions (other predicates).
func (f *LocationFilter) WhereHasOriginRouteLocationsWith(preds ...predicate.ShipmentRoute) {
	f.Where(entql.HasEdgeWith("origin_route_locations", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereHasDestinationRouteLocations applies a predicate to check if query has an edge destination_route_locations.
func (f *LocationFilter) WhereHasDestinationRouteLocations() {
	f.Where(entql.HasEdge("destination_route_locations"))
}

// WhereHasDestinationRouteLocationsWith applies a predicate to check if query has an edge destination_route_locations with a given conditions (other predicates).
func (f *LocationFilter) WhereHasDestinationRouteLocationsWith(preds ...predicate.ShipmentRoute) {
	f.Where(entql.HasEdgeWith("destination_route_locations", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereHasRatesOrigin applies a predicate to check if query has an edge rates_origin.
func (f *LocationFilter) WhereHasRatesOrigin() {
	f.Where(entql.HasEdge("rates_origin"))
}

// WhereHasRatesOriginWith applies a predicate to check if query has an edge rates_origin with a given conditions (other predicates).
func (f *LocationFilter) WhereHasRatesOriginWith(preds ...predicate.Rate) {
	f.Where(entql.HasEdgeWith("rates_origin", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereHasRatesDestination applies a predicate to check if query has an edge rates_destination.
func (f *LocationFilter) WhereHasRatesDestination() {
	f.Where(entql.HasEdge("rates_destination"))
}

// WhereHasRatesDestinationWith applies a predicate to check if query has an edge rates_destination with a given conditions (other predicates).
func (f *LocationFilter) WhereHasRatesDestinationWith(preds ...predicate.Rate) {
	f.Where(entql.HasEdgeWith("rates_destination", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereBusinessUnitID applies the entql [16]byte predicate on the business_unit_id field.
func (f *PermissionFilter) WhereBusinessUnitID(p entql.ValueP) {
	f.Where(p.Field(permission.FieldBusinessUnitID))
}

// WhereOrganizationID applies the entql [16]byte predicate on the organization_id field.
func (f *PermissionFilter) WhereOrganizationID(p entql.ValueP) {
	f.Where(p.Field(permission.FieldOrganizationID))
}
...
// WhereVersion applies the entql int predicate on the version field.
func (f *PermissionFilter) WhereVersion(p entql.IntP) {
...
func (f *PermissionFilter) WhereResourceID(p entql.ValueP) {
	f.Where(p.Field(permission.FieldResourceID))
}

// WhereHasBusinessUnit applies a predicate to check if query has an edge business_unit.
func (f *PermissionFilter) WhereHasBusinessUnit() {
	f.Where(entql.HasEdge("business_unit"))
}

// WhereHasBusinessUnitWith applies a predicate to check if query has an edge business_unit with a given conditions (other predicates).
func (f *PermissionFilter) WhereHasBusinessUnitWith(preds ...predicate.BusinessUnit) {
	f.Where(entql.HasEdgeWith("business_unit", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOrganization applies a predicate to check if query has an edge organization.
func (f *PermissionFilter) WhereHasOrganization() {
	f.Where(entql.HasEdge("organization"))
}

// WhereHasOrganizationWith applies a predicate to check if query has an edge organization with a given conditions (other predicates).
func (f *PermissionFilter) WhereHasOrganizationWith(preds ...predicate.Organization) {
	f.Where(entql.HasEdgeWith("organization", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
func (f *PermissionFilter) WhereHasResource() {
...
func (f *PermissionFilter) WhereHasResourceWith(preds ...predicate.Resource) {
...
// addPredicate implements the predicateAdder interface.
func (rq *RateQuery) addPredicate(pred func(s *sql.Selector)) {
	rq.predicates = append(rq.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the RateQuery builder.
func (rq *RateQuery) Filter() *RateFilter {
	return &RateFilter{config: rq.config, predicateAdder: rq}
}

// addPredicate implements the predicateAdder interface.
func (m *RateMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the RateMutation builder.
func (m *RateMutation) Filter() *RateFilter {
	return &RateFilter{config: m.config, predicateAdder: m}
}

// RateFilter provides a generic filtering capability at runtime for RateQuery.
...
// Where applies the entql predicate on the query filter.
func (f *RateFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql [16]byte predicate on the id field.
func (f *RateFilter) WhereID(p entql.ValueP) {
	f.Where(p.Field(rate.FieldID))
}

// WhereBusinessUnitID applies the entql [16]byte predicate on the business_unit_id field.
func (f *RateFilter) WhereBusinessUnitID(p entql.ValueP) {
	f.Where(p.Field(rate.FieldBusinessUnitID))
}

// WhereOrganizationID applies the entql [16]byte predicate on the organization_id field.
func (f *RateFilter) WhereOrganizationID(p entql.ValueP) {
	f.Where(p.Field(rate.FieldOrganizationID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *RateFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(rate.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *RateFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(rate.FieldUpdatedAt))
}

// WhereVersion applies the entql int predicate on the version field.
func (f *RateFilter) WhereVersion(p entql.IntP) {
	f.Where(p.Field(rate.FieldVersion))
}

// WhereStatus applies the entql string predicate on the status field.
func (f *RateFilter) WhereStatus(p entql.StringP) {
	f.Where(p.Field(rate.FieldStatus))
}

// WhereRateNumber applies the entql string predicate on the rate_number field.
func (f *RateFilter) WhereRateNumber(p entql.StringP) {
	f.Where(p.Field(rate.FieldRateNumber))
}

// WhereCustomerID applies the entql [16]byte predicate on the customer_id field.
func (f *RateFilter) WhereCustomerID(p entql.ValueP) {
	f.Where(p.Field(rate.FieldCustomerID))
}

// WhereEffectiveDate applies the entql other predicate on the effective_date field.
func (f *RateFilter) WhereEffectiveDate(p entql.OtherP) {
	f.Where(p.Field(rate.FieldEffectiveDate))
}

// WhereExpirationDate applies the entql other predicate on the expiration_date field.
func (f *RateFilter) WhereExpirationDate(p entql.OtherP) {
	f.Where(p.Field(rate.FieldExpirationDate))
}

// WhereCommodityID applies the entql [16]byte predicate on the commodity_id field.
func (f *RateFilter) WhereCommodityID(p entql.ValueP) {
	f.Where(p.Field(rate.FieldCommodityID))
}

// WhereShipmentTypeID applies the entql [16]byte predicate on the shipment_type_id field.
func (f *RateFilter) WhereShipmentTypeID(p entql.ValueP) {
	f.Where(p.Field(rate.FieldShipmentTypeID))
}

// WhereOriginLocationID applies the entql [16]byte predicate on the origin_location_id field.
func (f *RateFilter) WhereOriginLocationID(p entql.ValueP) {
	f.Where(p.Field(rate.FieldOriginLocationID))
}

// WhereDestinationLocationID applies the entql [16]byte predicate on the destination_location_id field.
func (f *RateFilter) WhereDestinationLocationID(p entql.ValueP) {
	f.Where(p.Field(rate.FieldDestinationLocationID))
}

// WhereRatingMethod applies the entql string predicate on the rating_method field.
func (f *RateFilter) WhereRatingMethod(p entql.StringP) {
	f.Where(p.Field(rate.FieldRatingMethod))
}

// WhereRateAmount applies the entql float64 predicate on the rate_amount field.
func (f *RateFilter) WhereRateAmount(p entql.Float64P) {
	f.Where(p.Field(rate.FieldRateAmount))
}

// WhereComment applies the entql string predicate on the comment field.
func (f *RateFilter) WhereComment(p entql.StringP) {
...
// WhereHasBusinessUnitWith applies a predicate to check if query has an edge business_unit with a given conditions (other predicates).
func (f *RateFilter) WhereHasBusinessUnitWith(preds ...predicate.BusinessUnit) {
	f.Where(entql.HasEdgeWith("business_unit", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOrganization applies a predicate to check if query has an edge organization.
func (f *RateFilter) WhereHasOrganization() {
	f.Where(entql.HasEdge("organization"))
}

// WhereHasOrganizationWith applies a predicate to check if query has an edge organization with a given conditions (other predicates).
func (f *RateFilter) WhereHasOrganizationWith(preds ...predicate.Organization) {
	f.Where(entql.HasEdgeWith("organization", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasCustomer applies a predicate to check if query has an edge customer.
func (f *RateFilter) WhereHasCustomer() {
	f.Where(entql.HasEdge("customer"))
}

// WhereHasCustomerWith applies a predicate to check if query has an edge customer with a given conditions (other predicates).
func (f *RateFilter) WhereHasCustomerWith(preds ...predicate.Customer) {
	f.Where(entql.HasEdgeWith("customer", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasCommodity applies a predicate to check if query has an edge commodity.
func (f *RateFilter) WhereHasCommodity() {
	f.Where(entql.HasEdge("commodity"))
}

// WhereHasCommodityWith applies a predicate to check if query has an edge commodity with a given conditions (other predicates).
func (f *RateFilter) WhereHasCommodityWith(preds ...predicate.Commodity) {
	f.Where(entql.HasEdgeWith("commodity", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasShipmentType applies a predicate to check if query has an edge shipment_type.
func (f *RateFilter) WhereHasShipmentType() {
	f.Where(entql.HasEdge("shipment_type"))
}

// WhereHasShipmentTypeWith applies a predicate to check if query has an edge shipment_type with a given conditions (other predicates).
func (f *RateFilter) WhereHasShipmentTypeWith(preds ...predicate.ShipmentType) {
	f.Where(entql.HasEdgeWith("shipment_type", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOriginLocation applies a predicate to check if query has an edge origin_location.
func (f *RateFilter) WhereHasOriginLocation() {
	f.Where(entql.HasEdge("origin_location"))
}

// WhereHasOriginLocationWith applies a predicate to check if query has an edge origin_location with a given conditions (other predicates).
func (f *RateFilter) WhereHasOriginLocationWith(preds ...predicate.Location) {
	f.Where(entql.HasEdgeWith("origin_location", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereHasDestinationLocation applies a predicate to check if query has an edge destination_location.
func (f *RateFilter) WhereHasDestinationLocation() {
	f.Where(entql.HasEdge("destination_location"))
}
...
// WhereID applies the entql [16]byte predicate on the id field.
func (f *ResourceFilter) WhereID(p entql.ValueP) {
...
func (f *ResourceFilter) WhereHasPermissions() {
...
func (f *ResourceFilter) WhereHasPermissionsWith(preds ...predicate.Permission) {
...
// WhereBusinessUnitID applies the entql [16]byte predicate on the business_unit_id field.
func (f *RoleFilter) WhereBusinessUnitID(p entql.ValueP) {
	f.Where(p.Field(role.FieldBusinessUnitID))
}

// WhereOrganizationID applies the entql [16]byte predicate on the organization_id field.
func (f *RoleFilter) WhereOrganizationID(p entql.ValueP) {
...
// WhereVersion applies the entql int predicate on the version field.
func (f *RoleFilter) WhereVersion(p entql.IntP) {
	f.Where(p.Field(role.FieldVersion))
}
...
// WhereHasBusinessUnit applies a predicate to check if query has an edge business_unit.
func (f *RoleFilter) WhereHasBusinessUnit() {
	f.Where(entql.HasEdge("business_unit"))
}

// WhereHasBusinessUnitWith applies a predicate to check if query has an edge business_unit with a given conditions (other predicates).
func (f *RoleFilter) WhereHasBusinessUnitWith(preds ...predicate.BusinessUnit) {
	f.Where(entql.HasEdgeWith("business_unit", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereID applies the entql [16]byte predicate on the id field.
func (f *ShipmentFilter) WhereID(p entql.ValueP) {
	f.Where(p.Field(shipment.FieldID))
}

// WhereBusinessUnitID applies the entql [16]byte predicate on the business_unit_id field.
func (f *ShipmentFilter) WhereBusinessUnitID(p entql.ValueP) {
	f.Where(p.Field(shipment.FieldBusinessUnitID))
}

// WhereOrganizationID applies the entql [16]byte predicate on the organization_id field.
func (f *ShipmentFilter) WhereOrganizationID(p entql.ValueP) {
	f.Where(p.Field(shipment.FieldOrganizationID))
}
...
// WhereVersion applies the entql int predicate on the version field.
func (f *ShipmentFilter) WhereVersion(p entql.IntP) {
	f.Where(p.Field(shipment.FieldVersion))
}

// WhereProNumber applies the entql string predicate on the pro_number field.
func (f *ShipmentFilter) WhereProNumber(p entql.StringP) {
	f.Where(p.Field(shipment.FieldProNumber))
}
...
// WhereOriginLocationID applies the entql [16]byte predicate on the origin_location_id field.
func (f *ShipmentFilter) WhereOriginLocationID(p entql.ValueP) {
	f.Where(p.Field(shipment.FieldOriginLocationID))
}

// WhereOriginAddressLine applies the entql string predicate on the origin_address_line field.
func (f *ShipmentFilter) WhereOriginAddressLine(p entql.StringP) {
	f.Where(p.Field(shipment.FieldOriginAddressLine))
}

// WhereOriginAppointmentStart applies the entql time.Time predicate on the origin_appointment_start field.
func (f *ShipmentFilter) WhereOriginAppointmentStart(p entql.TimeP) {
	f.Where(p.Field(shipment.FieldOriginAppointmentStart))
}

// WhereOriginAppointmentEnd applies the entql time.Time predicate on the origin_appointment_end field.
func (f *ShipmentFilter) WhereOriginAppointmentEnd(p entql.TimeP) {
	f.Where(p.Field(shipment.FieldOriginAppointmentEnd))
}

// WhereDestinationLocationID applies the entql [16]byte predicate on the destination_location_id field.
func (f *ShipmentFilter) WhereDestinationLocationID(p entql.ValueP) {
	f.Where(p.Field(shipment.FieldDestinationLocationID))
}

// WhereDestinationAddressLine applies the entql string predicate on the destination_address_line field.
func (f *ShipmentFilter) WhereDestinationAddressLine(p entql.StringP) {
	f.Where(p.Field(shipment.FieldDestinationAddressLine))
}

// WhereDestinationAppointmentStart applies the entql time.Time predicate on the destination_appointment_start field.
func (f *ShipmentFilter) WhereDestinationAppointmentStart(p entql.TimeP) {
	f.Where(p.Field(shipment.FieldDestinationAppointmentStart))
}

// WhereDestinationAppointmentEnd applies the entql time.Time predicate on the destination_appointment_end field.
func (f *ShipmentFilter) WhereDestinationAppointmentEnd(p entql.TimeP) {
	f.Where(p.Field(shipment.FieldDestinationAppointmentEnd))
}

// WhereShipmentTypeID applies the entql [16]byte predicate on the shipment_type_id field.
func (f *ShipmentFilter) WhereShipmentTypeID(p entql.ValueP) {
	f.Where(p.Field(shipment.FieldShipmentTypeID))
}

// WhereRevenueCodeID applies the entql [16]byte predicate on the revenue_code_id field.
func (f *ShipmentFilter) WhereRevenueCodeID(p entql.ValueP) {
	f.Where(p.Field(shipment.FieldRevenueCodeID))
}

// WhereServiceTypeID applies the entql [16]byte predicate on the service_type_id field.
func (f *ShipmentFilter) WhereServiceTypeID(p entql.ValueP) {
	f.Where(p.Field(shipment.FieldServiceTypeID))
}

// WhereRatingUnit applies the entql int predicate on the rating_unit field.
func (f *ShipmentFilter) WhereRatingUnit(p entql.IntP) {
	f.Where(p.Field(shipment.FieldRatingUnit))
}

// WhereMileage applies the entql float64 predicate on the mileage field.
func (f *ShipmentFilter) WhereMileage(p entql.Float64P) {
	f.Where(p.Field(shipment.FieldMileage))
}

// WhereOtherChargeAmount applies the entql float64 predicate on the other_charge_amount field.
func (f *ShipmentFilter) WhereOtherChargeAmount(p entql.Float64P) {
	f.Where(p.Field(shipment.FieldOtherChargeAmount))
}

// WhereFreightChargeAmount applies the entql float64 predicate on the freight_charge_amount field.
func (f *ShipmentFilter) WhereFreightChargeAmount(p entql.Float64P) {
	f.Where(p.Field(shipment.FieldFreightChargeAmount))
}

// WhereRatingMethod applies the entql string predicate on the rating_method field.
func (f *ShipmentFilter) WhereRatingMethod(p entql.StringP) {
	f.Where(p.Field(shipment.FieldRatingMethod))
}

// WhereCustomerID applies the entql [16]byte predicate on the customer_id field.
func (f *ShipmentFilter) WhereCustomerID(p entql.ValueP) {
	f.Where(p.Field(shipment.FieldCustomerID))
}

// WherePieces applies the entql float64 predicate on the pieces field.
func (f *ShipmentFilter) WherePieces(p entql.Float64P) {
	f.Where(p.Field(shipment.FieldPieces))
}

// WhereWeight applies the entql float64 predicate on the weight field.
func (f *ShipmentFilter) WhereWeight(p entql.Float64P) {
	f.Where(p.Field(shipment.FieldWeight))
}

// WhereReadyToBill applies the entql bool predicate on the ready_to_bill field.
func (f *ShipmentFilter) WhereReadyToBill(p entql.BoolP) {
	f.Where(p.Field(shipment.FieldReadyToBill))
}

// WhereBillDate applies the entql other predicate on the bill_date field.
func (f *ShipmentFilter) WhereBillDate(p entql.OtherP) {
	f.Where(p.Field(shipment.FieldBillDate))
}

// WhereShipDate applies the entql other predicate on the ship_date field.
func (f *ShipmentFilter) WhereShipDate(p entql.OtherP) {
	f.Where(p.Field(shipment.FieldShipDate))
}

// WhereBilled applies the entql bool predicate on the billed field.
func (f *ShipmentFilter) WhereBilled(p entql.BoolP) {
	f.Where(p.Field(shipment.FieldBilled))
}

// WhereTransferredToBilling applies the entql bool predicate on the transferred_to_billing field.
func (f *ShipmentFilter) WhereTransferredToBilling(p entql.BoolP) {
	f.Where(p.Field(shipment.FieldTransferredToBilling))
}

// WhereTransferredToBillingDate applies the entql other predicate on the transferred_to_billing_date field.
func (f *ShipmentFilter) WhereTransferredToBillingDate(p entql.OtherP) {
	f.Where(p.Field(shipment.FieldTransferredToBillingDate))
}

// WhereTotalChargeAmount applies the entql float64 predicate on the total_charge_amount field.
func (f *ShipmentFilter) WhereTotalChargeAmount(p entql.Float64P) {
	f.Where(p.Field(shipment.FieldTotalChargeAmount))
}

// WhereTrailerTypeID applies the entql [16]byte predicate on the trailer_type_id field.
func (f *ShipmentFilter) WhereTrailerTypeID(p entql.ValueP) {
	f.Where(p.Field(shipment.FieldTrailerTypeID))
}

// WhereTractorTypeID applies the entql [16]byte predicate on the tractor_type_id field.
func (f *ShipmentFilter) WhereTractorTypeID(p entql.ValueP) {
	f.Where(p.Field(shipment.FieldTractorTypeID))
}

// WhereTemperatureMin applies the entql int predicate on the temperature_min field.
func (f *ShipmentFilter) WhereTemperatureMin(p entql.IntP) {
	f.Where(p.Field(shipment.FieldTemperatureMin))
}

// WhereTemperatureMax applies the entql int predicate on the temperature_max field.
func (f *ShipmentFilter) WhereTemperatureMax(p entql.IntP) {
	f.Where(p.Field(shipment.FieldTemperatureMax))
}

// WhereBillOfLadingNumber applies the entql string predicate on the bill_of_lading_number field.
func (f *ShipmentFilter) WhereBillOfLadingNumber(p entql.StringP) {
	f.Where(p.Field(shipment.FieldBillOfLadingNumber))
}

// WhereConsigneeReferenceNumber applies the entql string predicate on the consignee_reference_number field.
func (f *ShipmentFilter) WhereConsigneeReferenceNumber(p entql.StringP) {
	f.Where(p.Field(shipment.FieldConsigneeReferenceNumber))
}

// WhereComment applies the entql string predicate on the comment field.
func (f *ShipmentFilter) WhereComment(p entql.StringP) {
	f.Where(p.Field(shipment.FieldComment))
}

// WhereVoidedComment applies the entql string predicate on the voided_comment field.
func (f *ShipmentFilter) WhereVoidedComment(p entql.StringP) {
	f.Where(p.Field(shipment.FieldVoidedComment))
}

// WhereAutoRated applies the entql bool predicate on the auto_rated field.
func (f *ShipmentFilter) WhereAutoRated(p entql.BoolP) {
	f.Where(p.Field(shipment.FieldAutoRated))
}

// WhereCurrentSuffix applies the entql string predicate on the current_suffix field.
func (f *ShipmentFilter) WhereCurrentSuffix(p entql.StringP) {
	f.Where(p.Field(shipment.FieldCurrentSuffix))
}

// WhereEntryMethod applies the entql string predicate on the entry_method field.
func (f *ShipmentFilter) WhereEntryMethod(p entql.StringP) {
	f.Where(p.Field(shipment.FieldEntryMethod))
}

// WhereCreatedBy applies the entql [16]byte predicate on the created_by field.
func (f *ShipmentFilter) WhereCreatedBy(p entql.ValueP) {
	f.Where(p.Field(shipment.FieldCreatedBy))
}

// WhereIsHazardous applies the entql bool predicate on the is_hazardous field.
func (f *ShipmentFilter) WhereIsHazardous(p entql.BoolP) {
	f.Where(p.Field(shipment.FieldIsHazardous))
}

// WhereHasBusinessUnit applies a predicate to check if query has an edge business_unit.
func (f *ShipmentFilter) WhereHasBusinessUnit() {
	f.Where(entql.HasEdge("business_unit"))
}

// WhereHasBusinessUnitWith applies a predicate to check if query has an edge business_unit with a given conditions (other predicates).
func (f *ShipmentFilter) WhereHasBusinessUnitWith(preds ...predicate.BusinessUnit) {
	f.Where(entql.HasEdgeWith("business_unit", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOrganization applies a predicate to check if query has an edge organization.
func (f *ShipmentFilter) WhereHasOrganization() {
	f.Where(entql.HasEdge("organization"))
}

// WhereHasOrganizationWith applies a predicate to check if query has an edge organization with a given conditions (other predicates).
func (f *ShipmentFilter) WhereHasOrganizationWith(preds ...predicate.Organization) {
	f.Where(entql.HasEdgeWith("organization", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasShipmentType applies a predicate to check if query has an edge shipment_type.
func (f *ShipmentFilter) WhereHasShipmentType() {
	f.Where(entql.HasEdge("shipment_type"))
}

// WhereHasShipmentTypeWith applies a predicate to check if query has an edge shipment_type with a given conditions (other predicates).
func (f *ShipmentFilter) WhereHasShipmentTypeWith(preds ...predicate.ShipmentType) {
	f.Where(entql.HasEdgeWith("shipment_type", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasServiceType applies a predicate to check if query has an edge service_type.
func (f *ShipmentFilter) WhereHasServiceType() {
	f.Where(entql.HasEdge("service_type"))
}

// WhereHasServiceTypeWith applies a predicate to check if query has an edge service_type with a given conditions (other predicates).
func (f *ShipmentFilter) WhereHasServiceTypeWith(preds ...predicate.ServiceType) {
	f.Where(entql.HasEdgeWith("service_type", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereHasRevenueCode applies a predicate to check if query has an edge revenue_code.
func (f *ShipmentFilter) WhereHasRevenueCode() {
	f.Where(entql.HasEdge("revenue_code"))
}

// WhereHasRevenueCodeWith applies a predicate to check if query has an edge revenue_code with a given conditions (other predicates).
func (f *ShipmentFilter) WhereHasRevenueCodeWith(preds ...predicate.ServiceType) {
	f.Where(entql.HasEdgeWith("revenue_code", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOriginLocation applies a predicate to check if query has an edge origin_location.
func (f *ShipmentFilter) WhereHasOriginLocation() {
	f.Where(entql.HasEdge("origin_location"))
}

// WhereHasOriginLocationWith applies a predicate to check if query has an edge origin_location with a given conditions (other predicates).
func (f *ShipmentFilter) WhereHasOriginLocationWith(preds ...predicate.Location) {
	f.Where(entql.HasEdgeWith("origin_location", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasDestinationLocation applies a predicate to check if query has an edge destination_location.
func (f *ShipmentFilter) WhereHasDestinationLocation() {
	f.Where(entql.HasEdge("destination_location"))
}

// WhereHasDestinationLocationWith applies a predicate to check if query has an edge destination_location with a given conditions (other predicates).
func (f *ShipmentFilter) WhereHasDestinationLocationWith(preds ...predicate.Location) {
	f.Where(entql.HasEdgeWith("destination_location", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasTrailerTypeWith applies a predicate to check if query has an edge trailer_type with a given conditions (other predicates).
func (f *ShipmentFilter) WhereHasTrailerTypeWith(preds ...predicate.EquipmentType) {
	f.Where(entql.HasEdgeWith("trailer_type", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereHasTractorType applies a predicate to check if query has an edge tractor_type.
func (f *ShipmentFilter) WhereHasTractorType() {
	f.Where(entql.HasEdge("tractor_type"))
}

// WhereHasTractorTypeWith applies a predicate to check if query has an edge tractor_type with a given conditions (other predicates).
func (f *ShipmentFilter) WhereHasTractorTypeWith(preds ...predicate.EquipmentType) {
	f.Where(entql.HasEdgeWith("tractor_type", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereHasShipmentDocumentation applies a predicate to check if query has an edge shipment_documentation.
func (f *ShipmentFilter) WhereHasShipmentDocumentation() {
	f.Where(entql.HasEdge("shipment_documentation"))
}

// WhereHasShipmentDocumentationWith applies a predicate to check if query has an edge shipment_documentation with a given conditions (other predicates).
func (f *ShipmentFilter) WhereHasShipmentDocumentationWith(preds ...predicate.ShipmentDocumentation) {
	f.Where(entql.HasEdgeWith("shipment_documentation", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasShipmentComments applies a predicate to check if query has an edge shipment_comments.
func (f *ShipmentFilter) WhereHasShipmentComments() {
	f.Where(entql.HasEdge("shipment_comments"))
}

// WhereHasShipmentCommentsWith applies a predicate to check if query has an edge shipment_comments with a given conditions (other predicates).
func (f *ShipmentFilter) WhereHasShipmentCommentsWith(preds ...predicate.ShipmentComment) {
	f.Where(entql.HasEdgeWith("shipment_comments", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasShipmentCharges applies a predicate to check if query has an edge shipment_charges.
func (f *ShipmentFilter) WhereHasShipmentCharges() {
	f.Where(entql.HasEdge("shipment_charges"))
}

// WhereHasShipmentChargesWith applies a predicate to check if query has an edge shipment_charges with a given conditions (other predicates).
func (f *ShipmentFilter) WhereHasShipmentChargesWith(preds ...predicate.ShipmentCharges) {
	f.Where(entql.HasEdgeWith("shipment_charges", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasShipmentCommodities applies a predicate to check if query has an edge shipment_commodities.
func (f *ShipmentFilter) WhereHasShipmentCommodities() {
	f.Where(entql.HasEdge("shipment_commodities"))
}

// WhereHasShipmentCommoditiesWith applies a predicate to check if query has an edge shipment_commodities with a given conditions (other predicates).
func (f *ShipmentFilter) WhereHasShipmentCommoditiesWith(preds ...predicate.ShipmentCommodity) {
	f.Where(entql.HasEdgeWith("shipment_commodities", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *ShipmentFilter) WhereHasCreatedByUser() {
...
// WhereHasShipmentMoves applies a predicate to check if query has an edge shipment_moves.
func (f *ShipmentFilter) WhereHasShipmentMoves() {
	f.Where(entql.HasEdge("shipment_moves"))
}

// WhereHasShipmentMovesWith applies a predicate to check if query has an edge shipment_moves with a given conditions (other predicates).
func (f *ShipmentFilter) WhereHasShipmentMovesWith(preds ...predicate.ShipmentMove) {
	f.Where(entql.HasEdgeWith("shipment_moves", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// addPredicate implements the predicateAdder interface.
func (scq *ShipmentChargesQuery) addPredicate(pred func(s *sql.Selector)) {
	scq.predicates = append(scq.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the ShipmentChargesQuery builder.
func (scq *ShipmentChargesQuery) Filter() *ShipmentChargesFilter {
	return &ShipmentChargesFilter{config: scq.config, predicateAdder: scq}
}

// addPredicate implements the predicateAdder interface.
func (m *ShipmentChargesMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the ShipmentChargesMutation builder.
func (m *ShipmentChargesMutation) Filter() *ShipmentChargesFilter {
	return &ShipmentChargesFilter{config: m.config, predicateAdder: m}
}

// ShipmentChargesFilter provides a generic filtering capability at runtime for ShipmentChargesQuery.
type ShipmentChargesFilter struct {
	predicateAdder
	config
}

// Where applies the entql predicate on the query filter.
func (f *ShipmentChargesFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql [16]byte predicate on the id field.
func (f *ShipmentChargesFilter) WhereID(p entql.ValueP) {
	f.Where(p.Field(shipmentcharges.FieldID))
}

// WhereBusinessUnitID applies the entql [16]byte predicate on the business_unit_id field.
func (f *ShipmentChargesFilter) WhereBusinessUnitID(p entql.ValueP) {
	f.Where(p.Field(shipmentcharges.FieldBusinessUnitID))
}

// WhereOrganizationID applies the entql [16]byte predicate on the organization_id field.
func (f *ShipmentChargesFilter) WhereOrganizationID(p entql.ValueP) {
	f.Where(p.Field(shipmentcharges.FieldOrganizationID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *ShipmentChargesFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(shipmentcharges.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *ShipmentChargesFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(shipmentcharges.FieldUpdatedAt))
}

// WhereVersion applies the entql int predicate on the version field.
func (f *ShipmentChargesFilter) WhereVersion(p entql.IntP) {
	f.Where(p.Field(shipmentcharges.FieldVersion))
}

// WhereShipmentID applies the entql [16]byte predicate on the shipment_id field.
func (f *ShipmentChargesFilter) WhereShipmentID(p entql.ValueP) {
	f.Where(p.Field(shipmentcharges.FieldShipmentID))
}

// WhereAccessorialChargeID applies the entql [16]byte predicate on the accessorial_charge_id field.
func (f *ShipmentChargesFilter) WhereAccessorialChargeID(p entql.ValueP) {
	f.Where(p.Field(shipmentcharges.FieldAccessorialChargeID))
}

// WhereDescription applies the entql string predicate on the description field.
func (f *ShipmentChargesFilter) WhereDescription(p entql.StringP) {
	f.Where(p.Field(shipmentcharges.FieldDescription))
}

// WhereChargeAmount applies the entql float64 predicate on the charge_amount field.
func (f *ShipmentChargesFilter) WhereChargeAmount(p entql.Float64P) {
	f.Where(p.Field(shipmentcharges.FieldChargeAmount))
}

// WhereUnits applies the entql int predicate on the units field.
func (f *ShipmentChargesFilter) WhereUnits(p entql.IntP) {
	f.Where(p.Field(shipmentcharges.FieldUnits))
}

// WhereSubTotal applies the entql float64 predicate on the sub_total field.
func (f *ShipmentChargesFilter) WhereSubTotal(p entql.Float64P) {
	f.Where(p.Field(shipmentcharges.FieldSubTotal))
}

// WhereCreatedBy applies the entql [16]byte predicate on the created_by field.
func (f *ShipmentChargesFilter) WhereCreatedBy(p entql.ValueP) {
	f.Where(p.Field(shipmentcharges.FieldCreatedBy))
}

// WhereHasBusinessUnit applies a predicate to check if query has an edge business_unit.
func (f *ShipmentChargesFilter) WhereHasBusinessUnit() {
	f.Where(entql.HasEdge("business_unit"))
}

// WhereHasBusinessUnitWith applies a predicate to check if query has an edge business_unit with a given conditions (other predicates).
func (f *ShipmentChargesFilter) WhereHasBusinessUnitWith(preds ...predicate.BusinessUnit) {
	f.Where(entql.HasEdgeWith("business_unit", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOrganization applies a predicate to check if query has an edge organization.
func (f *ShipmentChargesFilter) WhereHasOrganization() {
	f.Where(entql.HasEdge("organization"))
}

// WhereHasOrganizationWith applies a predicate to check if query has an edge organization with a given conditions (other predicates).
func (f *ShipmentChargesFilter) WhereHasOrganizationWith(preds ...predicate.Organization) {
	f.Where(entql.HasEdgeWith("organization", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
func (f *ShipmentChargesFilter) WhereHasShipment() {
...
func (f *ShipmentChargesFilter) WhereHasShipmentWith(preds ...predicate.Shipment) {
...
// WhereHasAccessorialCharge applies a predicate to check if query has an edge accessorial_charge.
func (f *ShipmentChargesFilter) WhereHasAccessorialCharge() {
	f.Where(entql.HasEdge("accessorial_charge"))
}

// WhereHasAccessorialChargeWith applies a predicate to check if query has an edge accessorial_charge with a given conditions (other predicates).
func (f *ShipmentChargesFilter) WhereHasAccessorialChargeWith(preds ...predicate.AccessorialCharge) {
	f.Where(entql.HasEdgeWith("accessorial_charge", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasUser applies a predicate to check if query has an edge user.
func (f *ShipmentChargesFilter) WhereHasUser() {
	f.Where(entql.HasEdge("user"))
}

// WhereHasUserWith applies a predicate to check if query has an edge user with a given conditions (other predicates).
func (f *ShipmentChargesFilter) WhereHasUserWith(preds ...predicate.User) {
	f.Where(entql.HasEdgeWith("user", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// addPredicate implements the predicateAdder interface.
func (scq *ShipmentCommentQuery) addPredicate(pred func(s *sql.Selector)) {
	scq.predicates = append(scq.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the ShipmentCommentQuery builder.
func (scq *ShipmentCommentQuery) Filter() *ShipmentCommentFilter {
	return &ShipmentCommentFilter{config: scq.config, predicateAdder: scq}
}

// addPredicate implements the predicateAdder interface.
func (m *ShipmentCommentMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the ShipmentCommentMutation builder.
func (m *ShipmentCommentMutation) Filter() *ShipmentCommentFilter {
	return &ShipmentCommentFilter{config: m.config, predicateAdder: m}
}

// ShipmentCommentFilter provides a generic filtering capability at runtime for ShipmentCommentQuery.
type ShipmentCommentFilter struct {
	predicateAdder
	config
}

// Where applies the entql predicate on the query filter.
func (f *ShipmentCommentFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql [16]byte predicate on the id field.
func (f *ShipmentCommentFilter) WhereID(p entql.ValueP) {
	f.Where(p.Field(shipmentcomment.FieldID))
}

// WhereBusinessUnitID applies the entql [16]byte predicate on the business_unit_id field.
func (f *ShipmentCommentFilter) WhereBusinessUnitID(p entql.ValueP) {
	f.Where(p.Field(shipmentcomment.FieldBusinessUnitID))
}

// WhereOrganizationID applies the entql [16]byte predicate on the organization_id field.
func (f *ShipmentCommentFilter) WhereOrganizationID(p entql.ValueP) {
	f.Where(p.Field(shipmentcomment.FieldOrganizationID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *ShipmentCommentFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(shipmentcomment.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *ShipmentCommentFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(shipmentcomment.FieldUpdatedAt))
}

// WhereVersion applies the entql int predicate on the version field.
func (f *ShipmentCommentFilter) WhereVersion(p entql.IntP) {
	f.Where(p.Field(shipmentcomment.FieldVersion))
}

// WhereShipmentID applies the entql [16]byte predicate on the shipment_id field.
func (f *ShipmentCommentFilter) WhereShipmentID(p entql.ValueP) {
	f.Where(p.Field(shipmentcomment.FieldShipmentID))
}

// WhereCommentTypeID applies the entql [16]byte predicate on the comment_type_id field.
func (f *ShipmentCommentFilter) WhereCommentTypeID(p entql.ValueP) {
	f.Where(p.Field(shipmentcomment.FieldCommentTypeID))
}

// WhereComment applies the entql string predicate on the comment field.
func (f *ShipmentCommentFilter) WhereComment(p entql.StringP) {
	f.Where(p.Field(shipmentcomment.FieldComment))
}

// WhereCreatedBy applies the entql [16]byte predicate on the created_by field.
func (f *ShipmentCommentFilter) WhereCreatedBy(p entql.ValueP) {
	f.Where(p.Field(shipmentcomment.FieldCreatedBy))
}

// WhereHasBusinessUnit applies a predicate to check if query has an edge business_unit.
func (f *ShipmentCommentFilter) WhereHasBusinessUnit() {
	f.Where(entql.HasEdge("business_unit"))
}

// WhereHasBusinessUnitWith applies a predicate to check if query has an edge business_unit with a given conditions (other predicates).
func (f *ShipmentCommentFilter) WhereHasBusinessUnitWith(preds ...predicate.BusinessUnit) {
	f.Where(entql.HasEdgeWith("business_unit", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOrganization applies a predicate to check if query has an edge organization.
func (f *ShipmentCommentFilter) WhereHasOrganization() {
	f.Where(entql.HasEdge("organization"))
}

// WhereHasOrganizationWith applies a predicate to check if query has an edge organization with a given conditions (other predicates).
func (f *ShipmentCommentFilter) WhereHasOrganizationWith(preds ...predicate.Organization) {
	f.Where(entql.HasEdgeWith("organization", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasShipment applies a predicate to check if query has an edge shipment.
func (f *ShipmentCommentFilter) WhereHasShipment() {
	f.Where(entql.HasEdge("shipment"))
}

// WhereHasShipmentWith applies a predicate to check if query has an edge shipment with a given conditions (other predicates).
func (f *ShipmentCommentFilter) WhereHasShipmentWith(preds ...predicate.Shipment) {
	f.Where(entql.HasEdgeWith("shipment", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasCommentType applies a predicate to check if query has an edge comment_type.
func (f *ShipmentCommentFilter) WhereHasCommentType() {
	f.Where(entql.HasEdge("comment_type"))
}

// WhereHasCommentTypeWith applies a predicate to check if query has an edge comment_type with a given conditions (other predicates).
func (f *ShipmentCommentFilter) WhereHasCommentTypeWith(preds ...predicate.CommentType) {
	f.Where(entql.HasEdgeWith("comment_type", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasCreatedByUser applies a predicate to check if query has an edge created_by_user.
func (f *ShipmentCommentFilter) WhereHasCreatedByUser() {
	f.Where(entql.HasEdge("created_by_user"))
}

// WhereHasCreatedByUserWith applies a predicate to check if query has an edge created_by_user with a given conditions (other predicates).
func (f *ShipmentCommentFilter) WhereHasCreatedByUserWith(preds ...predicate.User) {
	f.Where(entql.HasEdgeWith("created_by_user", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// addPredicate implements the predicateAdder interface.
func (scq *ShipmentCommodityQuery) addPredicate(pred func(s *sql.Selector)) {
	scq.predicates = append(scq.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the ShipmentCommodityQuery builder.
func (scq *ShipmentCommodityQuery) Filter() *ShipmentCommodityFilter {
	return &ShipmentCommodityFilter{config: scq.config, predicateAdder: scq}
}

// addPredicate implements the predicateAdder interface.
func (m *ShipmentCommodityMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the ShipmentCommodityMutation builder.
func (m *ShipmentCommodityMutation) Filter() *ShipmentCommodityFilter {
	return &ShipmentCommodityFilter{config: m.config, predicateAdder: m}
}

// ShipmentCommodityFilter provides a generic filtering capability at runtime for ShipmentCommodityQuery.
type ShipmentCommodityFilter struct {
	predicateAdder
	config
}

// Where applies the entql predicate on the query filter.
func (f *ShipmentCommodityFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql [16]byte predicate on the id field.
func (f *ShipmentCommodityFilter) WhereID(p entql.ValueP) {
	f.Where(p.Field(shipmentcommodity.FieldID))
}

// WhereBusinessUnitID applies the entql [16]byte predicate on the business_unit_id field.
func (f *ShipmentCommodityFilter) WhereBusinessUnitID(p entql.ValueP) {
	f.Where(p.Field(shipmentcommodity.FieldBusinessUnitID))
}

// WhereOrganizationID applies the entql [16]byte predicate on the organization_id field.
func (f *ShipmentCommodityFilter) WhereOrganizationID(p entql.ValueP) {
	f.Where(p.Field(shipmentcommodity.FieldOrganizationID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *ShipmentCommodityFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(shipmentcommodity.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *ShipmentCommodityFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(shipmentcommodity.FieldUpdatedAt))
}

// WhereVersion applies the entql int predicate on the version field.
func (f *ShipmentCommodityFilter) WhereVersion(p entql.IntP) {
	f.Where(p.Field(shipmentcommodity.FieldVersion))
}

// WhereShipmentID applies the entql [16]byte predicate on the shipment_id field.
func (f *ShipmentCommodityFilter) WhereShipmentID(p entql.ValueP) {
	f.Where(p.Field(shipmentcommodity.FieldShipmentID))
}

// WhereCommodityID applies the entql [16]byte predicate on the commodity_id field.
func (f *ShipmentCommodityFilter) WhereCommodityID(p entql.ValueP) {
	f.Where(p.Field(shipmentcommodity.FieldCommodityID))
}

// WhereHazardousMaterialID applies the entql [16]byte predicate on the hazardous_material_id field.
func (f *ShipmentCommodityFilter) WhereHazardousMaterialID(p entql.ValueP) {
	f.Where(p.Field(shipmentcommodity.FieldHazardousMaterialID))
}

// WhereSubTotal applies the entql float64 predicate on the sub_total field.
func (f *ShipmentCommodityFilter) WhereSubTotal(p entql.Float64P) {
	f.Where(p.Field(shipmentcommodity.FieldSubTotal))
}

// WherePlacardNeeded applies the entql bool predicate on the placard_needed field.
func (f *ShipmentCommodityFilter) WherePlacardNeeded(p entql.BoolP) {
	f.Where(p.Field(shipmentcommodity.FieldPlacardNeeded))
}

// WhereHasBusinessUnit applies a predicate to check if query has an edge business_unit.
func (f *ShipmentCommodityFilter) WhereHasBusinessUnit() {
	f.Where(entql.HasEdge("business_unit"))
}

// WhereHasBusinessUnitWith applies a predicate to check if query has an edge business_unit with a given conditions (other predicates).
func (f *ShipmentCommodityFilter) WhereHasBusinessUnitWith(preds ...predicate.BusinessUnit) {
	f.Where(entql.HasEdgeWith("business_unit", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOrganization applies a predicate to check if query has an edge organization.
func (f *ShipmentCommodityFilter) WhereHasOrganization() {
	f.Where(entql.HasEdge("organization"))
}

// WhereHasOrganizationWith applies a predicate to check if query has an edge organization with a given conditions (other predicates).
func (f *ShipmentCommodityFilter) WhereHasOrganizationWith(preds ...predicate.Organization) {
	f.Where(entql.HasEdgeWith("organization", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasShipment applies a predicate to check if query has an edge shipment.
func (f *ShipmentCommodityFilter) WhereHasShipment() {
	f.Where(entql.HasEdge("shipment"))
}

// WhereHasShipmentWith applies a predicate to check if query has an edge shipment with a given conditions (other predicates).
func (f *ShipmentCommodityFilter) WhereHasShipmentWith(preds ...predicate.Shipment) {
	f.Where(entql.HasEdgeWith("shipment", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// addPredicate implements the predicateAdder interface.
func (sdq *ShipmentDocumentationQuery) addPredicate(pred func(s *sql.Selector)) {
	sdq.predicates = append(sdq.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the ShipmentDocumentationQuery builder.
func (sdq *ShipmentDocumentationQuery) Filter() *ShipmentDocumentationFilter {
	return &ShipmentDocumentationFilter{config: sdq.config, predicateAdder: sdq}
}

// addPredicate implements the predicateAdder interface.
func (m *ShipmentDocumentationMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the ShipmentDocumentationMutation builder.
func (m *ShipmentDocumentationMutation) Filter() *ShipmentDocumentationFilter {
	return &ShipmentDocumentationFilter{config: m.config, predicateAdder: m}
}

// ShipmentDocumentationFilter provides a generic filtering capability at runtime for ShipmentDocumentationQuery.
type ShipmentDocumentationFilter struct {
	predicateAdder
	config
}

// Where applies the entql predicate on the query filter.
func (f *ShipmentDocumentationFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql [16]byte predicate on the id field.
func (f *ShipmentDocumentationFilter) WhereID(p entql.ValueP) {
	f.Where(p.Field(shipmentdocumentation.FieldID))
}

// WhereBusinessUnitID applies the entql [16]byte predicate on the business_unit_id field.
func (f *ShipmentDocumentationFilter) WhereBusinessUnitID(p entql.ValueP) {
	f.Where(p.Field(shipmentdocumentation.FieldBusinessUnitID))
}

// WhereOrganizationID applies the entql [16]byte predicate on the organization_id field.
func (f *ShipmentDocumentationFilter) WhereOrganizationID(p entql.ValueP) {
	f.Where(p.Field(shipmentdocumentation.FieldOrganizationID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *ShipmentDocumentationFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(shipmentdocumentation.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *ShipmentDocumentationFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(shipmentdocumentation.FieldUpdatedAt))
}

// WhereVersion applies the entql int predicate on the version field.
func (f *ShipmentDocumentationFilter) WhereVersion(p entql.IntP) {
	f.Where(p.Field(shipmentdocumentation.FieldVersion))
}

// WhereShipmentID applies the entql [16]byte predicate on the shipment_id field.
func (f *ShipmentDocumentationFilter) WhereShipmentID(p entql.ValueP) {
	f.Where(p.Field(shipmentdocumentation.FieldShipmentID))
}

// WhereDocumentURL applies the entql string predicate on the document_url field.
func (f *ShipmentDocumentationFilter) WhereDocumentURL(p entql.StringP) {
	f.Where(p.Field(shipmentdocumentation.FieldDocumentURL))
}

// WhereDocumentClassificationID applies the entql [16]byte predicate on the document_classification_id field.
func (f *ShipmentDocumentationFilter) WhereDocumentClassificationID(p entql.ValueP) {
	f.Where(p.Field(shipmentdocumentation.FieldDocumentClassificationID))
}

// WhereHasBusinessUnit applies a predicate to check if query has an edge business_unit.
func (f *ShipmentDocumentationFilter) WhereHasBusinessUnit() {
	f.Where(entql.HasEdge("business_unit"))
}

// WhereHasBusinessUnitWith applies a predicate to check if query has an edge business_unit with a given conditions (other predicates).
func (f *ShipmentDocumentationFilter) WhereHasBusinessUnitWith(preds ...predicate.BusinessUnit) {
	f.Where(entql.HasEdgeWith("business_unit", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOrganization applies a predicate to check if query has an edge organization.
func (f *ShipmentDocumentationFilter) WhereHasOrganization() {
	f.Where(entql.HasEdge("organization"))
}

// WhereHasOrganizationWith applies a predicate to check if query has an edge organization with a given conditions (other predicates).
func (f *ShipmentDocumentationFilter) WhereHasOrganizationWith(preds ...predicate.Organization) {
	f.Where(entql.HasEdgeWith("organization", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasShipment applies a predicate to check if query has an edge shipment.
func (f *ShipmentDocumentationFilter) WhereHasShipment() {
	f.Where(entql.HasEdge("shipment"))
}

// WhereHasShipmentWith applies a predicate to check if query has an edge shipment with a given conditions (other predicates).
func (f *ShipmentDocumentationFilter) WhereHasShipmentWith(preds ...predicate.Shipment) {
	f.Where(entql.HasEdgeWith("shipment", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasDocumentClassification applies a predicate to check if query has an edge document_classification.
func (f *ShipmentDocumentationFilter) WhereHasDocumentClassification() {
	f.Where(entql.HasEdge("document_classification"))
}

// WhereHasDocumentClassificationWith applies a predicate to check if query has an edge document_classification with a given conditions (other predicates).
func (f *ShipmentDocumentationFilter) WhereHasDocumentClassificationWith(preds ...predicate.DocumentClassification) {
	f.Where(entql.HasEdgeWith("document_classification", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// addPredicate implements the predicateAdder interface.
func (smq *ShipmentMoveQuery) addPredicate(pred func(s *sql.Selector)) {
	smq.predicates = append(smq.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the ShipmentMoveQuery builder.
func (smq *ShipmentMoveQuery) Filter() *ShipmentMoveFilter {
	return &ShipmentMoveFilter{config: smq.config, predicateAdder: smq}
}

// addPredicate implements the predicateAdder interface.
func (m *ShipmentMoveMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the ShipmentMoveMutation builder.
func (m *ShipmentMoveMutation) Filter() *ShipmentMoveFilter {
	return &ShipmentMoveFilter{config: m.config, predicateAdder: m}
}

// ShipmentMoveFilter provides a generic filtering capability at runtime for ShipmentMoveQuery.
type ShipmentMoveFilter struct {
	predicateAdder
	config
}

// Where applies the entql predicate on the query filter.
func (f *ShipmentMoveFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql [16]byte predicate on the id field.
func (f *ShipmentMoveFilter) WhereID(p entql.ValueP) {
	f.Where(p.Field(shipmentmove.FieldID))
}

// WhereBusinessUnitID applies the entql [16]byte predicate on the business_unit_id field.
func (f *ShipmentMoveFilter) WhereBusinessUnitID(p entql.ValueP) {
	f.Where(p.Field(shipmentmove.FieldBusinessUnitID))
}

// WhereOrganizationID applies the entql [16]byte predicate on the organization_id field.
func (f *ShipmentMoveFilter) WhereOrganizationID(p entql.ValueP) {
	f.Where(p.Field(shipmentmove.FieldOrganizationID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *ShipmentMoveFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(shipmentmove.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *ShipmentMoveFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(shipmentmove.FieldUpdatedAt))
}

// WhereVersion applies the entql int predicate on the version field.
func (f *ShipmentMoveFilter) WhereVersion(p entql.IntP) {
	f.Where(p.Field(shipmentmove.FieldVersion))
}

// WhereReferenceNumber applies the entql string predicate on the reference_number field.
func (f *ShipmentMoveFilter) WhereReferenceNumber(p entql.StringP) {
	f.Where(p.Field(shipmentmove.FieldReferenceNumber))
}

// WhereStatus applies the entql string predicate on the status field.
func (f *ShipmentMoveFilter) WhereStatus(p entql.StringP) {
	f.Where(p.Field(shipmentmove.FieldStatus))
}

// WhereIsLoaded applies the entql bool predicate on the is_loaded field.
func (f *ShipmentMoveFilter) WhereIsLoaded(p entql.BoolP) {
	f.Where(p.Field(shipmentmove.FieldIsLoaded))
}

// WhereShipmentID applies the entql [16]byte predicate on the shipment_id field.
func (f *ShipmentMoveFilter) WhereShipmentID(p entql.ValueP) {
	f.Where(p.Field(shipmentmove.FieldShipmentID))
}

// WhereTractorID applies the entql [16]byte predicate on the tractor_id field.
func (f *ShipmentMoveFilter) WhereTractorID(p entql.ValueP) {
	f.Where(p.Field(shipmentmove.FieldTractorID))
}

// WhereTrailerID applies the entql [16]byte predicate on the trailer_id field.
func (f *ShipmentMoveFilter) WhereTrailerID(p entql.ValueP) {
	f.Where(p.Field(shipmentmove.FieldTrailerID))
}

// WherePrimaryWorkerID applies the entql [16]byte predicate on the primary_worker_id field.
func (f *ShipmentMoveFilter) WherePrimaryWorkerID(p entql.ValueP) {
	f.Where(p.Field(shipmentmove.FieldPrimaryWorkerID))
}

// WhereSecondaryWorkerID applies the entql [16]byte predicate on the secondary_worker_id field.
func (f *ShipmentMoveFilter) WhereSecondaryWorkerID(p entql.ValueP) {
	f.Where(p.Field(shipmentmove.FieldSecondaryWorkerID))
}

// WhereHasBusinessUnit applies a predicate to check if query has an edge business_unit.
func (f *ShipmentMoveFilter) WhereHasBusinessUnit() {
	f.Where(entql.HasEdge("business_unit"))
}

// WhereHasBusinessUnitWith applies a predicate to check if query has an edge business_unit with a given conditions (other predicates).
func (f *ShipmentMoveFilter) WhereHasBusinessUnitWith(preds ...predicate.BusinessUnit) {
	f.Where(entql.HasEdgeWith("business_unit", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOrganization applies a predicate to check if query has an edge organization.
func (f *ShipmentMoveFilter) WhereHasOrganization() {
	f.Where(entql.HasEdge("organization"))
}

// WhereHasOrganizationWith applies a predicate to check if query has an edge organization with a given conditions (other predicates).
func (f *ShipmentMoveFilter) WhereHasOrganizationWith(preds ...predicate.Organization) {
	f.Where(entql.HasEdgeWith("organization", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasShipment applies a predicate to check if query has an edge shipment.
func (f *ShipmentMoveFilter) WhereHasShipment() {
	f.Where(entql.HasEdge("shipment"))
}

// WhereHasShipmentWith applies a predicate to check if query has an edge shipment with a given conditions (other predicates).
func (f *ShipmentMoveFilter) WhereHasShipmentWith(preds ...predicate.Shipment) {
	f.Where(entql.HasEdgeWith("shipment", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasTractor applies a predicate to check if query has an edge tractor.
func (f *ShipmentMoveFilter) WhereHasTractor() {
	f.Where(entql.HasEdge("tractor"))
}

// WhereHasTractorWith applies a predicate to check if query has an edge tractor with a given conditions (other predicates).
func (f *ShipmentMoveFilter) WhereHasTractorWith(preds ...predicate.Tractor) {
	f.Where(entql.HasEdgeWith("tractor", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereHasTrailer applies a predicate to check if query has an edge trailer.
func (f *ShipmentMoveFilter) WhereHasTrailer() {
	f.Where(entql.HasEdge("trailer"))
}

// WhereHasTrailerWith applies a predicate to check if query has an edge trailer with a given conditions (other predicates).
func (f *ShipmentMoveFilter) WhereHasTrailerWith(preds ...predicate.Tractor) {
	f.Where(entql.HasEdgeWith("trailer", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
func (f *ShipmentMoveFilter) WhereHasPrimaryWorker() {
...
func (f *ShipmentMoveFilter) WhereHasPrimaryWorkerWith(preds ...predicate.Worker) {
...
func (f *ShipmentMoveFilter) WhereHasSecondaryWorker() {
...
func (f *ShipmentMoveFilter) WhereHasSecondaryWorkerWith(preds ...predicate.Worker) {
...
// WhereHasMoveStops applies a predicate to check if query has an edge move_stops.
func (f *ShipmentMoveFilter) WhereHasMoveStops() {
	f.Where(entql.HasEdge("move_stops"))
}

// WhereHasMoveStopsWith applies a predicate to check if query has an edge move_stops with a given conditions (other predicates).
func (f *ShipmentMoveFilter) WhereHasMoveStopsWith(preds ...predicate.Stop) {
	f.Where(entql.HasEdgeWith("move_stops", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// addPredicate implements the predicateAdder interface.
func (srq *ShipmentRouteQuery) addPredicate(pred func(s *sql.Selector)) {
	srq.predicates = append(srq.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the ShipmentRouteQuery builder.
func (srq *ShipmentRouteQuery) Filter() *ShipmentRouteFilter {
	return &ShipmentRouteFilter{config: srq.config, predicateAdder: srq}
}

// addPredicate implements the predicateAdder interface.
func (m *ShipmentRouteMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the ShipmentRouteMutation builder.
func (m *ShipmentRouteMutation) Filter() *ShipmentRouteFilter {
	return &ShipmentRouteFilter{config: m.config, predicateAdder: m}
}

// ShipmentRouteFilter provides a generic filtering capability at runtime for ShipmentRouteQuery.
type ShipmentRouteFilter struct {
	predicateAdder
	config
}

// Where applies the entql predicate on the query filter.
func (f *ShipmentRouteFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql [16]byte predicate on the id field.
func (f *ShipmentRouteFilter) WhereID(p entql.ValueP) {
	f.Where(p.Field(shipmentroute.FieldID))
}

// WhereBusinessUnitID applies the entql [16]byte predicate on the business_unit_id field.
func (f *ShipmentRouteFilter) WhereBusinessUnitID(p entql.ValueP) {
	f.Where(p.Field(shipmentroute.FieldBusinessUnitID))
}

// WhereOrganizationID applies the entql [16]byte predicate on the organization_id field.
func (f *ShipmentRouteFilter) WhereOrganizationID(p entql.ValueP) {
	f.Where(p.Field(shipmentroute.FieldOrganizationID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *ShipmentRouteFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(shipmentroute.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *ShipmentRouteFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(shipmentroute.FieldUpdatedAt))
}

// WhereVersion applies the entql int predicate on the version field.
func (f *ShipmentRouteFilter) WhereVersion(p entql.IntP) {
	f.Where(p.Field(shipmentroute.FieldVersion))
}

// WhereOriginLocationID applies the entql [16]byte predicate on the origin_location_id field.
func (f *ShipmentRouteFilter) WhereOriginLocationID(p entql.ValueP) {
	f.Where(p.Field(shipmentroute.FieldOriginLocationID))
}

// WhereDestinationLocationID applies the entql [16]byte predicate on the destination_location_id field.
func (f *ShipmentRouteFilter) WhereDestinationLocationID(p entql.ValueP) {
	f.Where(p.Field(shipmentroute.FieldDestinationLocationID))
}

// WhereMileage applies the entql float64 predicate on the mileage field.
func (f *ShipmentRouteFilter) WhereMileage(p entql.Float64P) {
	f.Where(p.Field(shipmentroute.FieldMileage))
}

// WhereDuration applies the entql int predicate on the duration field.
func (f *ShipmentRouteFilter) WhereDuration(p entql.IntP) {
	f.Where(p.Field(shipmentroute.FieldDuration))
}

// WhereDistanceMethod applies the entql string predicate on the distance_method field.
func (f *ShipmentRouteFilter) WhereDistanceMethod(p entql.StringP) {
	f.Where(p.Field(shipmentroute.FieldDistanceMethod))
}

// WhereAutoGenerated applies the entql bool predicate on the auto_generated field.
func (f *ShipmentRouteFilter) WhereAutoGenerated(p entql.BoolP) {
	f.Where(p.Field(shipmentroute.FieldAutoGenerated))
}

// WhereHasBusinessUnit applies a predicate to check if query has an edge business_unit.
func (f *ShipmentRouteFilter) WhereHasBusinessUnit() {
	f.Where(entql.HasEdge("business_unit"))
}

// WhereHasBusinessUnitWith applies a predicate to check if query has an edge business_unit with a given conditions (other predicates).
func (f *ShipmentRouteFilter) WhereHasBusinessUnitWith(preds ...predicate.BusinessUnit) {
	f.Where(entql.HasEdgeWith("business_unit", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOrganization applies a predicate to check if query has an edge organization.
func (f *ShipmentRouteFilter) WhereHasOrganization() {
	f.Where(entql.HasEdge("organization"))
}

// WhereHasOrganizationWith applies a predicate to check if query has an edge organization with a given conditions (other predicates).
func (f *ShipmentRouteFilter) WhereHasOrganizationWith(preds ...predicate.Organization) {
	f.Where(entql.HasEdgeWith("organization", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOriginLocation applies a predicate to check if query has an edge origin_location.
func (f *ShipmentRouteFilter) WhereHasOriginLocation() {
	f.Where(entql.HasEdge("origin_location"))
}

// WhereHasOriginLocationWith applies a predicate to check if query has an edge origin_location with a given conditions (other predicates).
func (f *ShipmentRouteFilter) WhereHasOriginLocationWith(preds ...predicate.Location) {
	f.Where(entql.HasEdgeWith("origin_location", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasDestinationLocation applies a predicate to check if query has an edge destination_location.
func (f *ShipmentRouteFilter) WhereHasDestinationLocation() {
	f.Where(entql.HasEdge("destination_location"))
}

// WhereHasDestinationLocationWith applies a predicate to check if query has an edge destination_location with a given conditions (other predicates).
func (f *ShipmentRouteFilter) WhereHasDestinationLocationWith(preds ...predicate.Location) {
	f.Where(entql.HasEdgeWith("destination_location", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereColor applies the entql string predicate on the color field.
func (f *ShipmentTypeFilter) WhereColor(p entql.StringP) {
	f.Where(p.Field(shipmenttype.FieldColor))
}
...
// WhereHasRates applies a predicate to check if query has an edge rates.
func (f *ShipmentTypeFilter) WhereHasRates() {
	f.Where(entql.HasEdge("rates"))
}

// WhereHasRatesWith applies a predicate to check if query has an edge rates with a given conditions (other predicates).
func (f *ShipmentTypeFilter) WhereHasRatesWith(preds ...predicate.Rate) {
	f.Where(entql.HasEdgeWith("rates", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// addPredicate implements the predicateAdder interface.
func (sq *StopQuery) addPredicate(pred func(s *sql.Selector)) {
	sq.predicates = append(sq.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the StopQuery builder.
func (sq *StopQuery) Filter() *StopFilter {
	return &StopFilter{config: sq.config, predicateAdder: sq}
}

// addPredicate implements the predicateAdder interface.
func (m *StopMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the StopMutation builder.
func (m *StopMutation) Filter() *StopFilter {
	return &StopFilter{config: m.config, predicateAdder: m}
}

// StopFilter provides a generic filtering capability at runtime for StopQuery.
...
// Where applies the entql predicate on the query filter.
func (f *StopFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql [16]byte predicate on the id field.
func (f *StopFilter) WhereID(p entql.ValueP) {
	f.Where(p.Field(stop.FieldID))
}

// WhereBusinessUnitID applies the entql [16]byte predicate on the business_unit_id field.
func (f *StopFilter) WhereBusinessUnitID(p entql.ValueP) {
	f.Where(p.Field(stop.FieldBusinessUnitID))
}

// WhereOrganizationID applies the entql [16]byte predicate on the organization_id field.
func (f *StopFilter) WhereOrganizationID(p entql.ValueP) {
	f.Where(p.Field(stop.FieldOrganizationID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *StopFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(stop.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *StopFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(stop.FieldUpdatedAt))
}

// WhereVersion applies the entql int predicate on the version field.
func (f *StopFilter) WhereVersion(p entql.IntP) {
	f.Where(p.Field(stop.FieldVersion))
}

// WhereStatus applies the entql string predicate on the status field.
func (f *StopFilter) WhereStatus(p entql.StringP) {
	f.Where(p.Field(stop.FieldStatus))
}

// WhereShipmentMoveID applies the entql [16]byte predicate on the shipment_move_id field.
func (f *StopFilter) WhereShipmentMoveID(p entql.ValueP) {
	f.Where(p.Field(stop.FieldShipmentMoveID))
}

// WhereStopType applies the entql string predicate on the stop_type field.
func (f *StopFilter) WhereStopType(p entql.StringP) {
	f.Where(p.Field(stop.FieldStopType))
}

// WhereSequence applies the entql int predicate on the sequence field.
func (f *StopFilter) WhereSequence(p entql.IntP) {
	f.Where(p.Field(stop.FieldSequence))
}

// WhereLocationID applies the entql [16]byte predicate on the location_id field.
func (f *StopFilter) WhereLocationID(p entql.ValueP) {
	f.Where(p.Field(stop.FieldLocationID))
}

// WherePieces applies the entql float64 predicate on the pieces field.
func (f *StopFilter) WherePieces(p entql.Float64P) {
	f.Where(p.Field(stop.FieldPieces))
}

// WhereWeight applies the entql float64 predicate on the weight field.
func (f *StopFilter) WhereWeight(p entql.Float64P) {
	f.Where(p.Field(stop.FieldWeight))
}

// WhereAddressLine applies the entql string predicate on the address_line field.
func (f *StopFilter) WhereAddressLine(p entql.StringP) {
	f.Where(p.Field(stop.FieldAddressLine))
}

// WhereAppointmentStart applies the entql time.Time predicate on the appointment_start field.
func (f *StopFilter) WhereAppointmentStart(p entql.TimeP) {
	f.Where(p.Field(stop.FieldAppointmentStart))
}

// WhereAppointmentEnd applies the entql time.Time predicate on the appointment_end field.
func (f *StopFilter) WhereAppointmentEnd(p entql.TimeP) {
	f.Where(p.Field(stop.FieldAppointmentEnd))
}

// WhereArrivalTime applies the entql time.Time predicate on the arrival_time field.
func (f *StopFilter) WhereArrivalTime(p entql.TimeP) {
	f.Where(p.Field(stop.FieldArrivalTime))
}

// WhereDepartureTime applies the entql time.Time predicate on the departure_time field.
func (f *StopFilter) WhereDepartureTime(p entql.TimeP) {
	f.Where(p.Field(stop.FieldDepartureTime))
}

// WhereHasBusinessUnit applies a predicate to check if query has an edge business_unit.
func (f *StopFilter) WhereHasBusinessUnit() {
	f.Where(entql.HasEdge("business_unit"))
}

// WhereHasBusinessUnitWith applies a predicate to check if query has an edge business_unit with a given conditions (other predicates).
func (f *StopFilter) WhereHasBusinessUnitWith(preds ...predicate.BusinessUnit) {
	f.Where(entql.HasEdgeWith("business_unit", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOrganization applies a predicate to check if query has an edge organization.
func (f *StopFilter) WhereHasOrganization() {
	f.Where(entql.HasEdge("organization"))
}

// WhereHasOrganizationWith applies a predicate to check if query has an edge organization with a given conditions (other predicates).
func (f *StopFilter) WhereHasOrganizationWith(preds ...predicate.Organization) {
	f.Where(entql.HasEdgeWith("organization", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasShipmentMove applies a predicate to check if query has an edge shipment_move.
func (f *StopFilter) WhereHasShipmentMove() {
	f.Where(entql.HasEdge("shipment_move"))
}

// WhereHasShipmentMoveWith applies a predicate to check if query has an edge shipment_move with a given conditions (other predicates).
func (f *StopFilter) WhereHasShipmentMoveWith(preds ...predicate.ShipmentMove) {
	f.Where(entql.HasEdgeWith("shipment_move", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereHasUserNotifications applies a predicate to check if query has an edge user_notifications.
func (f *UserFilter) WhereHasUserNotifications() {
	f.Where(entql.HasEdge("user_notifications"))
}

// WhereHasUserNotificationsWith applies a predicate to check if query has an edge user_notifications with a given conditions (other predicates).
func (f *UserFilter) WhereHasUserNotificationsWith(preds ...predicate.UserNotification) {
	f.Where(entql.HasEdgeWith("user_notifications", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
	})))
...
// WhereHasShipmentComments applies a predicate to check if query has an edge shipment_comments.
func (f *UserFilter) WhereHasShipmentComments() {
	f.Where(entql.HasEdge("shipment_comments"))
}

// WhereHasShipmentCommentsWith applies a predicate to check if query has an edge shipment_comments with a given conditions (other predicates).
func (f *UserFilter) WhereHasShipmentCommentsWith(preds ...predicate.ShipmentComment) {
	f.Where(entql.HasEdgeWith("shipment_comments", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasShipmentCharges applies a predicate to check if query has an edge shipment_charges.
func (f *UserFilter) WhereHasShipmentCharges() {
	f.Where(entql.HasEdge("shipment_charges"))
}

// WhereHasShipmentChargesWith applies a predicate to check if query has an edge shipment_charges with a given conditions (other predicates).
func (f *UserFilter) WhereHasShipmentChargesWith(preds ...predicate.ShipmentCharges) {
	f.Where(entql.HasEdgeWith("shipment_charges", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
func (f *UserFilter) WhereHasReports() {
...
func (f *UserFilter) WhereHasReportsWith(preds ...predicate.UserReport) {
...
// addPredicate implements the predicateAdder interface.
func (unq *UserNotificationQuery) addPredicate(pred func(s *sql.Selector)) {
	unq.predicates = append(unq.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the UserNotificationQuery builder.
func (unq *UserNotificationQuery) Filter() *UserNotificationFilter {
	return &UserNotificationFilter{config: unq.config, predicateAdder: unq}
}

// addPredicate implements the predicateAdder interface.
func (m *UserNotificationMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the UserNotificationMutation builder.
func (m *UserNotificationMutation) Filter() *UserNotificationFilter {
	return &UserNotificationFilter{config: m.config, predicateAdder: m}
}

// UserNotificationFilter provides a generic filtering capability at runtime for UserNotificationQuery.
...
// Where applies the entql predicate on the query filter.
func (f *UserNotificationFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql [16]byte predicate on the id field.
func (f *UserNotificationFilter) WhereID(p entql.ValueP) {
	f.Where(p.Field(usernotification.FieldID))
}

// WhereBusinessUnitID applies the entql [16]byte predicate on the business_unit_id field.
func (f *UserNotificationFilter) WhereBusinessUnitID(p entql.ValueP) {
	f.Where(p.Field(usernotification.FieldBusinessUnitID))
}

// WhereOrganizationID applies the entql [16]byte predicate on the organization_id field.
func (f *UserNotificationFilter) WhereOrganizationID(p entql.ValueP) {
	f.Where(p.Field(usernotification.FieldOrganizationID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *UserNotificationFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(usernotification.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *UserNotificationFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(usernotification.FieldUpdatedAt))
}

// WhereVersion applies the entql int predicate on the version field.
func (f *UserNotificationFilter) WhereVersion(p entql.IntP) {
	f.Where(p.Field(usernotification.FieldVersion))
}

// WhereUserID applies the entql [16]byte predicate on the user_id field.
func (f *UserNotificationFilter) WhereUserID(p entql.ValueP) {
	f.Where(p.Field(usernotification.FieldUserID))
}

// WhereIsRead applies the entql bool predicate on the is_read field.
func (f *UserNotificationFilter) WhereIsRead(p entql.BoolP) {
	f.Where(p.Field(usernotification.FieldIsRead))
}

// WhereTitle applies the entql string predicate on the title field.
func (f *UserNotificationFilter) WhereTitle(p entql.StringP) {
	f.Where(p.Field(usernotification.FieldTitle))
}

// WhereDescription applies the entql string predicate on the description field.
func (f *UserNotificationFilter) WhereDescription(p entql.StringP) {
	f.Where(p.Field(usernotification.FieldDescription))
}

// WhereActionURL applies the entql string predicate on the action_url field.
func (f *UserNotificationFilter) WhereActionURL(p entql.StringP) {
	f.Where(p.Field(usernotification.FieldActionURL))
}

// WhereHasBusinessUnit applies a predicate to check if query has an edge business_unit.
func (f *UserNotificationFilter) WhereHasBusinessUnit() {
	f.Where(entql.HasEdge("business_unit"))
}

// WhereHasBusinessUnitWith applies a predicate to check if query has an edge business_unit with a given conditions (other predicates).
func (f *UserNotificationFilter) WhereHasBusinessUnitWith(preds ...predicate.BusinessUnit) {
	f.Where(entql.HasEdgeWith("business_unit", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOrganization applies a predicate to check if query has an edge organization.
func (f *UserNotificationFilter) WhereHasOrganization() {
	f.Where(entql.HasEdge("organization"))
}

// WhereHasOrganizationWith applies a predicate to check if query has an edge organization with a given conditions (other predicates).
func (f *UserNotificationFilter) WhereHasOrganizationWith(preds ...predicate.Organization) {
	f.Where(entql.HasEdgeWith("organization", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasUser applies a predicate to check if query has an edge user.
func (f *UserNotificationFilter) WhereHasUser() {
	f.Where(entql.HasEdge("user"))
}

// WhereHasUserWith applies a predicate to check if query has an edge user with a given conditions (other predicates).
func (f *UserNotificationFilter) WhereHasUserWith(preds ...predicate.User) {
	f.Where(entql.HasEdgeWith("user", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// addPredicate implements the predicateAdder interface.
func (urq *UserReportQuery) addPredicate(pred func(s *sql.Selector)) {
	urq.predicates = append(urq.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the UserReportQuery builder.
func (urq *UserReportQuery) Filter() *UserReportFilter {
	return &UserReportFilter{config: urq.config, predicateAdder: urq}
}

// addPredicate implements the predicateAdder interface.
func (m *UserReportMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the UserReportMutation builder.
func (m *UserReportMutation) Filter() *UserReportFilter {
	return &UserReportFilter{config: m.config, predicateAdder: m}
}

// UserReportFilter provides a generic filtering capability at runtime for UserReportQuery.
...
// Where applies the entql predicate on the query filter.
func (f *UserReportFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql [16]byte predicate on the id field.
func (f *UserReportFilter) WhereID(p entql.ValueP) {
	f.Where(p.Field(userreport.FieldID))
}

// WhereBusinessUnitID applies the entql [16]byte predicate on the business_unit_id field.
func (f *UserReportFilter) WhereBusinessUnitID(p entql.ValueP) {
	f.Where(p.Field(userreport.FieldBusinessUnitID))
}

// WhereOrganizationID applies the entql [16]byte predicate on the organization_id field.
func (f *UserReportFilter) WhereOrganizationID(p entql.ValueP) {
	f.Where(p.Field(userreport.FieldOrganizationID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *UserReportFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(userreport.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *UserReportFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(userreport.FieldUpdatedAt))
}

// WhereVersion applies the entql int predicate on the version field.
func (f *UserReportFilter) WhereVersion(p entql.IntP) {
	f.Where(p.Field(userreport.FieldVersion))
}

// WhereReportURL applies the entql string predicate on the report_url field.
func (f *UserReportFilter) WhereReportURL(p entql.StringP) {
	f.Where(p.Field(userreport.FieldReportURL))
}

// WhereUserID applies the entql [16]byte predicate on the user_id field.
func (f *UserReportFilter) WhereUserID(p entql.ValueP) {
	f.Where(p.Field(userreport.FieldUserID))
}

// WhereHasBusinessUnit applies a predicate to check if query has an edge business_unit.
func (f *UserReportFilter) WhereHasBusinessUnit() {
	f.Where(entql.HasEdge("business_unit"))
}

// WhereHasBusinessUnitWith applies a predicate to check if query has an edge business_unit with a given conditions (other predicates).
func (f *UserReportFilter) WhereHasBusinessUnitWith(preds ...predicate.BusinessUnit) {
	f.Where(entql.HasEdgeWith("business_unit", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasOrganization applies a predicate to check if query has an edge organization.
func (f *UserReportFilter) WhereHasOrganization() {
	f.Where(entql.HasEdge("organization"))
}

// WhereHasOrganizationWith applies a predicate to check if query has an edge organization with a given conditions (other predicates).
func (f *UserReportFilter) WhereHasOrganizationWith(preds ...predicate.Organization) {
	f.Where(entql.HasEdgeWith("organization", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
...
// WhereHasUser applies a predicate to check if query has an edge user.
func (f *UserReportFilter) WhereHasUser() {
	f.Where(entql.HasEdge("user"))
}

// WhereHasUserWith applies a predicate to check if query has an edge user with a given conditions (other predicates).
func (f *UserReportFilter) WhereHasUserWith(preds ...predicate.User) {
	f.Where(entql.HasEdgeWith("user", sqlgraph.WrapFunc(func(s *sql.Selector) {
		for _, p := range preds {
			p(s)
		}
