...
func (su *ShipmentUpdate) AddShipmentMoveIDs(ids ...uuid.UUID) *ShipmentUpdate {
	su.mutation.AddShipmentMoveIDs(ids...)
	return su
}

// AddShipmentMoves adds the "shipment_moves" edges to the ShipmentMove entity.
func (su *ShipmentUpdate) AddShipmentMoves(s ...*ShipmentMove) *ShipmentUpdate {
	ids := make([]uuid.UUID, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return su.AddShipmentMoveIDs(ids...)
}
...
func (su *ShipmentUpdate) RemoveShipmentDocumentationIDs(ids ...uuid.UUID) *ShipmentUpdate {
	su.mutation.RemoveShipmentDocumentationIDs(ids...)
	return su
}

// RemoveShipmentDocumentation removes "shipment_documentation" edges to ShipmentDocumentation entities.
func (su *ShipmentUpdate) RemoveShipmentDocumentation(s ...*ShipmentDocumentation) *ShipmentUpdate {
	ids := make([]uuid.UUID, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return su.RemoveShipmentDocumentationIDs(ids...)
}

// ClearShipmentComments clears all "shipment_comments" edges to the ShipmentComment entity.
func (su *ShipmentUpdate) ClearShipmentComments() *ShipmentUpdate {
	su.mutation.ClearShipmentComments()
	return su
}
...
// ClearShipmentMoves clears all "shipment_moves" edges to the ShipmentMove entity.
func (su *ShipmentUpdate) ClearShipmentMoves() *ShipmentUpdate {
	su.mutation.ClearShipmentMoves()
	return su
}

// RemoveShipmentMoveIDs removes the "shipment_moves" edge to ShipmentMove entities by IDs.
func (su *ShipmentUpdate) RemoveShipmentMoveIDs(ids ...uuid.UUID) *ShipmentUpdate {
	su.mutation.RemoveShipmentMoveIDs(ids...)
	return su
}

// RemoveShipmentMoves removes "shipment_moves" edges to ShipmentMove entities.
func (su *ShipmentUpdate) RemoveShipmentMoves(s ...*ShipmentMove) *ShipmentUpdate {
	ids := make([]uuid.UUID, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return su.RemoveShipmentMoveIDs(ids...)
}
...
func (su *ShipmentUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := su.mutation.RemovedShipmentDocumentationIDs(); len(nodes) > 0 && !su.mutation.ShipmentDocumentationCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   shipment.ShipmentDocumentationTable,
	...
	if nodes := su.mutation.ShipmentDocumentationIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   shipment.ShipmentDocumentationTable,
	...
	if su.mutation.ShipmentCommentsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := su.mutation.RemovedShipmentCommentsIDs(); len(nodes) > 0 && !su.mutation.ShipmentCommentsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   shipment.ShipmentCommentsTable,
	...
	if nodes := su.mutation.ShipmentCommentsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   shipment.ShipmentCommentsTable,
	...
	if su.mutation.ShipmentMovesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := su.mutation.RemovedShipmentMovesIDs(); len(nodes) > 0 && !su.mutation.ShipmentMovesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   shipment.ShipmentMovesTable,
	...
	if nodes := su.mutation.ShipmentMovesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   shipment.ShipmentMovesTable,
...
// AddShipmentMoveIDs adds the "shipment_moves" edge to the ShipmentMove entity by IDs.
func (suo *ShipmentUpdateOne) AddShipmentMoveIDs(ids ...uuid.UUID) *ShipmentUpdateOne {
	suo.mutation.AddShipmentMoveIDs(ids...)
	return suo
}

// AddShipmentMoves adds the "shipment_moves" edges to the ShipmentMove entity.
func (suo *ShipmentUpdateOne) AddShipmentMoves(s ...*ShipmentMove) *ShipmentUpdateOne {
	ids := make([]uuid.UUID, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return suo.AddShipmentMoveIDs(ids...)
}
...
// RemoveShipmentDocumentationIDs removes the "shipment_documentation" edge to ShipmentDocumentation entities by IDs.
func (suo *ShipmentUpdateOne) RemoveShipmentDocumentationIDs(ids ...uuid.UUID) *ShipmentUpdateOne {
	suo.mutation.RemoveShipmentDocumentationIDs(ids...)
	return suo
}

// RemoveShipmentDocumentation removes "shipment_documentation" edges to ShipmentDocumentation entities.
func (suo *ShipmentUpdateOne) RemoveShipmentDocumentation(s ...*ShipmentDocumentation) *ShipmentUpdateOne {
	ids := make([]uuid.UUID, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return suo.RemoveShipmentDocumentationIDs(ids...)
}

// ClearShipmentComments clears all "shipment_comments" edges to the ShipmentComment entity.
func (suo *ShipmentUpdateOne) ClearShipmentComments() *ShipmentUpdateOne {
	suo.mutation.ClearShipmentComments()
	return suo
}
...
// ClearShipmentMoves clears all "shipment_moves" edges to the ShipmentMove entity.
func (suo *ShipmentUpdateOne) ClearShipmentMoves() *ShipmentUpdateOne {
	suo.mutation.ClearShipmentMoves()
	return suo
}

// RemoveShipmentMoveIDs removes the "shipment_moves" edge to ShipmentMove entities by IDs.
func (suo *ShipmentUpdateOne) RemoveShipmentMoveIDs(ids ...uuid.UUID) *ShipmentUpdateOne {
	suo.mutation.RemoveShipmentMoveIDs(ids...)
	return suo
}

// RemoveShipmentMoves removes "shipment_moves" edges to ShipmentMove entities.
func (suo *ShipmentUpdateOne) RemoveShipmentMoves(s ...*ShipmentMove) *ShipmentUpdateOne {
	ids := make([]uuid.UUID, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return suo.RemoveShipmentMoveIDs(ids...)
}
...
func (suo *ShipmentUpdateOne) sqlSave(ctx context.Context) (_node *Shipment, err error) {
	...
	if nodes := suo.mutation.RemovedShipmentDocumentationIDs(); len(nodes) > 0 && !suo.mutation.ShipmentDocumentationCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   shipment.ShipmentDocumentationTable,
	...
	if nodes := suo.mutation.ShipmentDocumentationIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   shipment.ShipmentDocumentationTable,
	...
	if suo.mutation.ShipmentCommentsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   shipment.ShipmentCommentsTable,
	...
	if nodes := suo.mutation.RemovedShipmentCommentsIDs(); len(nodes) > 0 && !suo.mutation.ShipmentCommentsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   shipment.ShipmentCommentsTable,
	...
	if nodes := suo.mutation.ShipmentCommentsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   shipment.ShipmentCommentsTable,
	...
	if suo.mutation.ShipmentMovesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   shipment.ShipmentMovesTable,
	...
	if nodes := suo.mutation.RemovedShipmentMovesIDs(); len(nodes) > 0 && !suo.mutation.ShipmentMovesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   shipment.ShipmentMovesTable,
	...
	if nodes := suo.mutation.ShipmentMovesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   shipment.ShipmentMovesTable,
