...
func (h QualifierCodeHandler) Create() fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		go h.auditService.LogAction(constants.TableQualifierCode, entity.ID.String(), property.AuditLogActionCreate, entity, ids.UserID, ids.OrganizationID, ids.BusinessUnitID)
...
func (h QualifierCodeHandler) Update() fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		go h.auditService.LogAction(constants.TableQualifierCode, entity.ID.String(), property.AuditLogActionUpdate, entity, ids.UserID, ids.OrganizationID, ids.BusinessUnitID)
