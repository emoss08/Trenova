...
func (h EquipmentManufacturerHandler) Create() fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		attemptID := h.auditService.LogAttempt(c.Context(), constants.TableEquipmentManufacturer, "", property.AuditLogActionCreate, createdEntity, ids.UserID, ids.OrganizationID, ids.BusinessUnitID)
		...
		h.auditService.LogAction(c.Context(), constants.TableEquipmentManufacturer, entity.ID.String(), property.AuditLogActionCreate, entity, ids.UserID, ids.OrganizationID, ids.BusinessUnitID)
...
func (h EquipmentManufacturerHandler) Update() fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		attemptID := h.auditService.LogAttempt(c.Context(), constants.TableEquipmentManufacturer, equipManuID, property.AuditLogActionUpdate, updatedEntity, ids.UserID, ids.OrganizationID, ids.BusinessUnitID)
		...
		h.auditService.LogAction(c.Context(), constants.TableEquipmentManufacturer, entity.ID.String(), property.AuditLogActionUpdate, entity, ids.UserID, ids.OrganizationID, ids.BusinessUnitID)
