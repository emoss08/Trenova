...
func (h LocationCategoryHandler) Create() fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		attemptID := h.auditService.LogAttempt(c.Context(), constants.TableLocationCategory, "", property.AuditLogActionCreate, createdEntity, ids.UserID, ids.OrganizationID, ids.BusinessUnitID)
		...
		h.auditService.LogAction(c.Context(), constants.TableLocationCategory, entity.ID.String(), property.AuditLogActionCreate, entity, ids.UserID, ids.OrganizationID, ids.BusinessUnitID)
...
func (h LocationCategoryHandler) Update() fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		attemptID := h.auditService.LogAttempt(c.Context(), constants.TableLocationCategory, locationCategoryID, property.AuditLogActionUpdate, updatedEntity, ids.UserID, ids.OrganizationID, ids.BusinessUnitID)
		...
		h.auditService.LogAction(c.Context(), constants.TableLocationCategory, entity.ID.String(), property.AuditLogActionUpdate, entity, ids.UserID, ids.OrganizationID, ids.BusinessUnitID)
