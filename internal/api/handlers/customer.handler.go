...
func (h CustomerHandler) Create() fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		go h.auditService.LogAction("customers", entity.ID.String(), property.AuditLogActionCreate, entity, ids.UserID, ids.OrganizationID, ids.BusinessUnitID)
...
func (h CustomerHandler) Update() fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		go h.auditService.LogAction("customers", entity.ID.String(), property.AuditLogActionUpdate, entity, ids.UserID, ids.OrganizationID, ids.BusinessUnitID)
