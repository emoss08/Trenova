...
func (h *Handler) update(c *fiber.Ctx) error {
	...
	if existing.UserID != reqCtx.UserID {
		return h.eh.HandleError(c, errors.NewAuthorizationError("You can only update your own notification preferences"))
	}
...
func (h *Handler) delete(c *fiber.Ctx) error {
	...
	// Check if user owns this preference
	if existing.UserID != reqCtx.UserID {
		return h.eh.HandleError(c, errors.NewAuthorizationError("You can only delete your own notification preferences"))
	}
