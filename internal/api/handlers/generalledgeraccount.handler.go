...
func (h GeneralLedgerAccountHandler) Create() fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		attemptID := h.auditService.LogAttempt(c.Context(), constants.TableGeneralLedgerAccount, "", property.AuditLogActionCreate, createdEntity, ids.UserID, ids.OrganizationID, ids.BusinessUnitID)
		...
		h.auditService.LogAction(c.Context(), constants.TableGeneralLedgerAccount, entity.ID.String(), property.AuditLogActionCreate, entity, ids.UserID, ids.OrganizationID, ids.BusinessUnitID)
...
func (h GeneralLedgerAccountHandler) Update() fiber.Handler {
	return func(c *fiber.Ctx) error {
		...
		attemptID := h.auditService.LogAttempt(c.Context(), constants.TableGeneralLedgerAccount, glAccountID, property.AuditLogActionUpdate, updatedEntity, ids.UserID, ids.OrganizationID, ids.BusinessUnitID)
		...
		h.auditService.LogAction(c.Context(), constants.TableGeneralLedgerAccount, entity.ID.String(), property.AuditLogActionUpdate, entity, ids.UserID, ids.OrganizationID, ids.BusinessUnitID)
