...
func (c *CommentType) Insert(ctx context.Context, tx bun.IDB, auditService *audit.Service, user audit.AuditUser) error {
...
func (c *CommentType) UpdateOne(ctx context.Context, tx bun.IDB, auditService *audit.Service, user audit.AuditUser) error {
	// Fetch the original state of the comment type
	original := new(CommentType)
