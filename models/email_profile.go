...
// 	DefaultProfile *bool         `gorm:"type:boolean;default:false"                                                                  json:"defaultProfile"`
...
// func (e *EmailProfile) SetOrgID(orgID uuid.UUID) {
// 	e.OrganizationID = orgID
// }

// func (e *EmailProfile) SetBuID(buID uuid.UUID) {
...
// 	if e.DefaultProfile != nil && *e.DefaultProfile {
// 		var count int64
...
// 	if err := db.Model(&EmailProfile{}).
// 		Where("organization_id = ? AND business_unit_id = ?", orgID, buID).
// 		Offset(offset).Limit(limit).Order("default_profile desc").
