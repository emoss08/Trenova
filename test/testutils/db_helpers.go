...
func AssertReadOperation(t *testing.T, conn db.Connection, operation func() error) {
	...
	require.Greater(t, mockConn.GetReadCount(), int64(0), "Operation should have used read connection")
	require.Equal(t, int64(0), mockConn.GetWriteCount(), "Operation should not have used write connection")
}
...
func AssertWriteOperation(t *testing.T, conn db.Connection, operation func() error) {
	...
	require.Greater(t, mockConn.GetWriteCount(), int64(0), "Operation should have used write connection")
}
