    ...
    <>
      ...
      >
        ...
        <div className='menu-item px-3 my-0'>
          ...
          >
            <span className='menu-icon' data-kt-element='icon'>
              <MTSVG path='/media/icons/duotune/general/gen060.svg' className='svg-icon-3' />
            </span>
        ...
        <div className='menu-item px-3 my-0'>
          ...
          >
            <span className='menu-icon' data-kt-element='icon'>
              <MTSVG path='/media/icons/duotune/general/gen061.svg' className='svg-icon-3' />
            </span>
        ...
        <div className='menu-item px-3 my-0'>
          ...
          >
            <span className='menu-icon' data-kt-element='icon'>
              <MTSVG path='/media/icons/duotune/general/gen062.svg' className='svg-icon-3' />
            </span>
