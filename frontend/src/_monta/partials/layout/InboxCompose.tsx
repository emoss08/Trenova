        ...
        <form ref={formRef} id='kt_inbox_compose_form' onSubmit={() => console.log('submit')}>
          ...
          <div className='d-flex align-items-center justify-content-between py-5 ps-8 pe-5 border-bottom'>
            ...
            <div className='d-flex ms-2'>
              ...
              <div
                ...
                onClick={handleClose}
              >
                <MTSVG className='svg-icon-1' path='/media/icons/duotune/arrows/arr061.svg' />
              </div>
              {/*end::Close*/}
            </div>
          </div>
          ...
          <div className='d-flex align-items-center justify-content-between py-5 ps-8 pe-5 border-top'>
            ...
            <div className='d-flex align-items-center me-3'>
              ...
              >
                <MTSVG className='svg-icon-1' path='/media/icons/duotune/files/fil022.svg' />
              </a>
              <a href='#' className='btn btn-icon btn-active-light-primary'>
                <MTSVG className='svg-icon-1' path='/media/icons/duotune/general/gen018.svg' />
              </a>
              {/*end::Other*/}
            </div>
            {/*end::Actions*/}
            ...
            <div className='d-flex align-items-center'>
              <button
                ...
                title='More actions'
              >
                <MTSVG className='svg-icon-1' path='/media/icons/duotune/coding/cod001.svg' />
              </button>
            </div>
            {/*end::Toolbar*/}
          </div>
