      ...
      >
        ...
        >
          <div className='btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px'>
            <MTSVG path='/media/icons/duotune/general/gen021.svg' className='svg-icon-1' />
          </div>
        </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <MTSVG path='/media/icons/duotune/coding/cod001.svg' className='svg-icon-1' />
                </div>
                ...
                >
                  <MTSVG path='/media/icons/duotune/arrows/arr072.svg' className='svg-icon-2' />
                </div>
              </div>
            </form>
