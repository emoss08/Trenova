      ...
      <div className='card-body pb-0'>
        ...
        <div className='mb-6'>
          ...
          <div className='d-flex align-items-center mb-5'>
            ...
            >
              <MTSVG path='/media/icons/duotune/communication/com012.svg' className='svg-icon-3' />
              189
            </a>
            ...
            >
              <MTSVG path='/media/icons/duotune/general/gen030.svg' className='svg-icon-2' />
              229
            </a>
          </div>
          {/* end::Toolbar */}
        ...
        <form className='position-relative mb-6'>
          ...
          <div className='position-absolute top-0 end-0 me-n5'>
            ...
            <span className='btn btn-icon btn-sm btn-active-color-primary ps-0'>
              <MTSVG path='/media/icons/duotune/general/gen018.svg' className='svg-icon-2 mb-3' />
            </span>
          </div>
        </form>
        {/* edit::Reply input */}
